...
//
// Canonical attribution strings, mirrored from unsloth_branding.py, which greps the
...
// Must equal PHRASE in unsloth_branding.py, which greps the built bundle for it.
