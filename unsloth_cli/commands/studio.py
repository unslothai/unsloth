...
# New Chat leaves the previous conversation generating and the admission queue caps
# decodes at the slot count, so at 1 every extra chat queues behind the first.
# _slots_that_fit_on_gpu() still cuts this back when VRAM is tight.
