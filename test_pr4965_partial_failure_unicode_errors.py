...
def test_partial_failure_survives_unicode_upstream_error(monkeypatch, fake_datasets, fake_structlog):
...
def test_partial_failure_survives_embedded_newlines(monkeypatch, fake_datasets, fake_structlog):
    import datasets as ds
    from huggingface_hub.utils import HfHubHTTPError
