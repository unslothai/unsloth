...
def run_benchmarks():
    ...
    for batch, seq, dim in configs:
        ...
        print(f"Config: bsz={batch}, seq={seq}, dim={dim} ({elements/1e6:.2f}M elements)")
        print("-" * 60)
    ...
    print("Done. Use these baseline numbers to verify if custom Metal kernels improve bandwidth.")
