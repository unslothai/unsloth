...
# Record the resolved torch --index-url at the marker path, atomically (temp + Move).
# Best-effort: a write failure never aborts the install. A blank URL is ignored;
