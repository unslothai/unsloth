...
## Atlas Cloud (OpenAI-compatible API provider)

<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=unsloth">
    <img src="studio/frontend/public/provider-logos/atlas.svg" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=unsloth)** is a full-modal, OpenAI-compatible AI inference platform. Unsloth Studio lets you [connect API providers](https://unsloth.ai/docs/integrations/connections) for chat — pick **Atlas Cloud** to reach DeepSeek, Qwen, GLM, Kimi, MiniMax and more through a single API. Budget-friendly [coding plan](https://www.atlascloud.ai/console/coding-plan).

In **Unsloth Studio → Chat → API providers**, choose **Atlas Cloud**, paste your key, and you're set (base URL `https://api.atlascloud.ai/v1` is pre-filled). `deepseek-ai/deepseek-v4-pro` is a reasoning model.
