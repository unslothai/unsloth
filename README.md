...
## 🦥 Unsloth News
- New **Triton Kernels** and **Auto Packing**: RoPE & MLP kernels + packing for 3x faster training & 30% less VRAM. [Blog](https://docs.unsloth.ai/new/3x-faster-training-packing)
...
- **500K Context Fine-tuning**: Training a 20B model with >500K context windows is possible on a single 80GB GPU. [Blog](https://docs.unsloth.ai/new/500k-context-length-fine-tuning)
