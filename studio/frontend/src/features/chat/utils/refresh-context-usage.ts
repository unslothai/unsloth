 ...
 *  parent legacy records to the previous one, then walk the last record's ancestor chain.
 *  Greedy newest-child descent would pick another branch and drop pre-parentId history. */
