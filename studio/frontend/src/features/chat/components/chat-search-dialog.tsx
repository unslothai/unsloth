...
export function ChatSearchDialog() {
  ...
  return (
    <CommandDialog
      ...
      className="chat-search-surface corner-squircle top-[25%] w-[635px] max-w-[calc(100%-2rem)] gap-0 p-0 ring-0 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.16)] dark:shadow-[0_4px_14px_var(--background)] sm:max-w-[635px]"
