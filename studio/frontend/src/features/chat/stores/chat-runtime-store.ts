...
import type { ActiveModelLoadSource } from "../model-runtime/rollback-load-source";
import {
...
export type ChatModelLoadInfo = {
  ...
  runtimeBackend?: "llama_cpp" | "transformers" | "adapter" | "unknown";
...
export type ChatModelLoadProgress = {
  percent: number | null;
  label: string | null;
...
type ChatRuntimeStore = {
  ...
  modelLoadInfo: ChatModelLoadInfo | null;
  modelLoadProgress: ChatModelLoadProgress | null;
  modelLoadToastDismissed: boolean;
  activeNativePathToken: string | null;
  activeModelLoadSource: ActiveModelLoadSource | null;
  hydratePersistedSettings: () => Promise<void>;
  setModelLoading: (loading: boolean) => void;
  setModelLoadInfo: (info: ChatModelLoadInfo | null) => void;
  setModelLoadProgress: (progress: ChatModelLoadProgress | null) => void;
  setModelLoadToastDismissed: (dismissed: boolean) => void;
  setActiveModelLoadSource: (source: ActiveModelLoadSource | null) => void;
  ...
  setKvCacheDtype: (kvCacheDtype: string | null) => void;
  setSpeculativeType: (speculativeType: string | null) => void;
  setSpecDraftNMax: (specDraftNMax: number | null) => void;
  setCustomContextLength: (customContextLength: number | null) => void;
  setChatTemplateOverride: (chatTemplateOverride: string | null) => void;
};
...
export const useChatRuntimeStore = create<ChatRuntimeStore>((set, get) => ({
  ...
  setModelLoadInfo: (modelLoadInfo) => set({ modelLoadInfo }),
  setModelLoadProgress: (modelLoadProgress) => set({ modelLoadProgress }),
  setModelLoadToastDismissed: (modelLoadToastDismissed) =>
    set({ modelLoadToastDismissed }),
  setActiveModelLoadSource: (activeModelLoadSource) =>
    set({ activeModelLoadSource }),
