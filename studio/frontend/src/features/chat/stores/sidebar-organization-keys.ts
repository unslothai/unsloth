 ...
 * defined there was still in its temporal dead zone when `general-tab.tsx` read
 * it at module scope, throwing and leaving a white screen on launch. A module
 * with no imports is always evaluated first, so do not add an import here.
 */
