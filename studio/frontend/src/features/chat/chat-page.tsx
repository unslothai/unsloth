...
const ProjectChecksPanel = lazy(() =>
  import("./components/project-checks-panel").then((module) => ({ default: module.ProjectChecksPanel })),
);
...
function ProjectLanding({
  ...
  const [projectTab, setProjectTab] = useState<"chats" | "sources" | "checks">(() =>
