...
/** RagDocument enriched for global uploaded-files list (settings Data tab). */
...
/** Local directory whose durable access grant is held by desktop backend. */
...
/** Aggregate job for discovering and indexing all changes in linked folder. */
