...
// The half of the feature that only exists while a search is open, in its own module so it is also
// its own chunk: the index, the observer and the highlights are loaded when the chord is first
// pressed, not on the first screen. See `find-in-page.tsx` for the always-mounted half.
