...
export function NativeModelChip({
  ...
  return (
    <div className="flex min-w-0 max-w-[calc(34rem*var(--ui-space-scale,1))] items-center gap-2 rounded-lg border border-border/70 bg-muted/70 px-2.5 py-1.5 text-xs">
