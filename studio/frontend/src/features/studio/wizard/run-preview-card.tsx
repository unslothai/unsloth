...
export function RunPreviewCard({
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between gap-3">
        ...
        <span
          className={cn(
            ...
            isReady
              ? "bg-foreground/[0.06] text-foreground/90 dark:bg-[rgb(255_255_255_/_calc(0.08*var(--contrast-wash-gain,1)))]"
              : "bg-foreground/[0.03] text-muted-foreground/70 dark:bg-[rgb(255_255_255_/_calc(0.04*var(--contrast-wash-gain,1)))]",
          )}
        >
      ...
      <div className="-mx-6 h-px bg-foreground/[0.07] dark:bg-[rgb(255_255_255_/_calc(0.06*var(--contrast-wash-gain,1)))]" />
