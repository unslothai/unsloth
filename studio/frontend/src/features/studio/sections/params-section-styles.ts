...
export function selectableOptionStateClassName(selected: boolean): string {
  return selected
    ...
    : "border-border/50 bg-muted/40 hover:border-foreground/20 hover:bg-muted/60 dark:border-transparent dark:bg-[rgb(255_255_255_/_calc(0.05*var(--contrast-wash-gain,1)))] dark:hover:bg-[rgb(255_255_255_/_calc(0.09*var(--contrast-wash-gain,1)))]";
}
