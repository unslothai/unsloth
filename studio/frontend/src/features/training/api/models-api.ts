...
/** Ask the backend whether a model is a vision model (GET /api/models/check-vision/{name}). */
...
/** Ask the backend whether a model is an embedding model (GET /api/models/check-embedding/{name}). */
