...
// Adopt downloads the backend is running that this client doesn't know about.
// Retry only the side(s) that failed so transient backend readiness settles
// without duplicating already-polling jobs.
