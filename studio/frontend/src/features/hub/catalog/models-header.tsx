...
// eslint-disable-next-line no-restricted-imports -- Importing the Settings barrel pulls its Chat-heavy dialog into Hub.
  ...
  return (
    <header className="font-heading flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
      <PageHeading
        ...
        subtitle={
          isDataset
            ? "Discover and download datasets from Hugging Face."
