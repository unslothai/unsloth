              ...
              {needsVariantSelection && (
                ...
                >
                  ...
                  <PopoverContent
                    ...
                    className="hub-menu-instant menu-soft-surface w-[var(--radix-popover-trigger-width)] min-w-[calc(220px*var(--ui-space-scale,1))] gap-0 overflow-hidden p-0 py-2 ring-0"
                  >
