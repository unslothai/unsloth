      ...
      {tabs.map((tab, index) => (
        <button
          ...
          className={cn(
            ...
            // The active tab carries the pill itself. No hover override: the
            // pill rules already hold it still, and the wash this used to
            // paint landed below the pill, so pointing at the selected tab
            // darkened it.
