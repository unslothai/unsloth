...
function ExtraArgsRow({
  ...
  const diagnostics = diagnoseExtraArgs(text, catalog, {
    ...
    // Only manual mode with a resolved layer count of 0 or more rewrites --tensor-split; at
    // Auto layers the launcher drops it, so the value never reaches llama-server to be refused.
