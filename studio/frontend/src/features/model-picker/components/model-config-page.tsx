          ...
          <div className={ROW_CLASS}>
            <div className="flex min-w-0 items-center gap-1.5">
              ...
              <InfoHint>
                ...
                the llama.cpp default (512), raised to 2048 only on Gemma 4
                vision models, whose images do not fit in 512. Other vision
                models keep the 512 default. Larger values speed up prompt
