        ...
        <div className="flex h-full min-h-0 max-sm:flex-col">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? "text-[#232528] dark:text-white"
                        : "text-[#232528] dark:text-[#c7c7c4] hover:bg-[#ececec] dark:hover:bg-[#2d2f33] hover:text-[#232528] dark:hover:text-white",
                    )}
                  >
                    {active && (
                      <motion.span
          ...
          <main className="relative flex min-h-0 min-w-0 flex-1 flex-col">
            <button
              type="button"
              onClick={closeDialog}
              className="absolute top-3 right-3 z-10 flex size-7 items-center justify-center rounded-[8px] text-[#232528] dark:text-[#c7c7c4] transition-colors hover:bg-[#ececec] dark:hover:bg-[#2d2f33] hover:text-[#232528] dark:hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
