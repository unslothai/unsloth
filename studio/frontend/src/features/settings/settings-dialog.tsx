      ...
      <Dialog open={open} onOpenChange={(o) => !o && closeDialog()}>
        <DialogContent
          ...
          className={cn(
            ...
            "settings-surface !max-w-[min(960px,calc(100vw-2rem))] h-[min(680px,calc(100dvh-var(--studio-window-chrome-top,0px)-2rem))] w-[min(960px,calc(100vw-2rem))] p-0 overflow-hidden",
