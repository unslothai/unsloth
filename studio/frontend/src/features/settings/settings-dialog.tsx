      ...
      <Dialog open={open} onOpenChange={(o) => !o && closeDialog()}>
        ...
        >
          ...
          <div className="flex h-full min-h-0 min-w-0 w-full max-sm:flex-col">
            ...
            <aside className="font-heading flex w-[min(calc(248px*var(--ui-space-scale,1)),50%)] shrink-0 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground p-2 dark:border-r-0 max-sm:w-full max-sm:border-r-0 max-sm:border-b max-sm:border-sidebar-border">
