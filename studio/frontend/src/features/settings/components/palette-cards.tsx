      ...
      {OPTIONS.map((opt) => {
        ...
        return (
          <button
            ...
            className="palette-card flex flex-col gap-2 rounded-xl border border-border p-2.5 text-start transition-colors focus-visible:border-ring focus-visible:outline-none"
          >
