  ...
  return (
    <article className="min-w-0 rounded-lg border border-border/70 bg-background">
      ...
      >
        ...
        <div className="flex shrink-0 items-start gap-2 text-right text-[0.6875rem] text-muted-foreground">
          <div>
      ...
      {expanded ? (
        <div className="border-t border-border/60 p-3 pt-2">
          <div className="grid gap-2">
            <div>
              <div className="mb-1 flex items-center justify-between gap-2 text-[0.625rem] font-semibold uppercase text-muted-foreground">
                <span>Prompt</span>
