...
export interface DiffusionStatus {
  ...
  // Which NVFP4 kernel path the loaded DiT runs ("flashinfer" | "torchao"), null for every other
  // scheme. Selected per device at load time, so the scheme alone does not say which one served.
