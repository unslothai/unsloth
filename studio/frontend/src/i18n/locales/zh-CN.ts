...
export const zhCN = {
  ...
  dataRecipes: {
    import: {
      title: "导入旧版配方",
      description: "将此浏览器中的配方和运行记录导入 {account} 账户。",
      confirm: "导入旧版数据",
      cancel: "暂不",
      close: "关闭",
      importing: "正在导入...",
      complete: "旧版导入完成",
      failed: "旧版导入失败",
      failedDescription: "无法导入旧版数据。请重试。",
      noData: "没有可导入的旧版数据。",
      imported: "已导入",
      redacted: "已脱敏",
      skipped: "已跳过",
      ...
      retired: "已停用 ID",
      missingParent: "配方不存在",
      recipeCountOne: "{count} 个配方",
      recipeCountOther: "{count} 个配方",
      executionCountOne: "{count} 条运行记录",
      executionCountOther: "{count} 条运行记录",
      unknownId: "未知 ID",
      unknownOutcome: "未知结果",
      redactedFields: "已脱敏字段：{fields}",
      reasons: {
        alreadyExists: "已存在使用此 ID 的项目",
        idRetired: "此 ID 之前已被删除",
        missingParent: "关联的配方不可用",
        invalidIdentifier: "ID 无效",
        invalidData: "存储的数据无效",
        invalidName: "名称无效",
        invalidExecution: "运行数据无效",
        fieldLimit: "字段超出大小限制",
        secretField: "出于安全考虑已移除敏感字段",
        batchLimit: "导入批次过大",
        unknown: "无法导入此项目",
      },
    },
  ...
  studio: {
    ...
    trainingPresets: {
      title: "训练预设",
      selectPlaceholder: "选择已保存的预设",
      save: "保存预设",
      saveAs: "另存为预设",
      load: "加载预设",
      delete: "删除预设",
      deleteConfirmTitle: "删除此训练预设？",
      deleteConfirmDescription: "此操作无法撤销。",
      noPresets: "尚无已保存的训练预设。",
      loading: "正在加载预设...",
      loadError: "加载训练预设失败。",
      saveError: "保存训练预设失败。",
      deleteError: "删除训练预设失败。",
      conflictTitle: "预设已在服务器上更改",
      conflictDescription: "请重新加载服务器预设，或将当前草稿另存为新预设。",
      reload: "重新加载服务器预设",
      reloadError: "重新加载服务器预设失败。",
      reloadUnavailable: "此服务器预设已不可用。",
      saveAsNew: "另存为新预设",
      importYaml: "导入 YAML",
      exportYaml: "导出 YAML",
      yamlDescription: "使用 YAML 在环境之间传输可移植的训练配置。",
    },
    model: {
      title: "模型",
