  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        passwordLabel: "远程密码",
        passwordDescription:
          "远程浏览器以 unsloth 身份登录。桌面应用会继续自动登录。",
        ...
        setupConfirmDescription:
          "请核对下方主机名。随后 Cloudflare 会要求你授权此隧道：选择该主机名所属的域名，然后点击 Authorize。",
        setupPreparing: "正在打开 Cloudflare，以便你授权此隧道…",
        setupAuthorize:
          "等待你在 Cloudflare 中授权。请选择 {hostname} 所属的域名，然后点击 Authorize。",
        removeProgress: "正在从 Unsloth 中移除已保存的连接...",
        openCloudflare: "打开 Cloudflare",
        removeAction: "移除",
        removeTitle: "从 Unsloth 中移除此自定义隧道？",
        removeDescription:
          "这只会移除 Unsloth 中保存的内容。隧道及其 DNS 记录仍保留在 Cloudflare，直到你在那里删除。",
        ...
        removeLocally:
          "请在运行 Unsloth 的机器上打开设置，以删除这个已连接的隧道。",
        dnsConflict:
          "{hostname} 在 Cloudflare 中已指向别处。请删除该 DNS 记录，或改用其他主机名。",
        ...
        autoStartLabel: "自动启动",
        autoStartTemporary:
          "Unsloth 启动时创建新的临时 URL。现在断开连接不会关闭此设置。",
        autoStartCustom:
          "Unsloth 启动时连接此自定义主机名。现在断开连接不会关闭此设置。",
        autoStartCustomMissing:
          "在下方设置自定义主机名之前，这不会连接任何内容。",
        blockServerStarting: "服务器启动完成后即可使用远程访问。",
        blockCustomNotConfigured:
          "请先在下方设置自定义主机名，再启动远程访问。",
        ...
        dnsConflictUnknown:
          "该主机名在 Cloudflare 中已指向别处。请删除该 DNS 记录，或改用其他主机名。",
        errorInvalidHostname:
          "这不是完整主机名。请输入类似 unsloth.example.com 的地址。",
        errorWrongDomain:
          "你在 Cloudflare 授权的域名不包含 {hostname}。请重新设置，并选择该主机名所属的域名。",
        errorHostnameUnreachable:
          "隧道已连接，但 {hostname} 无法打开。请移除此自定义隧道后重新设置，并选择该主机名所属的域名。",
        errorCertificateExists:
          "{path} 已存在 Cloudflare 证书，Unsloth 不会覆盖它。请移动或删除该文件后重新设置。",
        ...
        errorLoginTimeout:
          "未能及时完成 Cloudflare 授权。请重新设置，并在 Cloudflare 页面打开时点击 Authorize。",
        errorLoginFailed: "Cloudflare 未完成授权。请重新设置。",
        errorSetupFailed:
          "自定义隧道未能完成设置。请重新设置，或查看服务器日志。",
        errorTeardownFailed:
          "无法移除已保存的自定义隧道。请重试，或查看服务器日志。",
