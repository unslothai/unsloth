...
export const zhCN = {
  picker: {
    ...
    retry: "重试",
    offlineTitle: "您已离线",
    offlineBody: "切换到本机以使用缓存或本地{noun}。",
    offlineSwitchDevice: "本机",
  ...
  studio: {
    ...
    preview: {
      ...
      model: "模型",
      dataset: "数据集",
      downloadsOnStart: "启动时下载",
      continuesOnStart: "启动时继续",
      noticeModelDownload: "此模型尚未在此设备上。训练时将自动下载。",
      noticeModelPartial: "训练将先完成模型的未完成下载，然后再加载。",
      noticeDatasetDownload: "此数据集尚未在此设备上。训练时将自动下载。",
      noticeDatasetPartial: "训练将先完成数据集的未完成下载，然后再读取。",
    },
    datasetPicker: {
      noun: "数据集",
      selectDataset: "选择数据集",
      ...
      useAsHubDataset: "用作 Hugging Face 数据集",
      useAsLocalPath: "用作本地路径",
      hfCacheLabel: "HF 缓存",
      scanningLocal: "正在扫描此设备上的数据集…",
      couldntScan: "无法扫描本地数据集",
      someLocationsUnscanned: "部分数据集位置无法扫描。",
      noLocalDatasets:
        "此设备上还没有数据集。从 Hub 下载数据集、在数据配方中构建，或上传文件。",
      searchingHub: "正在搜索 Hugging Face…",
      noDatasetsFound: "未找到数据集。",
      tokenRejectedTitle: "Hugging Face token 被拒绝",
      tokenRejectedBody: "请在设置 → 通用中更新 token，然后重试。",
    ...
    modelPicker: {
      ...
      useAsHubModel: "用作 Hugging Face 模型",
      useAsLocalPath: "用作本地路径",
      hfCacheLabel: "HF 缓存",
      scanningLocal: "正在扫描本地模型…",
      couldntScan: "无法扫描本地模型",
      someLocationsUnscanned: "部分本地位置无法扫描。",
      noLocalModels: "未找到本地模型。",
      noLocalModelsHint: "在上方粘贴文件夹路径，或切换到 Hugging Face。",
      searchingHub: "正在搜索 Hugging Face…",
      noModelsFound: "未找到模型。",
      tokenRejectedTitle: "Hugging Face token 被拒绝",
      tokenRejectedBody: "请在设置 → 通用中更新 token，然后重试。",
      hubUnreachable: "无法连接 Hugging Face",
      cantUseModel: "无法使用该模型进行训练",
      reasonEmptyId: "请输入模型 ID 或本地模型路径。",
      reasonGguf: "GGUF 模型无法用于训练。",
      reasonAdapter: "适配器输出不能作为基础训练模型。",
      reasonNotTrainable: "该设备上的模型无法训练。",
      reasonUnsupportedFormat: "该模型格式不支持训练。",
      vramNeeds: "约需 {est}GB 显存（GPU：{total}GB）",
      vramTight: "约 {est}GB 显存（在 {total}GB 上偏紧）",
      vramApprox: "约 {est}GB 显存",
    },
    methods: {
      qlora: {
        label: "QLoRA",
        hint: "4 位量化。显存占用最低，启动最快。",
        note: "4-bit",
      },
      lora: {
        label: "LoRA",
        hint: "16 位适配器。质量与内存均衡。",
        note: "16-bit",
      },
      full: {
        label: "全量微调",
        hint: "训练所有权重。质量最高，需要最多显存。",
        note: "fp16",
      },
      cpt: {
        label: "持续预训练",
        hint: "针对新领域或新语言的持续预训练。",
        note: "持续",
      },
    },
    subtitles: {
    ...
    history: {
      ...
      deleteArtifactsDescription:
        "删除该运行的输出文件夹，包括已保存的适配器和检查点。",
      deleteArtifactsSharedNote:
        "另一个运行共享此输出文件夹。文件将保留，直到删除最后一个使用它们的运行。",
      artifactsKeptShared:
        "运行已删除。由于另一个运行使用同一文件夹，适配器文件已保留。",
      deleteArtifactsActiveError:
        "这些文件正在被进行中的训练使用。请先停止训练再删除。",
      deleteArtifactsFailed: "运行已删除，但其文件无法移除。",
      emptyTitle: "还没有训练运行",
