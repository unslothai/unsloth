  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        stableTitle:"固定主机名",
        stableDescription:"创建命名 Cloudflare 隧道，以获得固定 URL 和 API 流式响应。",
        hostnameLabel:"完整主机名",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"设置",
        settingUp:"正在设置...",
        provisionProgress:"请在浏览器中授权 Cloudflare。Unsloth 将完成隧道和 DNS 记录的创建。",
        teardownProgress:"请授权 Cloudflare 删除隧道。DNS 记录会保留，需由你手动删除。",
        openCloudflare:"打开 Cloudflare",
        connectorReady:"连接器已注册",
        tunnelReady:"隧道正在提供服务",
        dnsReady:"DNS 已解析",
        dnsPending:"暂时无法访问",
        dnsUnknown:"无法检查",
        dnsLinkWaiting:"确认 DNS 解析后将显示远程链接。",
        ready:"就绪",
        waiting:"等待中",
        removeAction:"删除自定义隧道",
        removeTitle:"删除此自定义隧道？",
        removeDescription:"断开连接后会删除隧道身份。Cloudflare 无法删除 DNS 记录，因此再次使用此主机名前必须在控制台中删除该记录。",
        removeConfirm:"删除隧道",
        removeLocally:"请在运行 Unsloth 的机器上打开设置，以删除这个已连接的隧道。",
        dnsConflict:"记录 {hostname} 已存在。请在 Cloudflare 中删除该记录，或选择其他主机名。",
        orphanedRecords:"Cloudflare 中遗留的 DNS 记录：{hostnames}。再次使用前请在 Cloudflare 控制台中删除。",
        requestFailed:"远程访问请求失败。",
        runtimeFailed:"远程隧道失败。请重试，或查看服务器日志了解详情。",
        ...
        autoStartCustom:"Unsloth 启动时连接此固定主机名。现在断开连接不会关闭此设置。",
        autoStartCustomMissing:"自定义隧道自动启动需要先配置隧道。",
        ...
        errorTeardownFailed:"Cloudflare 未能完成自定义隧道移除。请重试。",
        errorTeardownManual:"本地隧道设置已移除，但 Cloudflare 清理未完成。请在 Cloudflare 控制面板中检查隧道和 DNS 记录。",
