...
export const zhCN = {
  ...
  notebooks: {
    ...
    title: "Unsloth 笔记本",
    subtitle:
      "来自 unslothai/notebooks 的官方微调配方。可在 Colab 中打开，或预填到 Fine-tuning Studio。",
    searchPlaceholder: "搜索笔记本…",
    pickerPlaceholder: "搜索并选择笔记本…",
    pickerEmpty: "没有与搜索匹配的笔记本。",
    pickedSection: "已选笔记本",
    resultsCount: "{count} 个笔记本",
    allCategories: "全部",
    featured: "精选",
    featuredSection: "精选笔记本",
    allSection: "全部笔记本",
    loading: "正在加载笔记本…",
    loadFailed: "加载笔记本失败",
    emptyTitle: "未找到笔记本",
    emptyDescription: "请尝试其他搜索或分类筛选。",
    useInStudio: "在 Studio 中使用",
    openInColab: "在 Colab 中打开",
    viewOnGitHub: "GitHub",
    studioModelReady: "预填 Studio：{model}",
    studioManualConfigure: "将打开 Fine-tuning Studio — 请选择与此笔记本匹配的模型。",
    studioOpenedWithoutModel: "已打开 Fine-tuning Studio。请选择与此笔记本匹配的模型。",
    studioDisabled: {
      mlxUnavailable:
        "训练需要 MLX。请运行 `unsloth studio update` 以启用“在 Studio 中使用”。",
      intelMac:
        "训练需要 Apple Silicon 或 GPU。Intel Mac 仅支持聊天。",
      noGpu: "训练需要 NVIDIA 或 AMD GPU。",
      generic: "此设备无法进行训练。",
    },
    categories: {
      sft: "微调",
