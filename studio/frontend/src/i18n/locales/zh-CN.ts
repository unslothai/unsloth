  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Unsloth 将准备一个 Cloudflare 页面。打开后，选择与此主机名匹配的域名，然后批准访问。",
        setupConfirmAction:"准备 Cloudflare",
        setupPreparing:"正在准备 Cloudflare...",
        setupAuthorize:"打开 Cloudflare，选择与 {hostname} 匹配的域名，然后批准访问。",
        removeProgress:"正在从 Unsloth 中移除已保存的连接...",
        openCloudflare:"打开 Cloudflare",
        ready:"就绪",
        removeAction:"移除",
        removeTitle:"从 Unsloth 中移除此自定义隧道？",
        removeDescription:"这只会移除 Unsloth 中保存的连接。隧道和 DNS 记录会保留在 Cloudflare 中。",
        ...
        dnsConflict:"记录 {hostname} 已存在。请在 Cloudflare 中删除该记录，或选择其他主机名。",
        requestFailed:"远程访问请求失败。",
        runtimeFailed:"远程访问意外停止。请重试，或查看服务器日志。",
        temporaryAction:"启动临时隧道",
        connectAction:"连接",
        stopAction:"断开连接",
        actionStarting:"正在启动...",
        actionStopping:"正在停止...",
        ...
        autoStartCustomMissing:"请先设置自定义隧道，再开启此选项。",
        blockServerStarting:"服务器完成启动后即可使用远程访问。",
        blockPasswordDesktop:"请先设置远程密码，再启动远程访问。",
        ...
        dnsConflictUnknown:"现有 DNS 记录占用了此主机名。请在 Cloudflare 中删除该记录，或选择其他主机名。",
        errorInvalidHostname:"请输入完整的主机名，例如 studio.example.com。",
        errorWrongDomain:"Cloudflare 未授权 {hostname}。请重试并选择此主机名所属的域名。",
        errorHostnameUnreachable:"Cloudflare 已连接，但无法打开 {hostname}。请移除此自定义隧道，重新设置并选择匹配的域名。",
        errorCertificateExists:"Studio 不会覆盖 {path} 中现有的 Cloudflare 证书。请将其移走后重试。",
        errorBusy:"另一项远程访问操作正在进行。请等待其完成后重试。",
        errorIdentityExists:"已配置自定义隧道。请先将其移除，再设置其他主机名。",
        errorUnavailable:"无法连接 Cloudflare。请检查网络连接后重试。",
        errorCancelled:"已取消 Cloudflare 授权。",
        errorLoginTimeout:"Cloudflare 授权超时。请重新开始设置。",
        errorLoginFailed:"Cloudflare 授权失败。请重新开始设置。",
        errorSetupFailed:"Cloudflare 未能完成自定义隧道设置。请重试。",
        errorTeardownFailed:"Unsloth 无法移除保存的自定义隧道。请重试。",
        errorTeardownManual:"自定义隧道已从 Unsloth 中移除。",
        errorUnknown:"自定义隧道操作失败。请重试，或查看服务器日志了解详情。",
      },
      notifications: {
        sectionTitle: "通知",
