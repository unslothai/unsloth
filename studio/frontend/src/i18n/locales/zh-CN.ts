...
export const zhCN = {
  ...
  skills: {
    ...
    newSkill: "新建技能",
    delete: "删除 {name}",
    createDescription: "保存为 ~/.agents/skills 下新文件夹中的 SKILL.md，创建后立即启用。",
    nameLabel: "名称",
    namePlaceholder: "例如 code-arithmetic",
    nameHint: "小写字母、数字和单个连字符。同时也是文件夹名。",
    nameInvalid: "请使用 1 到 64 个小写字母、数字或单个连字符，且不能以连字符开头或结尾。",
    descriptionLabel: "描述",
    descriptionPlaceholder: "当用户要求做算术时使用。始终用代码工具计算。",
    descriptionHint: "模型在技能目录中看到的这一行。模型据此决定何时读取该技能。",
    instructionsLabel: "说明",
    instructionsPlaceholder: "该技能适用时要做什么，用 Markdown 编写。",
    instructionsHint: "SKILL.md 的正文，模型选中技能后会完整读取。",
    create: "创建技能",
    save: "保存更改",
    created: "已创建 {name}",
    saved: "已保存 {name}",
    ...
    deleteError: "无法删除技能",
    deleteTitle: "删除技能",
    deleteDescription: "删除“{name}”以及 ~/.agents/skills 下其文件夹中的全部内容？此操作无法撤销。",
    search: "按名称或描述搜索技能…",
    noMatch: "没有与“{query}”匹配的技能",
    clearSearch: "清除搜索",
    count: "{shown} / {total} 个技能",
    readOnlyClaude: "只读：位于 ~/.claude/skills。请在那里编辑文件。",
    readOnlyBundled: "只读：Unsloth Studio 内置。",
    ...
    enabledLabel: "已启用",
    locationLabel: "位置",
    fromAgents: "位于 ~/.agents/skills 的技能。此处的更改会直接写入其 SKILL.md。",
    fromClaude: "位于 ~/.claude/skills 的技能。",
    fromBundled: "Unsloth Studio 内置。",
    detailsTitle: "详细信息",
    detailsDescription: "SKILL.md 前置元数据中的其他字段。如需更改，请编辑文件。",
    detailsEmpty: "没有其他字段。",
    licenseLabel: "许可证",
    compatibilityLabel: "兼容性",
    allowedToolsLabel: "允许的工具",
    deleteLabel: "删除技能",
    deleteRowDescription: "删除 ~/.agents/skills 下的该文件夹及其全部内容。",
    summary: "已启用 {enabled} / {total}",
    enabledOnly: "仅已启用",
    sectionAgents: "你的技能",
    sectionAgentsHint: "保存在 ~/.agents/skills。可在此创建、编辑和删除。",
    sectionClaude: "Claude 技能",
    sectionClaudeHint: "来自 ~/.claude/skills。此处只读，请在那里编辑文件。",
    sectionBundled: "内置",
    sectionBundledHint: "随 Unsloth Studio 提供。只读。",
    newSkillHint: "在此编写。它会保存到 ~/.agents/skills。",
    edit: "编辑",
    view: "查看",
    linked: "链接",
    emptyTitle: "还没有技能",
    previewTitle: "模型看到的内容",
    previewHint: "它在目录中的那一行。模型据此决定是否打开该技能并阅读说明。",
