...
export const zhCN = {
  ...
  systemPill: {
    ask: {
      ...
      copy: "复制",
      copied: "已复制",
      noModel: "没有可用的模型。请在设置中选择默认模型。",
      failed: "出错了。后端正在运行吗？",
      autoModel: "当前模型",
      enterHint: "提问",
      escHint: "关闭",
      context: "已选文本（{chars} 个字符）",
      followUp: "继续追问...",
      clear: "清除",
    },
    settings: {
      ...
      permissionRequest: "请求",
      hotkey: "快捷键",
      defaultModel: "默认模型",
      defaultModelDescription: "用于回答提问栏的问题。留空则使用已加载的模型。",
      addAction: "添加操作",
      editAction: "编辑",
      deleteAction: "删除",
      actionName: "名称",
      actionPrompt: "提示词",
      actionPromptHint: "必须包含 {selection}。",
      actionSystemPrompt: "系统提示词（可选）",
      actionModel: "模型",
      actionModelDefault: "使用已加载的模型",
      actionOutputMode: "结果",
      outputModeReplace: "替换选中内容",
      outputModeShow: "显示结果",
      actionEnabled: "已启用",
      saveError: "保存失败。请重试。",
    },
