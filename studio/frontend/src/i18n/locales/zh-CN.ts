  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        progressConnecting:"正在连接",
        progressOpeningLink:"正在打开安全链接",
        progressCheckingHostname:"正在检查主机名",
        progressDisconnecting:"正在断开连接",
        stateOff:"已关闭",
        stateStarting:"启动中",
        stateOnline:"在线",
        stateStopping:"正在停止",
        ...
        ownerLaunch:"由启动命令管理",
        ownerColab:"由 Colab 管理",
        copied:"已复制",
        copyUrl:"复制 URL",
        qrTitle:"在手机上打开",
        qrDescription:"扫描二维码，在手机浏览器中打开远程 URL。",
        remoteUrl:"远程 URL",
        remoteUrlReady:"远程链接已就绪。",
        urlHint:"任何拥有此 URL 和远程密码的人都可以登录。",
        streamingSupported:"此隧道支持流式响应。",
        streamingBuffered:"临时隧道会将流式响应缓冲到完成后再发送。",
        passwordLabel:"远程密码",
        passwordDescription:"远程浏览器以 unsloth 身份登录。桌面应用会继续自动登录。",
        customHostnameTitle:"自定义主机名",
        customHostnameDescription:"使用您自己的主机名，让地址保持不变。",
        hostnameLabel:"完整主机名",
        hostnamePlaceholder:"unsloth.example.com",
        setupAction:"设置",
        setupConfirmTitle:"设置此主机名？",
        setupConfirmAction:"确认",
        setupConfirmDescription:"请核对下方主机名。随后 Cloudflare 会要求你授权此隧道：选择该主机名所属的域名，然后点击 Authorize。",
        setupPreparing:"正在打开 Cloudflare，以便你授权此隧道…",
        setupAuthorize:"等待你在 Cloudflare 中授权。请选择 {hostname} 所属的域名，然后点击 Authorize。",
        removeProgress:"正在从 Unsloth 中移除已保存的连接...",
        openCloudflare:"打开 Cloudflare",
        removeAction:"移除",
        removeTitle:"从 Unsloth 中移除此自定义隧道？",
        removeDescription:"这只会移除 Unsloth 中保存的内容。隧道及其 DNS 记录仍保留在 Cloudflare，直到你在那里删除。",
        removeTunnelHint:"在 Cloudflare 中删除此隧道：",
        tunnelNameUnavailable:"隧道名称不可用",
        openCloudflareTunnels:"打开 Cloudflare 隧道",
        removeDnsHint:"然后删除此 DNS 记录：",
        openCloudflareDns:"打开 DNS 记录",
        removeConfirm:"从 Unsloth 中移除",
        removeLocally:"请在运行 Unsloth 的机器上打开设置，以删除这个已连接的隧道。",
        dnsConflict:"{hostname} 在 Cloudflare 中已指向别处。请删除该 DNS 记录，或改用其他主机名。",
        requestFailed:"远程访问请求失败。",
        ...
        autoStartCustomMissing:"在下方设置自定义主机名之前，这不会连接任何内容。",
        blockServerStarting:"服务器启动完成后即可使用远程访问。",
        blockCustomNotConfigured:"请先在下方设置自定义主机名，再启动远程访问。",
        blockPasswordDesktop:"请先在下方设置远程密码，再启动远程访问。",
        blockPasswordWeb:"请让主机管理员设置远程密码。",
        blockExplicitlyDisabled:"此服务器启动时已禁用远程访问。",
        blockLaunchManaged:"此隧道由服务器启动命令管理。",
        blockColabManaged:"此隧道由 Colab 会话管理。",
        blockColab:"远程访问设置由 Colab 管理。",
        dnsConflictUnknown:"该主机名在 Cloudflare 中已指向别处。请删除该 DNS 记录，或改用其他主机名。",
        errorInvalidHostname:"这不是完整主机名。请输入类似 unsloth.example.com 的地址。",
        errorWrongDomain:"你在 Cloudflare 授权的域名不包含 {hostname}。请重新设置，并选择该主机名所属的域名。",
        errorHostnameUnreachable:"隧道已连接，但 {hostname} 无法打开。请移除此自定义隧道后重新设置，并选择该主机名所属的域名。",
        errorCertificateExists:"{path} 已存在 Cloudflare 证书，Unsloth 不会覆盖它。请移动或删除该文件后重新设置。",
        errorBusy:"另一项远程访问操作仍在进行。请等待其完成后重试。",
        errorIdentityExists:"已设置自定义隧道。请先移除，再设置其他主机名。",
        errorUnavailable:"无法连接 Cloudflare。请检查本机的网络连接后重试。",
        errorCancelled:"设置已取消。准备好后可重新设置。",
        errorLoginTimeout:"未能及时完成 Cloudflare 授权。请重新设置，并在 Cloudflare 页面打开时点击 Authorize。",
        errorLoginFailed:"Cloudflare 未完成授权。请重新设置。",
        errorSetupFailed:"自定义隧道未能完成设置。请重新设置，或查看服务器日志。",
        errorTeardownFailed:"无法移除已保存的自定义隧道。请重试，或查看服务器日志。",
        errorTeardownManual:"自定义隧道已从 Unsloth 中移除。",
        errorUnknown:"自定义隧道的更改未完成。请重试，或查看服务器日志。",
      },
      notifications: {
        sectionTitle: "通知",
