...
export const ar = {
  ...
  promptQueue: {
    ...
    queueingOffHint: "الرسائل الجديدة المرسلة أثناء الرد ستوقف ذلك الرد وتُنفَّذ بعده مباشرة.",
    queueingOnHint: "الرسائل الجديدة المرسلة أثناء الرد ستنتظر دورها وتُنفَّذ بالترتيب.",
    queueingHintShared: "تبقى الرسائل الموجودة في الطابور كما هي؛ وهذا لا يوقف الطابور مؤقتًا ولا يستأنفه.",
  },
  picker: {
    onDevice: "على الجهاز",
