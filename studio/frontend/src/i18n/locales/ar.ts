...
export const ar = {
  ...
  notebooks: {
    routeTitle: "دفاتر الملاحظات",
    title: "دفاتر Unsloth",
    subtitle:
      "وصفات الضبط الدقيق الرسمية من unslothai/notebooks. افتحها في Colab أو املأ Fine-tuning Studio مسبقًا.",
    searchPlaceholder: "ابحث في الدفاتر…",
    pickerPlaceholder: "ابحث واختر دفترًا…",
    pickerEmpty: "لا توجد دفاتر تطابق بحثك.",
    pickedSection: "الدفتر المحدد",
    resultsCount: "{count} دفترًا",
    allCategories: "الكل",
    featured: "مميز",
    featuredSection: "دفاتر مميزة",
    allSection: "كل الدفاتر",
    loading: "جارٍ تحميل الدفاتر…",
    loadFailed: "فشل تحميل الدفاتر",
    emptyTitle: "لم يُعثر على دفاتر",
    emptyDescription: "جرّب بحثًا أو تصنيفًا مختلفًا.",
    useInStudio: "استخدم في Studio",
    openInColab: "افتح في Colab",
    viewOnGitHub: "GitHub",
    studioModelReady: "يملأ Studio مسبقًا: {model}",
    studioManualConfigure:
      "يفتح Fine-tuning Studio — اختر نموذجًا يطابق هذا الدفتر.",
    studioOpenedWithoutModel:
      "فُتح Fine-tuning Studio. اختر نموذجًا يطابق هذا الدفتر.",
    studioDisabled: {
      mlxUnavailable:
        "التدريب يحتاج إلى MLX. نفّذ `unsloth studio update` لتفعيل «استخدم في Studio».",
      intelMac:
        "التدريب يحتاج إلى Apple Silicon أو GPU. أجهزة Intel Mac تقتصر على الدردشة.",
      noGpu: "التدريب يحتاج إلى GPU من NVIDIA أو AMD.",
      generic: "التدريب غير متاح على هذا الجهاز.",
    },
    categories: {
      sft: "الضبط الدقيق",
      vision: "الرؤية",
