  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        urlHint:
          "يمكن لأي شخص لديه هذا الرابط وكلمة المرور البعيدة تسجيل الدخول.",
        streamingSupported: "يدعم هذا النفق الاستجابات المتدفقة.",
        streamingBuffered:
          "تخزن الأنفاق المؤقتة الاستجابات المتدفقة حتى اكتمالها.",
        passwordLabel: "كلمة المرور البعيدة",
        passwordDescription:
          "تسجل المتصفحات البعيدة الدخول باسم unsloth. يواصل تطبيق سطح المكتب تسجيل الدخول تلقائيًا.",
        customHostnameTitle: "اسم مضيف مخصص",
        customHostnameDescription:
          "استخدم اسم المضيف الخاص بك ليبقى العنوان ثابتًا.",
        ...
        setupConfirmDescription:
          "تحقق من اسم المضيف أدناه. سيطلب منك Cloudflare بعد ذلك تفويض هذا النفق: اختر النطاق الذي ينتمي إليه اسم المضيف هذا، ثم انقر على Authorize.",
        setupPreparing: "جارٍ فتح Cloudflare لتتمكن من تفويض هذا النفق…",
        setupAuthorize:
          "في انتظار تفويضك في Cloudflare. اختر النطاق الذي ينتمي إليه {hostname}، ثم انقر على Authorize.",
        ...
        removeDescription:
          "هذا يزيل ما حفظه Unsloth فقط. يبقى النفق وسجل DNS الخاص به في Cloudflare حتى تحذفهما هناك.",
        ...
        removeLocally:
          "افتح الإعدادات على الجهاز الذي يشغّل Unsloth لإزالة هذا النفق المتصل.",
        dnsConflict:
          "يشير {hostname} بالفعل إلى وجهة أخرى في Cloudflare. احذف سجل DNS ذاك، أو أعدّ اسم مضيف مختلفاً.",
        requestFailed: "فشل طلب الوصول عن بُعد.",
        runtimeFailed:
          "توقف الوصول عن بُعد بشكل غير متوقع. أعد المحاولة أو راجع سجلات الخادم.",
        startAction: "بدء",
        stopAction: "إيقاف",
        autoStartLabel: "البدء تلقائيًا",
        autoStartTemporary:
          "إنشاء رابط مؤقت جديد عند بدء Unsloth. قطع الاتصال الآن لا يعطل هذا الإعداد.",
        autoStartCustom:
          "الاتصال باسم المضيف المخصص عند بدء Unsloth. قطع الاتصال الآن لا يعطل هذا الإعداد.",
        autoStartCustomMissing:
          "لن يتصل هذا بأي شيء حتى تُعدّ اسم مضيف مخصصاً أدناه.",
        blockServerStarting:
          "سيتوفر الوصول عن بُعد بمجرد اكتمال بدء تشغيل الخادم.",
        blockCustomNotConfigured:
          "أعدّ اسم مضيف مخصصاً أدناه قبل بدء الوصول عن بُعد.",
        blockPasswordDesktop:
          "عيّن كلمة مرور للوصول عن بُعد أدناه قبل بدء الوصول عن بُعد.",
        ...
        dnsConflictUnknown:
          "يشير اسم المضيف هذا بالفعل إلى وجهة أخرى في Cloudflare. احذف سجل DNS ذاك، أو أعدّ اسم مضيف مختلفاً.",
        errorInvalidHostname:
          "هذا ليس اسم مضيف كاملاً. أدخل اسماً مثل unsloth.example.com.",
        errorWrongDomain:
          "النطاق الذي فوّضته في Cloudflare لا يشمل {hostname}. أعد الإعداد واختر النطاق الذي ينتمي إليه اسم المضيف هذا.",
        errorHostnameUnreachable:
          "تم اتصال النفق، لكن {hostname} لم يُفتح. أزل هذا النفق المخصص وأعد إعداده، ثم اختر النطاق الذي ينتمي إليه اسم المضيف هذا.",
        errorCertificateExists:
          "توجد بالفعل شهادة Cloudflare في {path}، ولن يستبدلها Unsloth. انقل ذلك الملف أو احذفه، ثم أعد الإعداد.",
        errorBusy:
          "لا يزال هناك تغيير آخر للوصول عن بُعد قيد التنفيذ. انتظر انتهاءه ثم أعد المحاولة.",
        errorIdentityExists:
          "تم إعداد نفق مخصص بالفعل. أزله قبل إعداد اسم مضيف آخر.",
        errorUnavailable:
          "تعذّر الوصول إلى Cloudflare. تحقق من اتصال الإنترنت على هذا الجهاز ثم أعد المحاولة.",
        errorCancelled: "أُلغي الإعداد. أعِد الإعداد عندما تكون جاهزاً.",
        errorLoginTimeout:
          "لم يتم تفويض Cloudflare في الوقت المحدد. أعد الإعداد وانقر على Authorize عند فتح صفحة Cloudflare.",
        errorLoginFailed: "لم يُكمل Cloudflare التفويض. أعد الإعداد.",
        errorSetupFailed:
          "تعذّر إكمال النفق المخصص. أعد الإعداد أو راجع سجلات الخادم.",
        errorTeardownFailed:
          "تعذّرت إزالة النفق المخصص المحفوظ. أعد المحاولة أو راجع سجلات الخادم.",
        errorTeardownManual: "تمت إزالة النفق المخصص من Unsloth.",
        errorUnknown:
          "لم يكتمل تغيير النفق المخصص. أعد المحاولة أو راجع سجلات الخادم.",
      },
      notifications: {
