  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        experimental: "تجريبي",
        description: "اطرح أسئلة نعم/لا واختيار وتقييم عن أي نص واحصل على احتمالات معايَرة من نموذج Laya محلي. وهي متوافقة مع واجهة Jev، لذا تعمل حزمة TypeSafe كما هي.",
        enable: "خدمة الطلبات",
        enableDescription: "يجيب على POST /v1/systemone. عند التشغيل يُنزَّل النموذج، ويُحمَّل في الذاكرة عند أول طلب.",
        lockedByEnv: "مضبوط بواسطة {name}.",
        model: "النموذج",
        modelDescription: "المتعدد اللغات يغطي أكثر من 100 لغة. الإنجليزي أكبر حجمًا ومخصص للإنجليزية فقط.",
        ...
        tryIt: "جرّبها",
        caveat: "النماذج الأساسية عامة الغرض. تحقّق من الإجابات على بياناتك قبل الاعتماد عليها.",
      },
      usageNoModel:
