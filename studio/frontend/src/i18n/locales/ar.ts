  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        keepResidentHint: "لا تُعاد الأوزان إلى ذاكرة النظام ما دام النموذج محمَّلاً. يعطّل التفريغ التلقائي عند الخمول ويمرّر ‎--mlock‎ حتى لا يُخرج النظام النموذج من الذاكرة ويعيد رفعه عند رسالتك التالية.",
