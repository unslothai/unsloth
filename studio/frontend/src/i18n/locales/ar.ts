...
export const ar = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "علامات تبويب الصور والفيديو والصوت",
      mediaTabsDescription: "إظهار هذه العلامات فقط عند وجود ملفات لها، أو دائمًا.",
      mediaTabsAuto: "عند وجود ملفات",
      mediaTabsAlways: "دائمًا",
      ...
      showFineTunes: "النماذج المضبوطة",
      showFineTunesDescription: "النماذج التي درّبتها أو صدّرتها في Studio.",
