...
export const ar = {
  ...
  settings: {
    ...
    resources: {
      ...
      llamaBackend: {
        exactConcurrency: {
          label: "التزامن الدقيق",
          description: "يقلل الإنتاجية عند تشغيل عدة محادثات معًا، ويُطبَّق عند تحميل النموذج التالي.",
          hint: "اطلب من llama-server فك ترميز لا تعتمد نتيجته على المحادثات الأخرى التي تشارك ذاكرة KV: تنتج المحادثة نفس الرموز وحدها وبجوار ثلاث محادثات أخرى. «تلقائي» يطلبه ويتابع بدونه إذا رفض الخادم، و«تشغيل» يطلبه ويُفشل التحميل بدلًا من ذلك، و«إيقاف» لا يطلبه أبدًا.",
          auto: "تلقائي",
          off: "إيقاف",
          on: "تشغيل",
