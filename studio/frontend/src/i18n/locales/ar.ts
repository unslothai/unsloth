  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"تديره الإعدادات",
        ownerColab:"يديره Colab",
        copied:"تم النسخ",
        copyUrl:"نسخ الرابط",
        ...
        stableTitle:"اسم مضيف ثابت",
        stableDescription:"أنشئ نفق Cloudflare مخصص لرابط دائم وبث استجابات API.",
        hostnameLabel:"اسم المضيف الكامل",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"إعداد",
        settingUp:"جارٍ الإعداد...",
        provisionProgress:"فوّض Cloudflare في المتصفح. سيكمل Unsloth إنشاء النفق وسجل DNS.",
        teardownProgress:"فوّض Cloudflare لإزالة النفق. سيبقى سجل DNS لتحذفه يدويًا.",
        openCloudflare:"فتح Cloudflare",
        connectorReady:"تم تسجيل الموصل",
        tunnelReady:"النفق يعمل",
        dnsReady:"تم حل DNS",
        dnsPending:"لم يصبح متاحًا بعد",
        dnsUnknown:"تعذر التحقق",
        dnsLinkWaiting:"سيظهر الرابط البعيد بعد تأكيد حل DNS.",
        ready:"جاهز",
        waiting:"قيد الانتظار",
        removeAction:"إزالة النفق المخصص",
        removeTitle:"هل تريد إزالة هذا النفق المخصص؟",
        removeDescription:"سيُحذف معرّف النفق بعد قطع اتصاله. لا يستطيع Cloudflare حذف سجل DNS؛ احذفه من لوحة التحكم قبل إعادة استخدام الاسم.",
        removeConfirm:"إزالة النفق",
        ...
        orphanedRecords:"سجلات DNS المتبقية في Cloudflare: {hostnames}. احذفها من لوحة التحكم قبل إعادة استخدامها.",
        requestFailed:"فشل طلب الوصول عن بُعد.",
        runtimeFailed:"فشل النفق البعيد. أعد المحاولة أو راجع سجلات الخادم.",
        ...
        autoStartCustom:"الاتصال باسم المضيف الثابت عند بدء Unsloth. قطع الاتصال الآن لا يعطل هذا الإعداد.",
        autoStartCustomMissing:"يتطلب البدء التلقائي للنفق المخصص نفقًا مهيأ.",
        ...
        errorTeardownFailed:"تعذر على Cloudflare إكمال إزالة النفق المخصص. أعد المحاولة.",
        errorTeardownManual:"تمت إزالة إعدادات النفق المحلية، لكن تنظيف Cloudflare لم يكتمل. تحقق من النفق وسجل DNS في لوحة Cloudflare.",
