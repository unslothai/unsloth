  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        mlockUngoverned: "يستخدم النموذج المحمَّل مشغّلاً لا تتحكم فيه «ذاكرة النموذج»، لذلك لا يمكن لهذا الإعداد التأثير في التشغيل الحالي. يظل الإعداد محفوظاً وسيُطبَّق على نموذج llama.cpp التالي الذي تحمّله.",
