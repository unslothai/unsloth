  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"أكد اسم المضيف أدناه. في Cloudflare، اختر النطاق المطابق ثم وافق على الوصول.",
        setupPreparing:"جارٍ الاتصال بـ Cloudflare...",
        setupAuthorize:"في انتظار الموافقة في Cloudflare. اختر النطاق المطابق لـ {hostname}.",
        ...
        removeDescription:"سيؤدي هذا إلى إزالة الاتصال المحفوظ في Unsloth فقط. سيبقى النفق وسجل DNS في Cloudflare.",
        ...
        dnsConflict:"السجل {hostname} موجود بالفعل. احذفه في Cloudflare أو اختر اسم مضيف آخر.",
        ...
        autoStartCustomMissing:"أعدّ نفقًا مخصصًا قبل تفعيل هذا الخيار.",
        blockServerStarting:"سيصبح الوصول عن بُعد متاحًا بعد اكتمال بدء تشغيل الخادم.",
        blockPasswordDesktop:"عيّن كلمة مرور للوصول عن بُعد قبل تشغيله.",
        ...
        dnsConflictUnknown:"يمنع سجل DNS موجود استخدام اسم المضيف هذا. احذف السجل من Cloudflare أو اختر اسم مضيف آخر.",
        errorInvalidHostname:"أدخل اسم مضيف كاملاً مثل studio.example.com.",
        errorWrongDomain:"لم يفوض Cloudflare المضيف {hostname}. حاول مجددًا واختر النطاق الذي يستخدمه اسم المضيف.",
        errorHostnameUnreachable:"اتصل Cloudflare، لكن {hostname} لم يفتح. أزل هذا النفق المخصص وأعد إعداده واختر النطاق المطابق.",
        errorCertificateExists:"لن يستبدل Studio شهادة Cloudflare الموجودة في {path}. انقلها إلى مكان آخر ثم أعد المحاولة.",
        errorBusy:"هناك عملية وصول عن بُعد أخرى قيد التنفيذ. انتظر حتى تنتهي ثم أعد المحاولة.",
        errorIdentityExists:"تم إعداد نفق مخصص بالفعل. أزله قبل إعداد اسم مضيف آخر.",
        errorUnavailable:"تعذر الوصول إلى Cloudflare. تحقق من اتصالك وأعد المحاولة.",
        errorCancelled:"تم إلغاء تفويض Cloudflare.",
        errorLoginTimeout:"انتهت مهلة تفويض Cloudflare. ابدأ الإعداد من جديد.",
        errorLoginFailed:"فشل تفويض Cloudflare. ابدأ الإعداد من جديد.",
        errorSetupFailed:"تعذر على Cloudflare إكمال إعداد النفق المخصص. أعد المحاولة.",
        errorTeardownFailed:"تعذر على Unsloth إزالة النفق المخصص المحفوظ. أعد المحاولة.",
        errorTeardownManual:"تمت إزالة النفق المخصص من Unsloth.",
        errorUnknown:"فشلت عملية النفق المخصص. أعد المحاولة أو راجع سجلات الخادم.",
      },
      notifications: {
