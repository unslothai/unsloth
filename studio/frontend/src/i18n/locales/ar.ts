...
export const ar = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "اسأل",
      escHint: "إغلاق",
      context: "النص المحدد ({chars} حرفا)",
    ...
    settings: {
      ...
      setUp: "الإعداد...",
      permission: "الوصول إلى تسهيلات الاستخدام",
      permissionGranted: "ممنوح",
      permissionMissing: "غير ممنوح",
      permissionRequest: "طلب",
      hotkey: "الاختصار",
      ...
      actionName: "الاسم",
      actionPrompt: "الموجه",
      actionPromptHint: "يجب أن يحتوي على {selection}.",
      actionSystemPrompt: "موجه النظام (اختياري)",
      actionModel: "النموذج",
      actionModelDefault: "استخدام النموذج المحمل",
      actionOutputMode: "النتيجة",
      outputModeReplace: "استبدال التحديد",
      outputModeShow: "عرض النتيجة",
      actionEnabled: "مفعل",
