...
export const ar = {
  ...
  skills: {
    ...
    delete: "حذف {name}",
    createDescription: "تُحفظ كملف SKILL.md في مجلد جديد ضمن ‎~/.agents/skills وتُفعَّل فور إنشائها.",
    nameLabel: "الاسم",
    namePlaceholder: "مثل code-arithmetic",
    nameHint: "أحرف لاتينية صغيرة وأرقام وشرطات مفردة. وهو أيضًا اسم المجلد.",
    nameInvalid: "استخدم من 1 إلى 64 حرفًا لاتينيًا صغيرًا أو رقمًا أو شرطة مفردة، دون أن يبدأ الاسم بشرطة أو ينتهي بها.",
    descriptionLabel: "الوصف",
    descriptionPlaceholder: "تُستخدم عندما يطلب المستخدم عملية حسابية. احسبها دائمًا بأداة الكود.",
    descriptionHint: "السطر الذي يراه النموذج في فهرس المهارات. ومنه يقرر متى يقرأ المهارة.",
    instructionsLabel: "التعليمات",
    instructionsPlaceholder: "ما يجب فعله عندما تنطبق هذه المهارة، بصيغة Markdown.",
    instructionsHint: "متن SKILL.md، ويقرؤه النموذج كاملًا بعد اختيار المهارة.",
    create: "إنشاء المهارة",
    save: "حفظ التغييرات",
    created: "تم إنشاء {name}",
    saved: "تم حفظ {name}",
    deleted: "تم حذف {name}",
    saveError: "تعذّر حفظ المهارة",
    openError: "تعذّر فتح المهارة",
    deleteError: "تعذّر حذف المهارة",
    deleteTitle: "حذف المهارة",
    deleteDescription: 'هل تريد حذف "{name}" وكل ما في مجلدها ضمن ‎~/.agents/skills؟ لا يمكن التراجع عن هذا الإجراء.',
    search: "ابحث عن المهارات بالاسم أو الوصف…",
    noMatch: 'لا توجد مهارات تطابق "{query}"',
    clearSearch: "مسح البحث",
    count: "{shown} من {total} مهارة",
    readOnlyClaude: "للقراءة فقط: موجودة في ‎~/.claude/skills. عدّل الملف هناك.",
    readOnlyBundled: "للقراءة فقط: مضمّنة مع Unsloth Studio.",
    readOnlyLinked: "للقراءة فقط: هذا الإدخال رابط. عدّل الملفات في مكانها الأصلي.",
    characters: "{count} حرفًا",
    unsaved: "تغييرات غير محفوظة",
    revert: "تراجع",
    enabledLabel: "مفعّلة",
    locationLabel: "الموقع",
    fromAgents: "مهارة في ‎~/.agents/skills. تُكتب التغييرات هنا مباشرةً في ملف SKILL.md الخاص بها.",
    fromClaude: "مهارة في ‎~/.claude/skills.",
    fromBundled: "مضمّنة مع Unsloth Studio.",
    detailsTitle: "التفاصيل",
    detailsDescription: "الحقول الأخرى في مقدّمة ملف SKILL.md. عدّل الملف لتغييرها.",
    detailsEmpty: "لا توجد حقول أخرى.",
    licenseLabel: "الترخيص",
    compatibilityLabel: "التوافق",
    allowedToolsLabel: "الأدوات المسموح بها",
    deleteLabel: "حذف المهارة",
    deleteRowDescription: "يحذف المجلد الموجود في ‎~/.agents/skills وكل ما بداخله.",
    summary: "{enabled} من {total} مفعّلة",
    enabledOnly: "المفعّلة فقط",
    sectionAgents: "مهاراتك",
    sectionAgentsHint: "محفوظة في ‎~/.agents/skills. أنشئها وعدّلها واحذفها من هنا.",
    sectionClaude: "مهارات Claude",
    sectionClaudeHint: "موجودة في ‎~/.claude/skills. للقراءة فقط هنا؛ عدّل الملفات هناك.",
    sectionBundled: "مضمّنة",
    sectionBundledHint: "تأتي مع Unsloth Studio. للقراءة فقط.",
    newSkillHint: "اكتب واحدة هنا. تُحفظ في ‎~/.agents/skills.",
    edit: "تعديل",
    view: "عرض",
    linked: "رابط",
    emptyTitle: "لا توجد مهارات بعد",
    previewTitle: "ما يراه النموذج",
    previewHint: "سطرها في الفهرس. منه يقرر النموذج ما إذا كان سيفتح المهارة ويقرأ التعليمات.",
    previewName: "skill-name",
    mention: "اذكرها في الدردشة",
    copyMention: "نسخ @{name}",
    sourceLabel: "المصدر",
