  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"سيجهز Unsloth صفحة Cloudflare. افتحها واختر النطاق المطابق لاسم المضيف هذا، ثم وافق على الوصول.",
        setupConfirmAction:"تجهيز Cloudflare",
        setupPreparing:"جارٍ إعداد Cloudflare...",
        setupAuthorize:"افتح Cloudflare واختر النطاق المطابق لـ {hostname}، ثم وافق على الوصول.",
        ...
        temporaryAction:"بدء نفق مؤقت",
        connectAction:"اتصال",
        stopAction:"قطع الاتصال",
