  ...
  settings: {
    ...
    chat: {
      ...
      compactionDescriptionInherit:
        "يضغط المحادثة وفق السياسة المضبوطة على الخادم، وهي افتراضيًا «إعادة ضبط المحادثة».",
      compactionDescriptionCheckpoint:
        "يضغط المحادثة مع الاحتفاظ بآخر تبادل للرسائل وبما يتّسع من التعليمات الدائمة، وأرشفة البقية ليتسنى استرجاعها.",
      compactionDescriptionRolling:
        "يضغط المحادثة بأرشفة أقدم التبادلات، مع الاحتفاظ بالسجل الحديث والمساحة الإضافية المحددة.",
      ...
      compactionStyleDescription:
        "كيفية ضغط المحادثة عندما تملأ سياقها. يتبع الخيار الافتراضي للخادم قيمة UNSLOTH_CONTEXT_POLICY على الخادم، وهي تُشحن بقيمة checkpoint ومن ثم تطابق «إعادة ضبط المحادثة» إلى أن تُغيَّر. تحتفظ إعادة ضبط المحادثة بأحدث دور وبما يتّسع من التعليمات الدائمة. أما أرشفة أقدم الأدوار فتحذف الأقدم ويمكنها الاحتفاظ بمزيد من السجل الحديث.",
