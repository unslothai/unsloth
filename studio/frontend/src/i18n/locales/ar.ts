  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        progressConnecting:"جارٍ الاتصال",
        progressOpeningLink:"جارٍ فتح الرابط الآمن",
        progressCheckingHostname:"جارٍ التحقق من اسم المضيف",
        progressDisconnecting:"جارٍ قطع الاتصال",
        stateOff:"متوقف",
        stateStarting:"جارٍ البدء",
        stateOnline:"متصل",
        stateStopping:"جارٍ الإيقاف",
        stateError:"خطأ",
        stateUnavailable:"غير متاح",
        ownerLaunch:"تديره عملية التشغيل",
        ownerColab:"تديره جلسة Colab",
        copied:"تم النسخ",
        copyUrl:"نسخ الرابط",
        qrTitle:"فتح على الهاتف",
        qrDescription:"امسح لفتح الرابط البعيد في متصفح هاتفك.",
        remoteUrl:"الرابط البعيد",
        remoteUrlReady:"الرابط البعيد جاهز.",
        urlHint:"يمكن لأي شخص لديه هذا الرابط وكلمة المرور البعيدة تسجيل الدخول.",
        streamingSupported:"يدعم هذا النفق الاستجابات المتدفقة.",
        streamingBuffered:"تخزن الأنفاق المؤقتة الاستجابات المتدفقة حتى اكتمالها.",
        passwordLabel:"كلمة المرور البعيدة",
        passwordDescription:"تسجل المتصفحات البعيدة الدخول باسم unsloth. يواصل تطبيق سطح المكتب تسجيل الدخول تلقائيًا.",
        customHostnameTitle:"اسم مضيف مخصص",
        customHostnameDescription:"استخدم اسم المضيف الخاص بك ليبقى العنوان ثابتًا.",
        hostnameLabel:"اسم المضيف الكامل",
        hostnamePlaceholder:"unsloth.example.com",
        setupAction:"إعداد",
        setupConfirmTitle:"هل تريد إعداد اسم المضيف هذا؟",
        setupConfirmAction:"تأكيد",
        setupConfirmDescription:"تحقق من اسم المضيف أدناه. سيطلب منك Cloudflare بعد ذلك تفويض هذا النفق: اختر النطاق الذي ينتمي إليه اسم المضيف هذا، ثم انقر على Authorize.",
        setupPreparing:"جارٍ فتح Cloudflare لتتمكن من تفويض هذا النفق…",
        setupAuthorize:"في انتظار تفويضك في Cloudflare. اختر النطاق الذي ينتمي إليه {hostname}، ثم انقر على Authorize.",
        removeProgress:"جارٍ إزالة الاتصال المحفوظ من Unsloth...",
        openCloudflare:"فتح Cloudflare",
        removeAction:"إزالة",
        removeTitle:"هل تريد إزالة هذا النفق المخصص من Unsloth؟",
        removeDescription:"هذا يزيل ما حفظه Unsloth فقط. يبقى النفق وسجل DNS الخاص به في Cloudflare حتى تحذفهما هناك.",
        removeTunnelHint:"احذف هذا النفق في Cloudflare:",
        tunnelNameUnavailable:"اسم النفق غير متاح",
        openCloudflareTunnels:"فتح أنفاق Cloudflare",
        removeDnsHint:"ثم احذف سجل DNS هذا:",
        openCloudflareDns:"فتح سجلات DNS",
        removeConfirm:"إزالة من Unsloth",
        removeLocally:"افتح الإعدادات على الجهاز الذي يشغّل Unsloth لإزالة هذا النفق المتصل.",
        dnsConflict:"يشير {hostname} بالفعل إلى وجهة أخرى في Cloudflare. احذف سجل DNS ذاك، أو أعدّ اسم مضيف مختلفاً.",
        requestFailed:"فشل طلب الوصول عن بُعد.",
        ...
        autoStartCustomMissing:"لن يتصل هذا بأي شيء حتى تُعدّ اسم مضيف مخصصاً أدناه.",
        blockServerStarting:"سيتوفر الوصول عن بُعد بمجرد اكتمال بدء تشغيل الخادم.",
        blockCustomNotConfigured:"أعدّ اسم مضيف مخصصاً أدناه قبل بدء الوصول عن بُعد.",
        blockPasswordDesktop:"عيّن كلمة مرور للوصول عن بُعد أدناه قبل بدء الوصول عن بُعد.",
        blockPasswordWeb:"اطلب من مسؤول المضيف تعيين كلمة مرور للوصول عن بُعد.",
        blockExplicitlyDisabled:"تم تعطيل الوصول عن بُعد عند تشغيل هذا الخادم.",
        blockLaunchManaged:"تتم إدارة هذا النفق بواسطة أمر تشغيل الخادم.",
        blockColabManaged:"تتم إدارة هذا النفق بواسطة جلسة Colab.",
        blockColab:"تتم إدارة إعدادات الوصول عن بُعد بواسطة Colab.",
        dnsConflictUnknown:"يشير اسم المضيف هذا بالفعل إلى وجهة أخرى في Cloudflare. احذف سجل DNS ذاك، أو أعدّ اسم مضيف مختلفاً.",
        errorInvalidHostname:"هذا ليس اسم مضيف كاملاً. أدخل اسماً مثل unsloth.example.com.",
        errorWrongDomain:"النطاق الذي فوّضته في Cloudflare لا يشمل {hostname}. أعد الإعداد واختر النطاق الذي ينتمي إليه اسم المضيف هذا.",
        errorHostnameUnreachable:"تم اتصال النفق، لكن {hostname} لم يُفتح. أزل هذا النفق المخصص وأعد إعداده، ثم اختر النطاق الذي ينتمي إليه اسم المضيف هذا.",
        errorCertificateExists:"توجد بالفعل شهادة Cloudflare في {path}، ولن يستبدلها Unsloth. انقل ذلك الملف أو احذفه، ثم أعد الإعداد.",
        errorBusy:"لا يزال هناك تغيير آخر للوصول عن بُعد قيد التنفيذ. انتظر انتهاءه ثم أعد المحاولة.",
        errorIdentityExists:"تم إعداد نفق مخصص بالفعل. أزله قبل إعداد اسم مضيف آخر.",
        errorUnavailable:"تعذّر الوصول إلى Cloudflare. تحقق من اتصال الإنترنت على هذا الجهاز ثم أعد المحاولة.",
        errorCancelled:"أُلغي الإعداد. أعِد الإعداد عندما تكون جاهزاً.",
        errorLoginTimeout:"لم يتم تفويض Cloudflare في الوقت المحدد. أعد الإعداد وانقر على Authorize عند فتح صفحة Cloudflare.",
        errorLoginFailed:"لم يُكمل Cloudflare التفويض. أعد الإعداد.",
        errorSetupFailed:"تعذّر إكمال النفق المخصص. أعد الإعداد أو راجع سجلات الخادم.",
        errorTeardownFailed:"تعذّرت إزالة النفق المخصص المحفوظ. أعد المحاولة أو راجع سجلات الخادم.",
        errorTeardownManual:"تمت إزالة النفق المخصص من Unsloth.",
        errorUnknown:"لم يكتمل تغيير النفق المخصص. أعد المحاولة أو راجع سجلات الخادم.",
      },
      notifications: {
