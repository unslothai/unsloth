...
export const ar = {
  ...
  settings: {
    ...
    apiKeys: {
      ...
      revoking: "جارٍ الإلغاء...",
      usageNoModel:
        "لا يتوفر في هذا الخادم أي نموذج دردشة، لذا يذكر هذا المثال نموذجًا لا يملكه. نزّل نموذج دردشة من Hub وسيذكره المثال.",
      usageModelNotLoaded:
        "{model} غير محمّل. فعّل \"تبديل النموذج حسب الطلب\" أعلاه، أو حمّله في الدردشة، قبل تشغيل هذا المثال.",
      usageModelNotLoadedKeyless:
        "{model} غير محمّل. أنشئ مفتاح API واستخدمه في هذا الطلب، أو حمّل النموذج في الدردشة، قبل تشغيل هذا المثال.",
      exampleModel: "النموذج",
      exampleModelFollow: "اتبع النموذج المحمّل",
      exampleQuant: "التكميم",
      modelLoaded: "محمّل",
    },
    about: {
      title: "حول",
