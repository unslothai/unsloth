...
export const en = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "ask",
      escHint: "close",
      context: "Selected text ({chars} chars)",
      followUp: "Follow up...",
      clear: "Clear",
    },
    settings: {
      ...
      actionName: "Name",
      actionPrompt: "Prompt",
      actionPromptHint: "Must contain {selection}.",
      actionSystemPrompt: "System prompt (optional)",
      actionModel: "Model",
      actionModelDefault: "Use loaded model",
      actionOutputMode: "Result",
      outputModeReplace: "Replace selection",
      outputModeShow: "Show result",
