...
export const en = {
  ...
  settings: {
    ...
    general: {
      ...
      previewSharing: {
        ...
        publicLinkLabel: "Shareable address",
        publicLinkDescription:
          "Preview links point at 127.0.0.1, so they only work on this machine. Turn this on to give them an address other people can reach. Only the preview pages go public. The rest of Studio stays private. Setup takes up to a minute.",
        publicLinkCreate: "Turn on",
        publicLinkOpening: "Setting up...",
        publicLinkStop: "Turn off",
        publicLinkStopping: "Turning off...",
        publicLinkOpened: "Shareable address is live",
        publicLinkStopped: "Shareable address turned off",
        publicLinkFailed: "Couldn't change the shareable address",
  ...
  studio: {
    ...
    history: {
      ...
      previewLinkCopiedLocal: "Copied, but the link only works on this machine",
      makeShareable: "Make shareable",
      previewLinkOpening: "Setting up a shareable address...",
      previewLinkReady: "Shareable address ready",
      previewLinkCopyAction: "Copy link",
      previewLinkOpenFailed: "Couldn't set up a shareable address",
    },
    charts: {
