  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "Uses DirectIO on supported Windows builds when the model is fully offloaded to the GPU. Otherwise keeps memory-mapped loading. Required CPU buffers and mapped pages can still use RAM. Drops --no-mmap and --mlock.",
