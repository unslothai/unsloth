  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmAction:"Confirm",
        setupConfirmDescription:"Check the hostname below. Cloudflare will then ask you to authorize this tunnel: choose the domain this hostname belongs to, and click Authorize.",
        setupPreparing:"Opening Cloudflare so you can authorize this tunnel...",
        setupAuthorize:"Waiting for you to authorize in Cloudflare. Choose the domain that {hostname} belongs to, then click Authorize.",
        ...
        removeDescription:"This removes only what Unsloth saved. The tunnel and its DNS record stay in Cloudflare until you delete them there.",
        ...
        dnsConflict:"{hostname} already points somewhere else in Cloudflare. Delete that DNS record, or set up a different hostname.",
        ...
        autoStartCustomMissing:"This will not connect anything until you set up a custom hostname below.",
        blockServerStarting:"Remote access will be available once the server finishes starting.",
        blockCustomNotConfigured:"Set up a custom hostname below before starting remote access.",
        blockPasswordDesktop:"Set a remote password below before starting remote access.",
        ...
        dnsConflictUnknown:"This hostname already points somewhere else in Cloudflare. Delete that DNS record, or set up a different hostname.",
        errorInvalidHostname:"That is not a full hostname. Enter one like unsloth.example.com.",
        errorWrongDomain:"The domain you authorized in Cloudflare does not cover {hostname}. Set up again and choose the domain this hostname belongs to.",
        errorHostnameUnreachable:"The tunnel connected, but {hostname} did not open. Remove this custom tunnel, set it up again, and choose the domain this hostname belongs to.",
        errorCertificateExists:"A Cloudflare certificate already exists at {path}, and Unsloth will not overwrite it. Move or delete that file, then set up again.",
        errorBusy:"Another remote access change is still running. Wait for it to finish, then try again.",
        errorIdentityExists:"A custom tunnel is already set up. Remove it before setting up a different hostname.",
        errorUnavailable:"Cloudflare could not be reached. Check the internet connection on this machine, then try again.",
        errorCancelled:"Setup was cancelled. Set it up again when you are ready.",
        errorLoginTimeout:"Cloudflare was not authorized in time. Set up again, and click Authorize when the Cloudflare page opens.",
        errorLoginFailed:"Cloudflare did not complete the authorization. Set up again.",
        errorSetupFailed:"The custom tunnel could not be finished. Set up again, or check the server logs.",
        errorTeardownFailed:"The saved custom tunnel could not be removed. Try again, or check the server logs.",
        errorTeardownManual:"The custom tunnel was removed from Unsloth.",
        errorUnknown:"The custom tunnel change did not finish. Try again, or check the server logs.",
      },
      permissions: {
