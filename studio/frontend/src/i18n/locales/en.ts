...
export const en = {
  ...
  dataRecipes: {
    import: {
      title: "Import legacy recipes",
      description:
        "Import recipes and execution history from this browser into the {account} account.",
      confirm: "Import legacy data",
      cancel: "Not now",
      close: "Close",
      importing: "Importing...",
      complete: "Legacy import complete",
      failed: "Legacy import failed",
      failedDescription:
        "The legacy data could not be imported. Please try again.",
      noData: "No legacy data to import.",
      imported: "Imported",
      redacted: "Redacted",
      skipped: "Skipped",
      rejected: "Rejected",
      ...
      retired: "Retired ID",
      missingParent: "Missing recipe",
      recipeCountOne: "{count} recipe",
      recipeCountOther: "{count} recipes",
      executionCountOne: "{count} execution record",
      executionCountOther: "{count} execution records",
      unknownId: "Unknown ID",
      unknownOutcome: "Unknown outcome",
      redactedFields: "Redacted fields: {fields}",
      reasons: {
        alreadyExists: "An item with this ID already exists",
        idRetired: "This ID was previously deleted",
        missingParent: "The related recipe is not available",
        invalidIdentifier: "The ID is invalid",
        invalidData: "The stored data is invalid",
        invalidName: "The name is invalid",
        invalidExecution: "The execution data is invalid",
        fieldLimit: "A field exceeds its size limit",
        secretField: "A secret field was removed for safety",
        batchLimit: "The import batch is too large",
        unknown: "The item could not be imported",
      },
    },
    conflict: {
      title: "Recipe changed on the server",
      description:
        "Your local draft is preserved. Reload the server version or save this draft as a new recipe.",
      reload: "Reload server version",
      saveAsNew: "Save as new recipe",
      unavailable: "This recipe is no longer available.",
    },
    server: {
  ...
  studio: {
    ...
    trainingPresets: {
      ...
      selectPlaceholder: "Select a saved preset",
      save: "Save preset",
      saveAs: "Save as preset",
      load: "Load preset",
      delete: "Delete preset",
      deleteConfirmTitle: "Delete this training preset?",
      deleteConfirmDescription: "This action cannot be undone.",
      noPresets: "No saved training presets yet.",
      loading: "Loading presets...",
      loadError: "Failed to load training presets.",
      saveError: "Failed to save training preset.",
      deleteError: "Failed to delete training preset.",
      conflictTitle: "Preset changed on the server",
      conflictDescription:
        "Reload the server preset or save your current draft as a new preset.",
      reload: "Reload server preset",
      reloadError: "Failed to reload the server preset.",
      reloadUnavailable: "This server preset is no longer available.",
      saveAsNew: "Save as new preset",
      importYaml: "Import YAML",
      exportYaml: "Export YAML",
      yamlDescription:
        "Use YAML to move a portable training configuration between environments.",
    },
    model: {
      title: "Model",
