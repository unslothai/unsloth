...
export const en = {
  ...
  notebooks: {
    ...
    subtitle:
      "Official fine-tuning recipes from unslothai/notebooks. Open in Colab or pre-fill Fine-tuning Studio.",
    searchPlaceholder: "Search notebooks…",
    pickerPlaceholder: "Search and pick a notebook…",
    pickerEmpty: "No notebooks match your search.",
    pickedSection: "Selected notebook",
    resultsCount: "{count} notebooks",
    allCategories: "All",
    featured: "Featured",
    featuredSection: "Featured notebooks",
    allSection: "All notebooks",
    loading: "Loading notebooks…",
    loadFailed: "Failed to load notebooks",
    emptyTitle: "No notebooks found",
    emptyDescription: "Try a different search or category filter.",
    useInStudio: "Use in Studio",
    openInColab: "Open in Colab",
    viewOnGitHub: "GitHub",
    studioModelReady: "Pre-fills Studio: {model}",
    studioManualConfigure: "Opens Fine-tuning Studio — pick a model to match this notebook.",
    studioOpenedWithoutModel: "Opened Fine-tuning Studio. Select a model to match this notebook.",
    studioDisabled: {
      mlxUnavailable:
        "Training needs MLX. Run `unsloth studio update` to enable Use in Studio.",
      intelMac:
        "Training needs Apple Silicon or a GPU. Intel Macs are chat-only.",
      noGpu: "Training needs an NVIDIA or AMD GPU.",
      generic: "Training is unavailable on this device.",
    },
    categories: {
      sft: "Fine-tuning",
      vision: "Vision",
