  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Ask yes/no, choice and score questions about any text and get calibrated probabilities back from a local Laya model. It speaks the Jev API, so TypeSafe's SDK works unchanged.",
        enable: "Serve requests",
        enableDescription: "Answers POST /v1/systemone. Turning it on downloads the model; it loads into memory on the first request.",
        lockedByEnv: "Set by {name}.",
        model: "Model",
        modelDescription: "Multilingual covers 100+ languages. English is larger and English-only.",
        ...
        tryIt: "Try it",
        caveat: "Base models are general-purpose. Check the answers on your own data before relying on them.",
      },
    },
    about: {
      title: "About",
