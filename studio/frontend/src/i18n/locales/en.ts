...
export const en = {
  ...
  "settings": {
    ...
    "keyboardShortcuts": {
      ...
      "description": "Change any shortcut, or clear one to free the chord for your browser or OS.",
    ...
    "voice": {
      ...
      "dictation": {
        ...
        "sttLoaded": "Loaded",
        "sttUnavailable": "Not installed on this server. Run `unsloth studio update` to enable local dictation.",
        "sttRetry": "Retry",
    ...
    "general": {
      ...
      "passwordDialog": {
        ...
        "setDescription": `Choose the password remote browsers sign in with as unsloth (at least {minLength} characters). The ${PRODUCT_NAME} Desktop App keeps signing in automatically.`,
      ...
      "helperLlm": {
        ...
        "disabledByEnv": "Disabled by UNSLOTH_HELPER_MODEL_DISABLE in the backend environment.",
      ...
      "startup": {
        ...
        "closeToTrayDescription": "Keep Unsloth and its server running in the background when you close the main window.",
      ...
      "startOnboardingDescription": "Reopen the setup wizard without changing your account.",
    ...
    "agents": {
      "title": "Agents",
      "description": "Connect coding agents like Claude Code and Codex to a local model with unsloth start.",
      ...
      "options": {
        ...
        "model": "Select a model. Without --model, unsloth start uses the model currently loaded in Studio and errors if none is loaded.",
      ...
      "remote": {
        ...
        "description": "Point unsloth start at a Studio running elsewhere by setting these before launching (or pass --api-key directly):"
      },
      "passthrough": {
    ...
    "chat": {
      ...
      "importChatsDescription": "Import a JSONL, NDJSON, or CSV export into Recents.",
    ...
    "data": {
      ...
      "archivedChatsDescription": `View and manage this device's local archive state. Chat content remains on ${PRODUCT_NAME}.`,
      ...
      "archiveAllChatsDescription": "Locally hide every chat in Recents and Projects on this device.",
    ...
    "about": {
      ...
      "update": {
        ...
        "desktopExternalServer": "Run `unsloth studio update` from the terminal that started your server.",
  ...
  "studio": {
    ...
    "wizard": {
      ...
      "modelPickerDescription": "Search Hugging Face or choose a trainable model already on this device.",
      "trainingMethod": "Training method",
      "trainingMethodDescription": "Choose how to fine-tune {model}",
      "trainingMethodTooltip": "QLoRA uses 4-bit quantization for the lowest VRAM use. LoRA uses 16-bit weights, while full fine-tuning updates every weight.",
      "datasetPickerDescription": "Search Hugging Face or choose a dataset already on this device.",
    ...
    "dataset": {
      ...
      "uploadLimitsHint": "CSV, JSONL, JSON, Parquet · up to {limit}; PDF/DOCX/TXT → Learning Recipes",
    ...
    "trainingStart": {
      ...
      "terminalStart": "> rag-platform training starts...",
  ...
  "platformAuth": {
    ...
    "errors": {
      ...
      "network": `Could not connect to ${PRODUCT_NAME}.`,
      ...
      "oauth": {
        ...
        "missingCode": "The sign-in provider did not return an authorization code.",
        "tokenFailed": "A secure session could not be created with the sign-in provider.",
        "emailMissing": "The sign-in provider did not return a verified email address.",
