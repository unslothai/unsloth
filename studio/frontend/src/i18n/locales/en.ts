  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ready:"Ready",
        waiting:"Waiting",
        removeAction:"Remove custom tunnel",
        removeTitle:"Remove this custom tunnel?",
        removeDescription:"This deletes the tunnel identity after disconnecting it. Cloudflare cannot delete the DNS record, so you must remove it in the dashboard before reusing this hostname.",
        removeConfirm:"Remove tunnel",
        ...
        runtimeFailed:"The remote tunnel failed. Retry, or check the server logs for details.",
        ...
        autoStartCustom:"Connect this stable hostname when Unsloth starts. Disconnecting now won't turn this off.",
        autoStartCustomMissing:"Custom-tunnel auto-start needs a configured tunnel.",
        ...
        errorTeardownFailed:"Cloudflare could not finish removing the custom tunnel. Retry removal.",
        errorTeardownManual:"Local tunnel settings were removed, but Cloudflare cleanup did not finish. Check the Cloudflare dashboard for the tunnel and DNS record.",
        errorUnknown:"The custom tunnel operation failed. Retry, or check the server logs for details."
      },
      permissions: {
