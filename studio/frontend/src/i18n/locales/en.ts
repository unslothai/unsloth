  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerLaunch:"Launch managed",
        ownerSettings:"Settings managed",
        ownerColab:"Colab managed",
        progressConnecting:"Connecting",
        progressOpeningLink:"Opening secure link",
        progressCheckingHostname:"Checking hostname",
        progressDisconnecting:"Disconnecting",
        copied:"Copied",
        copyUrl:"Copy URL",
        qrTitle:"Open on your phone",
        qrDescription:"Scan to open the remote URL in your phone's browser.",
        remoteUrl:"Remote URL",
        remoteUrlReady:"The remote link is ready.",
        urlHint:"Anyone with this URL and the remote password can sign in.",
        streamingSupported:"Streaming responses are supported by this tunnel.",
        streamingBuffered:"Temporary tunnels buffer streaming responses until completion.",
        passwordLabel:"Remote password",
        passwordDescription:"Remote browsers sign in as unsloth. The desktop app keeps signing in automatically.",
        stableTitle:"Stable hostname",
        stableDescription:"Create a custom Cloudflare tunnel for a permanent URL and streaming API responses.",
        customHostnameTitle:"Custom hostname",
        customHostnameDescription:"Use your own hostname for an address that stays the same.",
        hostnameLabel:"Full hostname",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Set up",
        settingUp:"Setting up...",
        setupConfirmTitle:"Set up this hostname?",
        setupConfirmDescription:"Unsloth will prepare a Cloudflare page. Open it, select the domain that matches this hostname, then approve access.",
        setupConfirmAction:"Prepare Cloudflare",
        setupPreparing:"Preparing Cloudflare...",
        setupAuthorize:"Open Cloudflare, select the domain that matches {hostname}, then approve access.",
        provisionProgress:"Authorize Cloudflare in your browser. Unsloth will finish creating the tunnel and DNS record.",
        teardownProgress:"Authorize Cloudflare to remove the tunnel. Its DNS record will remain for you to delete.",
        removeProgress:"Removing the saved connection from Unsloth...",
        openCloudflare:"Open Cloudflare",
        connectorReady:"Connector registered",
        tunnelReady:"Tunnel serving",
        dnsReady:"DNS resolved",
        dnsPending:"Not reachable yet",
        dnsUnknown:"Could not check",
        dnsLinkWaiting:"The remote link will appear after DNS resolution is confirmed.",
        ready:"Ready",
        waiting:"Waiting",
        removeAction:"Remove",
        removeTitle:"Remove this custom tunnel from Unsloth?",
        removeDescription:"This removes only the connection saved in Unsloth. The tunnel and DNS record stay in Cloudflare.",
        removeTunnelHint:"In Cloudflare, delete this tunnel:",
        tunnelNameUnavailable:"Tunnel name unavailable",
        openCloudflareTunnels:"Open Cloudflare tunnels",
        removeDnsHint:"Then delete this DNS record:",
        openCloudflareDns:"Open DNS records",
        removeConfirm:"Remove from Unsloth",
        removeLocally:"Open Settings on the machine running Unsloth to remove this connected tunnel.",
        dnsConflict:"The record {hostname} already exists. Remove that record in Cloudflare, or choose another hostname.",
        orphanedRecords:"DNS records left in Cloudflare: {hostnames}. Delete them in the Cloudflare dashboard before reusing those hostnames.",
        requestFailed:"Remote access request failed.",
        runtimeFailed:"Remote access stopped unexpectedly. Try again, or check the server logs.",
        temporaryAction:"Start temporary tunnel",
        ...
        autoStartCustomMissing:"Set up a custom tunnel before turning this on.",
        blockServerStarting:"Remote access will be available after the server finishes starting.",
        blockPasswordDesktop:"Set a remote password before starting remote access.",
        blockPasswordWeb:"Ask the host administrator to set a remote password.",
        blockExplicitlyDisabled:"Remote access was disabled when this server launched.",
        blockLaunchManaged:"This tunnel is managed by the server launch command.",
        blockColabManaged:"This tunnel is managed by the Colab session.",
        blockColab:"Remote access settings are managed by Colab.",
        dnsConflictUnknown:"An existing DNS record blocks this hostname. Remove that record in Cloudflare, or choose another hostname.",
        errorInvalidHostname:"Enter a full hostname such as studio.example.com.",
        errorWrongDomain:"Cloudflare did not authorize {hostname}. Try again and select the domain used by this hostname.",
        errorHostnameUnreachable:"Cloudflare connected, but {hostname} did not open. Remove this custom tunnel, set it up again, and select the matching domain.",
        errorCertificateExists:"Studio will not overwrite the existing Cloudflare certificate at {path}. Move it elsewhere, then retry.",
        errorBusy:"Another remote access operation is already in progress. Wait for it to finish, then retry.",
        errorIdentityExists:"A custom tunnel is already configured. Remove it before setting up another hostname.",
        errorUnavailable:"Cloudflare could not be reached. Check your connection and retry.",
        errorCancelled:"Cloudflare authorization was cancelled.",
        errorLoginTimeout:"Cloudflare authorization timed out. Start setup again.",
        errorLoginFailed:"Cloudflare authorization failed. Start setup again.",
        errorSetupFailed:"Cloudflare could not finish setting up the custom tunnel. Retry setup.",
        errorTeardownFailed:"Unsloth could not remove the saved custom tunnel. Try again.",
        errorTeardownManual:"The custom tunnel was removed from Unsloth.",
        errorUnknown:"Unsloth could not finish the custom tunnel operation. Try again, or check the server logs.",
      },
      permissions: {
