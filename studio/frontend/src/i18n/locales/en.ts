  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Confirm the hostname below. In Cloudflare, select the domain that matches it, then approve access.",
        setupPreparing:"Connecting to Cloudflare...",
        setupAuthorize:"Waiting for approval in Cloudflare. Select the domain that matches {hostname}.",
