...
export const en = {
  ...
  settings: {
    ...
    library: {
      ...
      showCardDatesDescription: "Show when each file last changed.",
      browsingSection: "Browsing",
      startTab: "Open on",
      startTabDescription: "The tab the Library opens to.",
      suggested: "Suggested",
      all: "All",
      sort: "Sort by",
      ...
      oldest: "Oldest",
      name: "Name",
      suggestedLimit: "Suggested items",
      suggestedLimitDescription: "How many recent files Suggested shows.",
  ...
  skills: {
    ...
    count: "{shown} of {total} skills",
    readOnlyClaude: "Read-only: found in ~/.claude/skills. Edit the file there.",
    readOnlyBundled: "Read-only: bundled with Unsloth Studio.",
    ...
    fromAgents: "A skill in ~/.agents/skills. Changes here are written straight to its SKILL.md.",
    fromClaude: "A skill in ~/.claude/skills.",
    fromBundled: "Bundled with Unsloth Studio.",
    detailsTitle: "Details",
    detailsDescription: "The other fields in the SKILL.md frontmatter. Edit the file to change them.",
    detailsEmpty: "No other fields.",
    licenseLabel: "License",
    compatibilityLabel: "Compatibility",
    allowedToolsLabel: "Allowed tools",
    deleteLabel: "Delete skill",
    deleteRowDescription: "Removes the folder under ~/.agents/skills and everything in it.",
    ...
    sectionBundledHint: "Shipped with Unsloth Studio. Read-only.",
    newSkillHint: "Write one here. It lands in ~/.agents/skills.",
    edit: "Edit",
    view: "View",
    linked: "Link",
    emptyTitle: "No skills yet",
    previewTitle: "What the model sees",
    previewHint: "Its catalog line. The model decides from this whether to open the skill and read the instructions.",
    previewName: "skill-name",
    mention: "Mention it in chat",
    copyMention: "Copy @{name}",
    sourceLabel: "Source",
  ...
  library: {
    ...
    empty: {
      ...
      imagesDescription: "Images you upload or generate show up here.",
      ...
      noMatchesDescription: "Try a different search or clear the filters.",
    ...
    dialog: {
      ...
      deleteImage: "It is also removed from your Images gallery.",
      deleteVideo: "It is also removed from your Video gallery.",
      deleteAudio: "It is also removed from your Audio gallery.",
    ...
    project: {
      ...
      addedTo: "Added to {project}",
      createAndAdd: "Create and add",
      addFailedImage: "Failed to add image to project",
      addFailedVideo: "Failed to add video to project",
      addFailedClip: "Failed to add clip to project",
      addFailedFile: "Failed to add file to project",
      newProjectImage: "Add image to new project",
      newProjectVideo: "Add video to new project",
      newProjectClip: "Add clip to new project",
      newProjectFile: "Add file to new project",
    },
    toast: {
      missingItem: "That file is no longer in the Library",
      moveFailed: "Could not move",
      movedToFolder: "Moved to {folder}",
      movedToLibrary: "Moved to Library",
      // Stands in for a destination folder whose name is not known.
      folderFallback: "folder",
      favoritesFailed: "Could not update favorites",
      ...
      uploadFailed: "Upload failed",
      uploadTooLarge: "{name} is larger than 512 MB.",
      readDropsFailed: "Could not read the dropped files",
      createNoteFailed: "Could not create the note",
      renameFailed: "Could not rename",
      createFolderFailed: "Could not create the folder",
      signedOutBeforeFolder: "Signed out before the folder was made.",
      signedOutBeforeSave: "Signed out before the change was saved.",
      signedOutBeforeUpload: "Signed out before the upload finished.",
      deleteFailed: "Some items could not be deleted",
      saveFailed: "Could not save",
      saveNoteFirst: "Save the note first.",
      revealFailed: "Could not open the file manager",
      ...
      nothingToChat: "Nothing to chat about yet",
      emptyFolder: "This folder has no files.",
      tooLargeOne: "{name} is too large to attach",
      tooLargeMany: "These files are too large to attach",
      attachedOne: "Attached {count} file",
