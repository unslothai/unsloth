...
export const en = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Images, Videos and Audio tabs",
      mediaTabsDescription: "Show these tabs only once you have files for them, or always.",
      mediaTabsAuto: "When they have files",
      mediaTabsAlways: "Always",
      ...
      showFineTunesDescription: "Models you trained or exported in Studio.",
