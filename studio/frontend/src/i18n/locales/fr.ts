  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Unsloth va préparer une page Cloudflare. Ouvrez-la, choisissez le domaine correspondant, puis autorisez l’accès.",
        setupConfirmAction:"Préparer Cloudflare",
        setupPreparing:"Préparation de Cloudflare...",
        setupAuthorize:"Ouvrez Cloudflare, choisissez le domaine correspondant à {hostname}, puis autorisez l’accès.",
        ...
        removeDescription:"Seule la connexion enregistrée dans Unsloth sera supprimée. Le tunnel et l’enregistrement DNS resteront dans Cloudflare.",
        ...
        autoStartCustomMissing:"Configurez un tunnel personnalisé avant d’activer cette option.",
        ...
        errorWrongDomain:"Cloudflare n’a pas autorisé {hostname}. Réessayez et sélectionnez le domaine de ce nom d’hôte.",
        errorHostnameUnreachable:"Cloudflare est connecté, mais {hostname} ne s’ouvre pas. Supprimez ce tunnel personnalisé, recréez-le et sélectionnez le bon domaine.",
        ...
        errorTeardownFailed:"Unsloth n’a pas pu supprimer le tunnel personnalisé enregistré. Réessayez.",
