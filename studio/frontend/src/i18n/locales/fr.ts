  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Confirmez le nom d’hôte ci-dessous. Dans Cloudflare, choisissez le domaine correspondant, puis autorisez l’accès.",
        setupPreparing:"Connexion à Cloudflare...",
        setupAuthorize:"En attente de l’autorisation dans Cloudflare. Choisissez le domaine correspondant à {hostname}.",
