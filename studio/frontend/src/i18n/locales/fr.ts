...
export const fr = {
  ...
  skills: {
    ...
    createDescription: "Enregistrée comme SKILL.md dans un nouveau dossier sous ~/.agents/skills, et activée dès sa création.",
    nameLabel: "Nom",
    namePlaceholder: "ex. code-arithmetic",
    nameHint: "Minuscules, chiffres et tirets simples. C'est aussi le nom du dossier.",
    nameInvalid: "Utilisez 1 à 64 minuscules, chiffres ou tirets simples, sans tiret au début ni à la fin.",
    descriptionLabel: "Description",
    descriptionPlaceholder: "À utiliser quand l'utilisateur demande un calcul. Toujours calculer avec l'outil de code.",
    descriptionHint: "La ligne que le modèle voit dans son catalogue de compétences. C'est sur elle qu'il décide quand lire la compétence.",
    instructionsLabel: "Instructions",
    instructionsPlaceholder: "Que faire quand cette compétence s'applique, en Markdown.",
    instructionsHint: "Le corps de SKILL.md, lu en entier une fois que le modèle choisit la compétence.",
    create: "Créer la compétence",
    save: "Enregistrer les modifications",
    created: "{name} créée",
    saved: "{name} enregistrée",
    deleted: "{name} supprimée",
    saveError: "Impossible d'enregistrer la compétence",
    openError: "Impossible d'ouvrir la compétence",
    deleteError: "Impossible de supprimer la compétence",
    deleteTitle: "Supprimer la compétence",
    deleteDescription: "Supprimer « {name} » et tout le contenu de son dossier sous ~/.agents/skills ? Cette action est irréversible.",
    search: "Rechercher des compétences par nom ou description…",
    noMatch: "Aucune compétence ne correspond à « {query} »",
    clearSearch: "Effacer la recherche",
    count: "{shown} compétences sur {total}",
    readOnlyClaude: "Lecture seule : située dans ~/.claude/skills. Modifiez le fichier à cet endroit.",
    readOnlyBundled: "Lecture seule : intégrée à Unsloth Studio.",
    ...
    fromAgents: "Une compétence dans ~/.agents/skills. Les modifications faites ici sont écrites directement dans son SKILL.md.",
    fromClaude: "Une compétence dans ~/.claude/skills.",
    fromBundled: "Intégrée à Unsloth Studio.",
    detailsTitle: "Détails",
    detailsDescription: "Les autres champs du frontmatter de SKILL.md. Modifiez le fichier pour les changer.",
    detailsEmpty: "Aucun autre champ.",
    licenseLabel: "Licence",
    compatibilityLabel: "Compatibilité",
    allowedToolsLabel: "Outils autorisés",
    deleteLabel: "Supprimer la compétence",
    deleteRowDescription: "Supprime le dossier dans ~/.agents/skills et tout son contenu.",
    summary: "{enabled} sur {total} activées",
    enabledOnly: "Activées seulement",
    sectionAgents: "Vos compétences",
    sectionAgentsHint: "Enregistrées dans ~/.agents/skills. Créez, modifiez et supprimez-les ici.",
    ...
    sectionBundledHint: "Livrées avec Unsloth Studio. Lecture seule.",
    newSkillHint: "Écrivez-en une ici. Elle ira dans ~/.agents/skills.",
    edit: "Modifier",
    view: "Voir",
    linked: "Lien",
    emptyTitle: "Aucune compétence pour l'instant",
    previewTitle: "Ce que voit le modèle",
    previewHint: "Sa ligne de catalogue. C'est à partir d'elle que le modèle décide d'ouvrir la compétence et de lire les instructions.",
    previewName: "skill-name",
    mention: "La mentionner dans le chat",
    copyMention: "Copier @{name}",
    sourceLabel: "Source",
