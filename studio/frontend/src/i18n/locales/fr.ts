...
export const fr = {
  ...
  settings: {
    ...
    library: {
      ...
      locationsDescription: "Où Studio conserve chaque type de fichier. Les dossiers de la bibliothèque sont des étiquettes dans Studio, pas des dossiers sur le disque.",
