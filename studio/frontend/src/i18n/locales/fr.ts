  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"Géré dans les paramètres",
        ...
        stableTitle:"Nom d'hôte stable",
        stableDescription:"Créez un tunnel Cloudflare personnalisé pour une URL permanente et le streaming des API.",
        hostnameLabel:"Nom d'hôte complet",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Configurer",
        settingUp:"Configuration...",
        provisionProgress:"Autorisez Cloudflare dans votre navigateur. Unsloth terminera la création du tunnel et de l'enregistrement DNS.",
        teardownProgress:"Autorisez Cloudflare à supprimer le tunnel. L'enregistrement DNS restera à supprimer manuellement.",
        openCloudflare:"Ouvrir Cloudflare",
        connectorReady:"Connecteur enregistré",
        tunnelReady:"Tunnel actif",
        dnsReady:"DNS résolu",
        dnsPending:"Pas encore accessible",
        dnsUnknown:"Vérification impossible",
        dnsLinkWaiting:"Le lien distant apparaîtra après confirmation de la résolution DNS.",
        ready:"Prêt",
        waiting:"En attente",
        removeAction:"Supprimer le tunnel personnalisé",
        removeTitle:"Supprimer ce tunnel personnalisé ?",
        removeDescription:"L'identité du tunnel sera supprimée après sa déconnexion. Cloudflare ne peut pas supprimer l'enregistrement DNS ; supprimez-le du tableau de bord avant de réutiliser ce nom.",
        removeConfirm:"Supprimer le tunnel",
        removeLocally:"Ouvrez les paramètres sur la machine qui exécute Unsloth pour supprimer ce tunnel connecté.",
        dnsConflict:"L'enregistrement {hostname} existe déjà. Supprimez-le dans Cloudflare ou choisissez un autre nom d'hôte.",
        orphanedRecords:"Enregistrements DNS restants dans Cloudflare : {hostnames}. Supprimez-les du tableau de bord avant de les réutiliser.",
        requestFailed:"La demande d'accès distant a échoué.",
        runtimeFailed:"Le tunnel distant a échoué. Réessayez ou consultez les journaux du serveur.",
        temporaryAction:"Démarrer un tunnel temporaire",
        connectAction:"Connecter",
        stopAction:"Déconnecter",
        ...
        autoStartCustom:"Connecte ce nom d'hôte stable au démarrage d'Unsloth. La déconnexion ne désactive pas ce réglage.",
        autoStartCustomMissing:"Le démarrage automatique personnalisé nécessite un tunnel configuré.",
        blockServerStarting:"L’accès à distance sera disponible une fois le démarrage du serveur terminé.",
        blockPasswordDesktop:"Définissez un mot de passe distant avant de démarrer l’accès à distance.",
        ...
        dnsConflictUnknown:"Un enregistrement DNS existant bloque ce nom d’hôte. Supprimez-le dans Cloudflare ou choisissez un autre nom.",
        errorInvalidHostname:"Saisissez un nom d’hôte complet, par exemple studio.example.com.",
        errorCertificateExists:"Studio ne remplacera pas le certificat Cloudflare existant à l’emplacement {path}. Déplacez-le, puis réessayez.",
        errorBusy:"Une autre opération d’accès à distance est déjà en cours. Attendez qu’elle se termine, puis réessayez.",
        errorIdentityExists:"Un tunnel personnalisé est déjà configuré. Supprimez-le avant de configurer un autre nom d’hôte.",
        errorUnavailable:"Cloudflare est inaccessible. Vérifiez votre connexion et réessayez.",
        errorCancelled:"L’autorisation Cloudflare a été annulée.",
        errorLoginTimeout:"L’autorisation Cloudflare a expiré. Relancez la configuration.",
        errorLoginFailed:"L’autorisation Cloudflare a échoué. Relancez la configuration.",
        errorSetupFailed:"Cloudflare n’a pas pu terminer la configuration du tunnel personnalisé. Réessayez.",
        errorTeardownFailed:"Cloudflare n’a pas pu terminer la suppression du tunnel personnalisé. Réessayez.",
        errorTeardownManual:"Les paramètres locaux du tunnel ont été supprimés, mais le nettoyage Cloudflare n’a pas abouti. Vérifiez le tunnel et l’enregistrement DNS dans le tableau de bord Cloudflare.",
        errorUnknown:"L’opération du tunnel personnalisé a échoué. Réessayez ou consultez les journaux du serveur."
      },
      notifications: {
