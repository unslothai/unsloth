  ...
  settings: {
    ...
    profile: {
      ...
      stats: {
        ...
        activityDescription: "{total} tokens sur les {weeks} dernières semaines",
        mode: {
          daily: "Quotidienne",
          weekly: "Hebdomadaire",
          cumulative: "Cumulée",
        ...
        weekTooltip: "Semaine du {date} · {tokens} tokens",
        less: "Moins",
        more: "Plus",
        ...
        bestLoss: "Meilleure loss",
        runSteps: "{steps} étapes",
        runLoss: "loss {loss}",
      },
    },
    appearance: {
