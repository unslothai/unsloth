  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Posez des questions oui/non, à choix et à score sur n'importe quel texte et obtenez des probabilités calibrées d'un modèle Laya local. Elle parle l'API Jev, donc le SDK de TypeSafe fonctionne tel quel.",
        enable: "Répondre aux requêtes",
        enableDescription: "Répond à POST /v1/systemone. L'activer télécharge le modèle ; il est chargé en mémoire à la première requête.",
        lockedByEnv: "Défini par {name}.",
        model: "Modèle",
        modelDescription: "Multilingue couvre plus de 100 langues. Anglais est plus lourd et uniquement en anglais.",
        ...
        tryIt: "Essayer",
        caveat: "Les modèles de base sont généralistes. Vérifiez les réponses sur vos propres données avant de vous y fier.",
      },
      usageNoModel:
