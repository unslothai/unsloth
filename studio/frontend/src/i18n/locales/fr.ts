...
export const fr = {
  ...
  settings: {
    ...
    library: {
      ...
      defaultViewDescription: "Comment les fichiers s'affichent à l'ouverture de la Bibliothèque.",
      grid: "Grille",
      list: "Liste",
      ...
      mediaTabs: "Onglets Images, Vidéos et Audio",
      mediaTabsDescription: "Afficher ces onglets uniquement lorsqu'ils contiennent des fichiers, ou toujours.",
      mediaTabsAuto: "Quand ils contiennent des fichiers",
      mediaTabsAlways: "Toujours",
      ...
      showFineTunesDescription: "Modèles que vous avez entraînés ou exportés dans Studio.",
