...
export const fr = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "demander",
      escHint: "fermer",
      context: "Texte sélectionné ({chars} caractères)",
    ...
    settings: {
      ...
      setUp: "Configurer...",
      permission: "Accès à l'accessibilité",
      permissionGranted: "Accordé",
      permissionMissing: "Non accordé",
      permissionRequest: "Demander",
      hotkey: "Raccourci",
      ...
      actionName: "Nom",
      actionPrompt: "Prompt",
      actionPromptHint: "Doit contenir {selection}.",
      actionSystemPrompt: "Prompt système (facultatif)",
      actionModel: "Modèle",
      actionModelDefault: "Utiliser le modèle chargé",
      actionOutputMode: "Résultat",
      outputModeReplace: "Remplacer la sélection",
      outputModeShow: "Afficher le résultat",
      actionEnabled: "Activé",
