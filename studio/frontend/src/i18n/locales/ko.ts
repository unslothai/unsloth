...
export const ko = {
  ...
  notebooks: {
    ...
    title: "Unsloth 노트북",
    subtitle:
      "unslothai/notebooks의 공식 파인튜닝 레시피입니다. Colab에서 열거나 Fine-tuning Studio에 미리 채울 수 있습니다.",
    searchPlaceholder: "노트북 검색…",
    pickerPlaceholder: "노트북을 검색하고 선택…",
    pickerEmpty: "검색과 일치하는 노트북이 없습니다.",
    pickedSection: "선택한 노트북",
    resultsCount: "노트북 {count}개",
    allCategories: "전체",
    featured: "추천",
    featuredSection: "추천 노트북",
    allSection: "모든 노트북",
    loading: "노트북을 불러오는 중…",
    loadFailed: "노트북을 불러오지 못했습니다",
    emptyTitle: "노트북을 찾을 수 없습니다",
    emptyDescription: "다른 검색어나 카테고리 필터를 사용해 보세요.",
    useInStudio: "Studio에서 사용",
    openInColab: "Colab에서 열기",
    viewOnGitHub: "GitHub",
    studioModelReady: "Studio에 미리 채움: {model}",
    studioManualConfigure:
      "Fine-tuning Studio를 엽니다 — 이 노트북에 맞는 모델을 선택하세요.",
    studioOpenedWithoutModel:
      "Fine-tuning Studio를 열었습니다. 이 노트북에 맞는 모델을 선택하세요.",
    studioDisabled: {
      mlxUnavailable:
        "학습에는 MLX가 필요합니다. Studio에서 사용을 켜려면 `unsloth studio update`를 실행하세요.",
      intelMac:
        "학습에는 Apple Silicon 또는 GPU가 필요합니다. Intel Mac은 채팅만 사용할 수 있습니다.",
      noGpu: "학습에는 NVIDIA 또는 AMD GPU가 필요합니다.",
      generic: "이 기기에서는 학습을 사용할 수 없습니다.",
    },
    categories: {
      sft: "파인튜닝",
      vision: "비전",
