  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"아래 호스트 이름을 확인하세요. Cloudflare에서 일치하는 도메인을 선택한 다음 액세스를 승인하세요.",
        setupPreparing:"Cloudflare에 연결 중...",
        setupAuthorize:"Cloudflare 승인을 기다리는 중입니다. {hostname}과 일치하는 도메인을 선택하세요.",
