  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassLabel: "도구 권한",
        bypassDescription:
          "채팅의 도구 호출(터미널, python, 웹, MCP)을 실행하기 전에 Unsloth가 승인하는 방식입니다. 전체 접근을 선택하면 승인과 코드 샌드박스가 꺼집니다.",
      },
    },
    profile: {
      title: "프로필",
      ...
      stats: {
        ...
        activityTitle: "토큰 활동",
        activityDescription: "최근 {weeks}주 동안 {total} 토큰",
        mode: {
          daily: "일별",
          weekly: "주별",
          cumulative: "누적",
        },
        cellTooltip: "{date} · 토큰 {tokens}개, 메시지 {messages}개",
        weekTooltip: "{date} 주간 · 토큰 {tokens}개",
        less: "적음",
        more: "많음",
        insightsTitle: "활동 분석",
        totalChats: "전체 채팅",
        ...
        modelSummary: "{tokens} · 메시지 {messages}개",
