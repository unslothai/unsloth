  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        stateOnline:"온라인",
        stateStopping:"중지 중",
        ownerLaunch:"실행 명령에서 관리",
        ownerSettings:"설정에서 관리",
        ...
        stableTitle:"고정 호스트 이름",
        stableDescription:"고정 URL과 API 스트리밍을 위한 사용자 지정 Cloudflare 터널을 만듭니다.",
        hostnameLabel:"전체 호스트 이름",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"설정",
        settingUp:"설정 중...",
        provisionProgress:"브라우저에서 Cloudflare를 승인하세요. Unsloth가 터널과 DNS 레코드를 생성합니다.",
        teardownProgress:"터널을 제거하려면 Cloudflare를 승인하세요. DNS 레코드는 직접 삭제할 수 있도록 남습니다.",
        openCloudflare:"Cloudflare 열기",
        connectorReady:"커넥터 등록",
        tunnelReady:"터널 서비스",
        dnsReady:"DNS 확인",
        dnsPending:"아직 연결할 수 없음",
        dnsUnknown:"확인할 수 없음",
        dnsLinkWaiting:"DNS 확인이 완료되면 원격 링크가 표시됩니다.",
        ready:"준비됨",
        waiting:"대기 중",
        removeAction:"사용자 지정 터널 제거",
        removeTitle:"이 사용자 지정 터널을 제거할까요?",
        removeDescription:"연결을 끊은 뒤 터널 ID를 삭제합니다. Cloudflare는 DNS 레코드를 삭제할 수 없으므로 이 호스트 이름을 재사용하기 전에 대시보드에서 삭제해야 합니다.",
        removeConfirm:"터널 제거",
        ...
        orphanedRecords:"Cloudflare에 남은 DNS 레코드: {hostnames}. 재사용하기 전에 Cloudflare 대시보드에서 삭제하세요.",
        requestFailed:"원격 액세스 요청에 실패했습니다.",
        runtimeFailed:"원격 터널에 실패했습니다. 다시 시도하거나 서버 로그를 확인하세요.",
        ...
        autoStartCustom:"Unsloth 시작 시 이 고정 호스트 이름에 연결합니다. 지금 연결을 끊어도 이 설정은 꺼지지 않습니다.",
        autoStartCustomMissing:"사용자 지정 터널 자동 시작에는 설정된 터널이 필요합니다.",
        ...
        errorTeardownFailed:"Cloudflare가 사용자 지정 터널 제거를 완료하지 못했습니다. 다시 시도하세요.",
        errorTeardownManual:"로컬 터널 설정은 제거되었지만 Cloudflare 정리가 완료되지 않았습니다. Cloudflare 대시보드에서 터널과 DNS 레코드를 확인하세요.",
