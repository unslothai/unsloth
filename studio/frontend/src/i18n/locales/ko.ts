...
export const ko = {
  ...
  systemPill: {
    ...
    settings: {
      ...
      actionName: "이름",
      actionPrompt: "프롬프트",
      actionPromptHint: "{selection}을(를) 포함해야 합니다.",
      actionSystemPrompt: "시스템 프롬프트(선택 사항)",
      actionModel: "모델",
      actionModelDefault: "불러온 모델 사용",
      actionOutputMode: "결과",
      outputModeReplace: "선택 항목 바꾸기",
      outputModeShow: "결과 표시",
      actionEnabled: "사용함",
