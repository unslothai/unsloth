  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        title: "판단 API",
        experimental: "실험적",
        description: "어떤 텍스트든 예/아니오, 선택, 점수 질문을 하고 로컬 Laya 모델에서 보정된 확률을 받아 보세요. Jev API와 호환되므로 TypeSafe SDK를 그대로 사용할 수 있습니다.",
        enable: "요청 처리",
        enableDescription: "POST /v1/systemone에 응답합니다. 켜면 모델을 다운로드하고, 첫 요청 때 메모리에 로드합니다.",
        lockedByEnv: "{name}(으)로 설정됨.",
        model: "모델",
        modelDescription: "다국어는 100개 이상의 언어를 지원합니다. 영어는 더 크고 영어 전용입니다.",
        ...
        tryIt: "사용해 보기",
        caveat: "기본 모델은 범용입니다. 믿고 쓰기 전에 직접 가진 데이터로 답변을 확인하세요.",
      },
      usageNoModel:
