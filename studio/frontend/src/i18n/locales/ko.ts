  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "모델이 GPU에 완전히 오프로드된 경우 지원되는 Windows 빌드에서 DirectIO를 사용합니다. 그렇지 않으면 메모리 매핑 로딩을 유지합니다. 필요한 CPU 버퍼와 매핑된 페이지는 여전히 RAM을 사용할 수 있습니다. --no-mmap과 --mlock을 제거합니다.",
