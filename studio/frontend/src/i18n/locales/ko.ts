...
export const ko = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "사전 정의된 보상 함수를 사용하는 강화 학습.",
        note: "RL",
      },
    },
    grpo: {
      settings: "GRPO 설정",
      rewardFunctions: "보상 함수",
      rewardFunctionsLoading: "보상 함수를 불러오는 중...",
      expectedColumns: "필요한 데이터셋 열: {columns}",
      weight: "가중치",
      numGenerations: "프롬프트당 생성 수",
      numGenerationsTooltip: "프롬프트마다 생성하고 채점할 응답 수입니다. 배치 크기 x 그래디언트 누적을 나눌 수 있어야 합니다.",
      maxPromptLength: "최대 프롬프트 길이",
      maxPromptLengthTooltip: "생성 전에 유지할 프롬프트 토큰 수입니다. 더 긴 프롬프트는 잘립니다.",
      maxCompletionLength: "최대 생성 길이",
      maxCompletionLengthTooltip: "롤아웃당 생성할 최대 토큰 수입니다. 프롬프트와 생성의 합이 컨텍스트 길이에 들어가야 합니다.",
      temperature: "샘플링 온도",
      temperatureTooltip: "값이 클수록 롤아웃이 다양해지며, GRPO가 좋은 응답과 나쁜 응답을 구분하는 데 필요합니다.",
      topP: "Top-p",
      topPTooltip: "롤아웃의 뉴클리어스 샘플링 임계값입니다.",
      beta: "KL 계수 (beta)",
      betaTooltip: "참조 모델이 정책을 얼마나 강하게 되돌리는지입니다. 0이면 KL 항이 완전히 사라집니다.",
      generationBackend: "롤아웃 백엔드",
