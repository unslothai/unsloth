  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        hostnamePlaceholder:"studio.example.com",
        setupAction:"설정",
        settingUp:"설정 중...",
        setupConfirmTitle:"이 호스트 이름을 설정할까요?",
        setupConfirmDescription:"Unsloth가 Cloudflare 페이지를 준비합니다. 페이지를 열고 이 호스트 이름과 일치하는 도메인을 선택한 다음 액세스를 승인하세요.",
        setupConfirmAction:"Cloudflare 준비",
        setupPreparing:"Cloudflare 준비 중...",
        setupAuthorize:"Cloudflare를 열고 {hostname}과 일치하는 도메인을 선택한 다음 액세스를 승인하세요.",
        removeProgress:"Unsloth에서 저장된 연결 제거 중...",
        openCloudflare:"Cloudflare 열기",
        ready:"준비됨",
        removeAction:"제거",
        removeTitle:"이 사용자 지정 터널을 Unsloth에서 제거할까요?",
        removeDescription:"Unsloth에 저장된 연결만 제거합니다. 터널과 DNS 레코드는 Cloudflare에 남습니다.",
        ...
        dnsConflict:"레코드 {hostname}이(가) 이미 있습니다. Cloudflare에서 삭제하거나 다른 호스트 이름을 선택하세요.",
        requestFailed:"원격 액세스 요청에 실패했습니다.",
        runtimeFailed:"원격 액세스가 예기치 않게 중지되었습니다. 다시 시도하거나 서버 로그를 확인하세요.",
        temporaryAction:"임시 터널 시작",
        connectAction:"연결",
        stopAction:"연결 끊기",
        actionStarting:"시작 중...",
        actionStopping:"중지 중...",
        ...
        autoStartCustomMissing:"이 옵션을 켜기 전에 사용자 지정 터널을 설정하세요.",
        blockServerStarting:"서버 시작이 완료되면 원격 액세스를 사용할 수 있습니다.",
        blockPasswordDesktop:"원격 액세스를 시작하기 전에 원격 비밀번호를 설정하세요.",
        ...
        dnsConflictUnknown:"기존 DNS 레코드가 이 호스트 이름을 차단합니다. Cloudflare에서 해당 레코드를 삭제하거나 다른 호스트 이름을 선택하세요.",
        errorInvalidHostname:"studio.example.com과 같은 전체 호스트 이름을 입력하세요.",
        errorWrongDomain:"Cloudflare가 {hostname}을 승인하지 않았습니다. 다시 시도하고 이 호스트 이름의 도메인을 선택하세요.",
        errorHostnameUnreachable:"Cloudflare는 연결됐지만 {hostname}이 열리지 않습니다. 이 사용자 지정 터널을 제거하고 다시 설정한 뒤 올바른 도메인을 선택하세요.",
        errorCertificateExists:"Studio는 {path}의 기존 Cloudflare 인증서를 덮어쓰지 않습니다. 다른 위치로 옮긴 후 다시 시도하세요.",
        errorBusy:"다른 원격 액세스 작업이 이미 진행 중입니다. 완료될 때까지 기다린 후 다시 시도하세요.",
        errorIdentityExists:"사용자 지정 터널이 이미 설정되어 있습니다. 다른 호스트 이름을 설정하기 전에 제거하세요.",
        errorUnavailable:"Cloudflare에 연결할 수 없습니다. 연결을 확인하고 다시 시도하세요.",
        errorCancelled:"Cloudflare 인증이 취소되었습니다.",
        errorLoginTimeout:"Cloudflare 인증 시간이 초과되었습니다. 설정을 다시 시작하세요.",
        errorLoginFailed:"Cloudflare 인증에 실패했습니다. 설정을 다시 시작하세요.",
        errorSetupFailed:"Cloudflare가 사용자 지정 터널 설정을 완료하지 못했습니다. 다시 시도하세요.",
        errorTeardownFailed:"Unsloth가 저장된 사용자 지정 터널을 제거하지 못했습니다. 다시 시도하세요.",
        errorTeardownManual:"사용자 지정 터널이 Unsloth에서 제거되었습니다.",
        errorUnknown:"사용자 지정 터널 작업에 실패했습니다. 다시 시도하거나 서버 로그를 확인하세요.",
      },
      notifications: {
        sectionTitle: "알림",
