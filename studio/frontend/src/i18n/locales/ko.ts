...
export const ko = {
  composerSettings: {
    ...
    sendShortcut: "전송 단축키",
    sendMultiline: "여러 줄 메시지는 {mod} + Enter",
    sendAlways: "항상 {mod} + Enter",
    sendEnterDescription: "Enter로 전송하고 Shift + Enter로 줄을 바꿉니다.",
    sendMultilineDescription: "한 줄 메시지는 Enter로 전송합니다. 두 줄 이상이 되면 Enter로 줄을 바꾸고 {mod} + Enter로 전송합니다.",
    sendAlwaysDescription: "{mod} + Enter로 전송하고 Enter로 줄을 바꿉니다.",
    followUp: "후속 메시지 동작",
    followUpDescription: "응답 중에 전송할 때의 동작을 선택합니다. {shortcut}을 누르면 해당 메시지만 반대로 처리합니다.",
    followUpMultilineShortcut: "{shortcut} (여러 줄 메시지에서는 {multiline})",
    queue: "대기열",
    steer: "방향 변경",
  ...
  settings: {
    ...
    library: {
      ...
      large: "크게",
      imageLayout: "이미지 카드",
      imageLayoutDescription: "각 이미지의 모양을 유지하거나 균일한 정사각형으로 자릅니다.",
      masonry: "원래 모양",
      square: "정사각형",
      showCardDates: "카드에 날짜 표시",
      showCardDatesDescription: "각 파일이 마지막으로 변경된 시간을 표시합니다.",
      browsingSection: "탐색",
      startTab: "시작 탭",
      startTabDescription: "라이브러리를 열 때 표시할 탭입니다.",
      suggested: "추천",
      all: "전체",
      sort: "정렬 기준",
      sortDescription: "파일과 폴더의 순서입니다. 추천은 항상 최신 항목을 보여줍니다.",
      recent: "최신순",
      oldest: "오래된순",
      name: "이름",
      suggestedLimit: "추천 항목 수",
      suggestedLimitDescription: "추천에 표시할 최근 파일 수입니다.",
      tabAuto: "파일이 있을 때",
      tabAlways: "항상",
      contentSection: "콘텐츠",
      contentDescription: "라이브러리에 표시할 항목을 선택합니다. 숨긴 파일은 삭제되지 않습니다.",
      showChatAttachments: "채팅 첨부 파일",
      showChatAttachmentsDescription: "채팅에 첨부한 파일입니다.",
      showChatToolFiles: "채팅 도구 파일",
      showChatToolFilesDescription: "채팅 중 코드와 도구가 만든 파일입니다.",
      showGeneratedMedia: "생성된 미디어",
      showGeneratedMediaDescription: "이미지, 동영상, 오디오 페이지에서 만든 이미지, 동영상, 오디오입니다.",
      showFineTunesDescription: "Unsloth에서 학습하거나 내보낸 모델입니다.",
      deletingSection: "삭제",
      confirmDelete: "삭제 전 확인",
      confirmDeleteDescription: "라이브러리에서 파일과 폴더를 삭제하기 전에 확인합니다.",
      reset: "라이브러리 설정 초기화",
      resetDescription: "위의 모든 옵션을 기본값으로 되돌립니다.",
      resetButton: "초기화",
      resetDone: "라이브러리 설정을 초기화했습니다",
      storageSection: "저장 공간",
      storageDescription: "카테고리를 열면 파일이 큰 순서로 표시되며, 필요 없는 파일을 삭제할 수 있습니다.",
      ...
      locationUploads: "라이브러리 업로드",
      locationExports: "내보내기",
      revealFailed: "파일 관리자를 열 수 없습니다",
      locationReset: "초기화",
      locationMoveTitle: "{name}을(를) 새 폴더로 이동",
      locationMoveDescription: "아무 폴더나 선택하세요. 이미 파일이 있으면 Unsloth가 그 안에 전용 폴더를 만듭니다. 여기에 있는 파일도 모두 함께 이동합니다.",
      locationMoveAction: "여기로 이동",
      locationMoving: "{name} 이동 중…",
      locationMoved: "{name} 이동됨",
      locationMoveFailed: "{name}을(를) 이동할 수 없습니다",
      locationFree: "이 드라이브의 여유 공간 {free}",
      locationUnavailable: "사용할 수 없습니다. 드라이브를 다시 연결하거나 폴더를 재설정하세요.",
      locationResetUnavailableTitle: "{name}을(를) 재설정할까요?",
      locationResetUnavailableDescription: "드라이브가 연결되어 있지 않습니다. {path}의 파일은 그 드라이브에 남아 있으며, 다시 옮기기 전까지 라이브러리에 표시되지 않습니다.",
      locationLeftBehind: "{path}의 파일은 그 드라이브에 남아 있습니다.",
      dataStorage: "라이브러리 저장 공간",
      manageStorage: "저장 공간 관리",
      categoryImages: "이미지",
      categoryVideos: "동영상",
      categoryFineTunes: "파인튜닝",
      itemCountOne: "1개 항목",
      itemCount: "{count}개 항목",
      tabsSection: "탭",
      tabsDescription: "라이브러리에 표시할 탭을 선택합니다. 링크로 연 탭은 계속 표시됩니다.",
      tabHidden: "숨김",
      lastVisited: "마지막으로 본 탭",
    },
    tabs: {
      accounts: "계정",
      general: "일반",
  ...
  skills: {
    ...
    newSkill: "새 스킬",
    delete: "{name} 삭제",
    createDescription: "~/.agents/skills의 새 폴더에 SKILL.md로 저장되며 만들어지는 즉시 활성화됩니다.",
    nameLabel: "이름",
    namePlaceholder: "예: code-arithmetic",
    nameHint: "소문자, 숫자, 단일 하이픈만 사용합니다. 폴더 이름으로도 쓰입니다.",
    nameInvalid: "1~64자의 소문자, 숫자 또는 단일 하이픈을 사용하고, 하이픈으로 시작하거나 끝나지 않아야 합니다.",
    descriptionLabel: "설명",
    descriptionPlaceholder: "사용자가 산술 계산을 요청할 때 사용합니다. 항상 코드 도구로 계산합니다.",
    descriptionHint: "모델이 스킬 카탈로그에서 보는 한 줄입니다. 모델은 이를 보고 스킬을 읽을 시점을 정합니다.",
    instructionsLabel: "지침",
    instructionsPlaceholder: "이 스킬이 적용될 때 할 일을 Markdown으로 적습니다.",
    instructionsHint: "SKILL.md 본문입니다. 모델이 스킬을 선택하면 전체를 읽습니다.",
    create: "스킬 만들기",
    save: "변경 사항 저장",
    created: "{name} 생성됨",
    saved: "{name} 저장됨",
    deleted: "{name} 삭제됨",
    saveError: "스킬을 저장할 수 없습니다",
    openError: "스킬을 열 수 없습니다",
    deleteError: "스킬을 삭제할 수 없습니다",
    deleteTitle: "스킬 삭제",
    deleteDescription: '"{name}"과(와) ~/.agents/skills에 있는 해당 폴더의 모든 내용을 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
    search: "이름 또는 설명으로 스킬 검색…",
    noMatch: "“{query}”과(와) 일치하는 스킬이 없습니다",
    clearSearch: "검색 지우기",
    count: "스킬 {total}개 중 {shown}개",
    readOnlyClaude: "읽기 전용: ~/.claude/skills에 있습니다. 파일은 그곳에서 편집하세요.",
    readOnlyBundled: "읽기 전용: Unsloth Studio에 기본 제공됩니다.",
    readOnlyLinked: "읽기 전용: 이 항목은 링크입니다. 파일은 실제 위치에서 편집하세요.",
    characters: "{count}자",
    unsaved: "저장되지 않은 변경 사항",
    revert: "되돌리기",
    enabledLabel: "활성화",
    locationLabel: "위치",
    fromAgents: "~/.agents/skills에 있는 스킬입니다. 여기서의 변경은 SKILL.md에 바로 기록됩니다.",
    fromClaude: "~/.claude/skills에 있는 스킬입니다.",
    fromBundled: "Unsloth Studio에 기본 제공됩니다.",
    detailsTitle: "세부 정보",
    detailsDescription: "SKILL.md 프런트매터의 나머지 필드입니다. 변경하려면 파일을 편집하세요.",
    detailsEmpty: "다른 필드가 없습니다.",
    licenseLabel: "라이선스",
    compatibilityLabel: "호환성",
    allowedToolsLabel: "허용된 도구",
    deleteLabel: "스킬 삭제",
    deleteRowDescription: "~/.agents/skills 아래의 폴더와 그 안의 모든 내용을 삭제합니다.",
    summary: "{total}개 중 {enabled}개 활성화",
    enabledOnly: "활성화만",
    sectionAgents: "내 스킬",
    sectionAgentsHint: "~/.agents/skills에 저장됩니다. 여기서 만들고, 편집하고, 삭제하세요.",
    sectionClaude: "Claude 스킬",
    sectionClaudeHint: "~/.claude/skills에서 찾았습니다. 여기서는 읽기 전용이며, 파일은 그곳에서 편집하세요.",
    sectionBundled: "기본 제공",
    sectionBundledHint: "Unsloth Studio와 함께 제공됩니다. 읽기 전용입니다.",
    newSkillHint: "여기서 작성하세요. ~/.agents/skills에 저장됩니다.",
    edit: "편집",
    view: "보기",
    linked: "링크",
    emptyTitle: "아직 스킬이 없습니다",
    previewTitle: "모델이 보는 내용",
    previewHint: "카탈로그의 한 줄입니다. 모델은 이를 보고 스킬을 열어 지침을 읽을지 결정합니다.",
  ...
  library: {
    ...
    empty: {
      suggestedTitle: "라이브러리가 비어 있습니다",
      suggestedDescription: "업로드하거나 채팅에서 만든 파일이 여기에 표시됩니다.",
      favoritesTitle: "아직 즐겨찾기가 없습니다",
      favoritesDescription: "파일을 즐겨찾기에 추가하면 여기에서 빠르게 찾을 수 있습니다.",
      foldersTitle: "첫 폴더를 만들어 보세요",
      foldersDescription: "폴더를 만들어 라이브러리의 항목을 정리하세요.",
      imagesTitle: "아직 이미지가 없습니다",
      imagesDescription: "업로드하거나 생성한 이미지가 여기에 표시됩니다.",
      videosTitle: "아직 동영상이 없습니다",
      videosDescription: "업로드하거나 생성한 동영상이 여기에 표시됩니다.",
      audioTitle: "아직 오디오가 없습니다",
      audioDescription: "오디오 페이지에서 생성한 음성이 여기에 표시됩니다.",
      modelsTitle: "아직 파인튜닝된 모델이 없습니다",
      modelsDescription: "Unsloth에서 학습하거나 내보낸 모델이 여기에 표시됩니다.",
      createFolder: "폴더 만들기",
      generateVideo: "동영상 생성",
      generateAudio: "오디오 생성",
      trainModel: "모델 학습",
      uploadFiles: "파일 업로드",
      dropHere: "또는 여기에 파일을 끌어다 놓으세요",
      noMatchesTitle: "일치하는 항목 없음",
      noMatchesDescription: "다른 검색어를 입력하거나 필터를 지우세요.",
      loadErrorTitle: "라이브러리를 불러오지 못했습니다",
      loadErrorFallback: "문제가 발생했습니다.",
      tryAgain: "다시 시도",
    },
    sections: {
      items: "항목",
    ...
    dropToUploadInto: '놓아서 "{folder}"에 업로드',
    itemCountOne: "항목 {count}개",
    itemCount: "항목 {count}개",
    selectItem: "{name} 선택",
    selection: {
      startChat: "채팅 시작",
    ...
    modelKind: {
      ...
      loraExport: "LoRA 내보내기",
      mergedExport: "병합 내보내기",
      ggufExport: "GGUF 내보내기",
      model: "모델",
    },
    dialog: {
      create: "만들기",
      ...
      deleteManyDescription: "파일은 저장된 위치에서 삭제됩니다. 삭제한 폴더 안의 항목은 한 단계 위로 이동합니다.",
      deleteFolderIntoParent: '안의 모든 항목이 "{folder}"(으)로 이동합니다. 파일은 삭제되지 않습니다.',
      deleteFolderIntoLibrary: "안의 모든 항목이 라이브러리로 이동합니다. 파일은 삭제되지 않습니다.",
      deleteUpload: "파일이 영구적으로 삭제됩니다.",
      deleteAttachment: "첨부되어 있던 채팅에서도 제거됩니다.",
      deleteImage: "이미지 갤러리에서도 제거됩니다.",
      deleteVideo: "동영상 갤러리에서도 제거됩니다.",
      deleteAudio: "오디오 갤러리에서도 제거됩니다.",
      deleteSandbox: "이 파일을 만든 채팅에서도 제거됩니다.",
      deleteModel: "모델이 디스크에서 영구적으로 삭제됩니다.",
      unsavedTitle: "변경 사항이 저장되지 않았습니다",
    ...
    preview: {
      code: "코드",
      preview: "미리보기",
      viewOriginalChat: "원래 채팅 보기",
      viewInImages: "이미지에서 보기",
      viewInVideo: "동영상에서 보기",
      viewInAudio: "오디오에서 보기",
      cannotPreview: "이 파일은 여기에서 미리 볼 수 없습니다. 다운로드해서 여세요.",
      noPreview: "이 파일 형식은 미리보기를 지원하지 않습니다.",
      tooLargeToPreview: "파일이 너무 커서 여기에서 미리 볼 수 없습니다. 다운로드해서 여세요.",
      ...
      location: "위치",
      unknown: "알 수 없음",
      readOnlyUtf16: "이 파일은 올바른 UTF-16 텍스트가 아니므로 여기에서는 읽기 전용으로 열립니다.",
      readOnlyNotUtf8: "이 파일은 UTF-8 텍스트가 아니므로 여기에서는 읽기 전용으로 열립니다. 일부 문자가 올바르게 표시되지 않을 수 있습니다.",
    },
    viewer: {
      scale: "배율",
      fit: "맞춤",
      ...
      moreActionsFile: "이 파일에 대한 추가 작업",
      openImage: "이미지 열기",
      openImageNamed: "이미지 열기: {prompt}",
      openVideo: "동영상 열기",
      untitledImage: "제목 없는 이미지",
    ...
    project: {
      ...
      alreadyIn: "이미 {project}에 있습니다",
      addedTo: "{project}에 추가됨",
      createAndAdd: "만들고 추가",
      addFailedImage: "이미지를 프로젝트에 추가하지 못했습니다",
      addFailedVideo: "동영상을 프로젝트에 추가하지 못했습니다",
      addFailedClip: "클립을 프로젝트에 추가하지 못했습니다",
      addFailedFile: "파일을 프로젝트에 추가하지 못했습니다",
      newProjectImage: "새 프로젝트에 이미지 추가",
      newProjectVideo: "새 프로젝트에 동영상 추가",
      newProjectClip: "새 프로젝트에 클립 추가",
      newProjectFile: "새 프로젝트에 파일 추가",
    },
    toast: {
      missingItem: "이 파일은 더 이상 라이브러리에 없습니다",
      moveFailed: "이동하지 못했습니다",
      movedToFolder: "{folder}(으)로 이동됨",
      movedToLibrary: "라이브러리로 이동됨",
      folderFallback: "폴더",
      favoritesFailed: "즐겨찾기를 업데이트하지 못했습니다",
      addedToFavorites: "즐겨찾기에 추가됨",
      removedFromFavorites: "즐겨찾기에서 제거됨",
      uploadingOne: "{name} 업로드 중…",
      uploadingMany: "파일 {count}개 업로드 중…",
      uploadedOne: "파일 업로드됨",
      uploadedMany: "파일 {count}개 업로드됨",
      uploadFailed: "업로드 실패",
      uploadTooLarge: "{name}이(가) 512MB를 초과합니다.",
      readDropsFailed: "끌어다 놓은 파일을 읽지 못했습니다",
      createNoteFailed: "메모를 만들지 못했습니다",
      renameFailed: "이름을 변경하지 못했습니다",
      createFolderFailed: "폴더를 만들지 못했습니다",
      signedOutBeforeFolder: "폴더가 만들어지기 전에 로그아웃되었습니다.",
      signedOutBeforeSave: "변경 사항이 저장되기 전에 로그아웃되었습니다.",
      signedOutBeforeUpload: "업로드가 끝나기 전에 로그아웃되었습니다.",
      deleteFailed: "일부 항목을 삭제하지 못했습니다",
      saveFailed: "저장하지 못했습니다",
      saveNoteFirst: "먼저 메모를 저장하세요.",
      revealFailed: "파일 관리자를 열지 못했습니다",
      downloadFailed: "{name}을(를) 다운로드하지 못했습니다",
      downloadManyFailed: "파일을 다운로드하지 못했습니다",
      downloadingMany: "파일 {count}개 다운로드 중",
      downloadingManyDescription: "브라우저에서 묻는 경우 이 사이트가 여러 파일을 다운로드하도록 허용하세요.",
      preparingMany: "파일 {count}개 준비 중…",
      zipFileName: "라이브러리 파일",
      nothingToChat: "아직 채팅할 내용이 없습니다",
      emptyFolder: "이 폴더에는 파일이 없습니다.",
      tooLargeOne: "{name}은(는) 너무 커서 첨부할 수 없습니다",
      tooLargeMany: "이 파일들은 너무 커서 첨부할 수 없습니다",
      attachedOne: "파일 {count}개 첨부됨",
      ...
      imageTooLarge: "이 이미지는 너무 커서 첨부할 수 없습니다",
      videoTooLarge: "이 동영상은 너무 커서 첨부할 수 없습니다",
      attachmentLimit: "채팅 첨부 파일은 {size}MB까지 가능합니다.",
      attachingImage: "이미지를 첨부하는 중…",
      attachingVideo: "동영상을 첨부하는 중…",
      readImageFailed: "이미지를 읽을 수 없습니다 ({status}).",
      readVideoFailed: "동영상을 읽을 수 없습니다 ({status}).",
