  ...
  settings: {
    ...
    general: {
      ...
      downloads: {
        ...
        transportHint:
          "HTTPS는 일반 TLS입니다. 모든 네트워크와 프록시, VPN이 허용하며 취소되거나 끊긴 전송도 디스크에 남은 바이트부터 이어받고 메모리 사용량이 일정합니다. Xet은 중복 제거된 청크를 받아오므로 이미 가진 저장소와 데이터를 공유하면 훨씬 빠르게 도착하지만 hf_xet이 필요하고 RAM을 더 쓰며, 취소하면 진행 중인 파일이 버려집니다. Auto는 이 머신에 맞춰 판단해 RAM과 Xet이 여기서 멈춘 적이 있는지를 따지고 필요하면 HTTPS로 물러납니다. 새 설치는 HTTPS를 사용합니다.",
        https: "HTTPS",
        xet: "Xet",
        auto: "Auto",
        httpsHint:
