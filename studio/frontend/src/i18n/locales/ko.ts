  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        sectionTitle: "원격 액세스",
        description:
          "Cloudflare를 통해 다른 기기에서 Unsloth와 API를 사용합니다.",
        ...
        streamingBuffered:
          "임시 터널은 완료될 때까지 스트리밍 응답을 버퍼링합니다.",
        passwordLabel: "원격 비밀번호",
        passwordDescription:
          "원격 브라우저는 unsloth로 로그인합니다. 데스크톱 앱은 자동으로 계속 로그인합니다.",
        customHostnameTitle: "사용자 지정 호스트 이름",
        customHostnameDescription:
          "같은 주소를 유지하려면 내 호스트 이름을 사용하세요.",
        ...
        setupConfirmDescription:
          "아래 호스트 이름을 확인하세요. 이어서 Cloudflare가 이 터널의 승인을 요청합니다. 이 호스트 이름이 속한 도메인을 선택하고 Authorize를 클릭하세요.",
        setupPreparing: "이 터널을 승인할 수 있도록 Cloudflare를 여는 중…",
        setupAuthorize:
          "Cloudflare에서 승인하기를 기다리는 중입니다. {hostname}이(가) 속한 도메인을 선택한 뒤 Authorize를 클릭하세요.",
        removeProgress: "Unsloth에서 저장된 연결 제거 중...",
        openCloudflare: "Cloudflare 열기",
        removeAction: "제거",
        removeTitle: "이 사용자 지정 터널을 Unsloth에서 제거할까요?",
        removeDescription:
          "Unsloth에 저장된 항목만 제거합니다. 터널과 DNS 레코드는 Cloudflare에서 삭제할 때까지 남아 있습니다.",
        ...
        removeLocally:
          "연결된 터널을 제거하려면 Unsloth를 실행 중인 컴퓨터에서 설정을 여세요.",
        dnsConflict:
          "{hostname}은(는) Cloudflare에서 이미 다른 곳을 가리킵니다. 해당 DNS 레코드를 삭제하거나 다른 호스트 이름을 설정하세요.",
        requestFailed: "원격 액세스 요청에 실패했습니다.",
        runtimeFailed:
          "원격 액세스가 예기치 않게 중지되었습니다. 다시 시도하거나 서버 로그를 확인하세요.",
        startAction: "시작",
        stopAction: "정지",
        autoStartLabel: "자동 시작",
        autoStartTemporary:
          "Unsloth 시작 시 새 임시 URL을 만듭니다. 지금 연결을 끊어도 이 설정은 꺼지지 않습니다.",
        autoStartCustom:
          "Unsloth 시작 시 이 사용자 지정 호스트 이름에 연결합니다. 지금 연결을 끊어도 이 설정은 꺼지지 않습니다.",
        autoStartCustomMissing:
          "아래에서 사용자 지정 호스트 이름을 설정하기 전까지는 아무것도 연결되지 않습니다.",
        blockServerStarting:
          "서버 시작이 끝나면 원격 액세스를 사용할 수 있습니다.",
        blockCustomNotConfigured:
          "원격 액세스를 시작하기 전에 아래에서 사용자 지정 호스트 이름을 설정하세요.",
        blockPasswordDesktop:
          "원격 액세스를 시작하기 전에 아래에서 원격 비밀번호를 설정하세요.",
        blockPasswordWeb: "호스트 관리자에게 원격 비밀번호 설정을 요청하세요.",
        blockExplicitlyDisabled:
          "이 서버를 시작할 때 원격 액세스가 비활성화되었습니다.",
        blockLaunchManaged: "이 터널은 서버 시작 명령으로 관리됩니다.",
        blockColabManaged: "이 터널은 Colab 세션에서 관리됩니다.",
        blockColab: "원격 액세스 설정은 Colab에서 관리됩니다.",
        dnsConflictUnknown:
          "이 호스트 이름은 Cloudflare에서 이미 다른 곳을 가리킵니다. 해당 DNS 레코드를 삭제하거나 다른 호스트 이름을 설정하세요.",
        errorInvalidHostname:
          "전체 호스트 이름이 아닙니다. unsloth.example.com과 같은 형식으로 입력하세요.",
        errorWrongDomain:
          "Cloudflare에서 승인한 도메인에 {hostname}이(가) 포함되지 않습니다. 다시 설정하고 이 호스트 이름이 속한 도메인을 선택하세요.",
        errorHostnameUnreachable:
          "터널은 연결되었지만 {hostname}이(가) 열리지 않았습니다. 이 사용자 지정 터널을 제거하고 다시 설정한 뒤, 이 호스트 이름이 속한 도메인을 선택하세요.",
        errorCertificateExists:
          "{path}에 Cloudflare 인증서가 이미 있으며 Unsloth는 덮어쓰지 않습니다. 해당 파일을 옮기거나 삭제한 뒤 다시 설정하세요.",
        errorBusy:
          "다른 원격 액세스 작업이 진행 중입니다. 완료된 후 다시 시도하세요.",
        errorIdentityExists:
          "사용자 지정 터널이 이미 설정되어 있습니다. 다른 호스트 이름을 설정하기 전에 제거하세요.",
        errorUnavailable:
          "Cloudflare에 연결할 수 없습니다. 이 컴퓨터의 인터넷 연결을 확인한 뒤 다시 시도하세요.",
        errorCancelled: "설정이 취소되었습니다. 준비되면 다시 설정하세요.",
        errorLoginTimeout:
          "Cloudflare 승인이 제시간에 완료되지 않았습니다. 다시 설정하고, Cloudflare 페이지가 열리면 Authorize를 클릭하세요.",
        errorLoginFailed:
          "Cloudflare가 승인을 완료하지 못했습니다. 다시 설정하세요.",
        errorSetupFailed:
          "사용자 지정 터널을 완료하지 못했습니다. 다시 설정하거나 서버 로그를 확인하세요.",
        errorTeardownFailed:
          "저장된 사용자 지정 터널을 제거하지 못했습니다. 다시 시도하거나 서버 로그를 확인하세요.",
        errorTeardownManual: "사용자 지정 터널이 Unsloth에서 제거되었습니다.",
        errorUnknown:
          "사용자 지정 터널 변경이 완료되지 않았습니다. 다시 시도하거나 서버 로그를 확인하세요.",
      },
      notifications: {
        sectionTitle: "알림",
