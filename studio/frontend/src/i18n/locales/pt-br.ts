...
export const ptBR = {
  ...
  skills: {
    ...
    delete: "Excluir {name}",
    createDescription: "Salva como SKILL.md em uma nova pasta em ~/.agents/skills e ativada assim que existir.",
    nameLabel: "Nome",
    namePlaceholder: "ex.: code-arithmetic",
    nameHint: "Minúsculas, números e hífens simples. Também é o nome da pasta.",
    nameInvalid: "Use de 1 a 64 minúsculas, números ou hífens simples, sem começar nem terminar com hífen.",
    descriptionLabel: "Descrição",
    descriptionPlaceholder: "Usar quando o usuário pedir cálculos aritméticos. Sempre calcular com a ferramenta de código.",
    descriptionHint: "A linha que o modelo vê no catálogo de habilidades. É por ela que decide quando ler a habilidade.",
    instructionsLabel: "Instruções",
    instructionsPlaceholder: "O que fazer quando esta habilidade se aplica, em Markdown.",
    instructionsHint: "O corpo do SKILL.md, lido por inteiro quando o modelo escolhe a habilidade.",
    create: "Criar habilidade",
    save: "Salvar alterações",
    created: "{name} criada",
    saved: "{name} salva",
    deleted: "{name} excluída",
    saveError: "Não foi possível salvar a habilidade",
    openError: "Não foi possível abrir a habilidade",
    deleteError: "Não foi possível excluir a habilidade",
    deleteTitle: "Excluir habilidade",
    deleteDescription: 'Excluir "{name}" e tudo o que está na pasta dela em ~/.agents/skills? Isso não pode ser desfeito.',
    search: "Buscar habilidades por nome ou descrição…",
    ...
    readOnlyBundled: "Somente leitura: incluída no Unsloth Studio.",
    ...
    locationLabel: "Local",
    fromAgents: "Uma habilidade em ~/.agents/skills. As alterações aqui são gravadas direto no SKILL.md dela.",
    fromClaude: "Uma habilidade em ~/.claude/skills.",
    fromBundled: "Incluída no Unsloth Studio.",
    detailsTitle: "Detalhes",
    detailsDescription: "Os outros campos do frontmatter do SKILL.md. Edite o arquivo para alterá-los.",
    detailsEmpty: "Nenhum outro campo.",
    licenseLabel: "Licença",
    compatibilityLabel: "Compatibilidade",
    allowedToolsLabel: "Ferramentas permitidas",
    deleteLabel: "Excluir habilidade",
    deleteRowDescription: "Remove a pasta em ~/.agents/skills e tudo o que há nela.",
    summary: "{enabled} de {total} ativadas",
    enabledOnly: "Somente ativadas",
    sectionAgents: "Suas habilidades",
    sectionAgentsHint: "Salvas em ~/.agents/skills. Crie, edite e exclua aqui.",
    ...
    sectionBundledHint: "Vêm com o Unsloth Studio. Somente leitura.",
    newSkillHint: "Escreva uma aqui. Ela vai para ~/.agents/skills.",
    edit: "Editar",
    view: "Ver",
    linked: "Link",
    emptyTitle: "Nenhuma habilidade ainda",
    previewTitle: "O que o modelo vê",
    previewHint: "Sua linha no catálogo. É por ela que o modelo decide se abre a habilidade e lê as instruções.",
    previewName: "skill-name",
    mention: "Mencione no chat",
