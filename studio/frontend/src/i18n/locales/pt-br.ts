  ...
  settings: {
    ...
    general: {
      ...
      modelAutoSwitch: {
        ...
        apiOnlyDescription:
          "O descarregamento por inatividade mantém na memória o modelo que você carregou pelo Unsloth Studio e libera apenas os que uma requisição da API carregou.",
      },
      previewSharing: {
