...
export const ptBR = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Abas de Imagens, Vídeos e Áudio",
      mediaTabsDescription: "Mostrar essas abas só quando houver arquivos para elas, ou sempre.",
      mediaTabsAuto: "Quando houver arquivos",
      ...
      showFineTunesDescription: "Modelos que você treinou ou exportou no Studio.",
