...
export const ptBR = {
  ...
  notebooks: {
    ...
    subtitle:
      "Receitas oficiais de fine-tuning de unslothai/notebooks. Abra no Colab ou preencha o Fine-tuning Studio.",
    searchPlaceholder: "Pesquisar notebooks…",
    pickerPlaceholder: "Pesquise e escolha um notebook…",
    pickerEmpty: "Nenhum notebook corresponde à sua pesquisa.",
    pickedSection: "Notebook selecionado",
    resultsCount: "{count} notebooks",
    allCategories: "Tudo",
    featured: "Destaques",
    featuredSection: "Notebooks em destaque",
    allSection: "Todos os notebooks",
    loading: "Carregando notebooks…",
    loadFailed: "Falha ao carregar os notebooks",
    emptyTitle: "Nenhum notebook encontrado",
    emptyDescription: "Tente outra pesquisa ou outro filtro de categoria.",
    useInStudio: "Usar no Studio",
    openInColab: "Abrir no Colab",
    viewOnGitHub: "GitHub",
    studioModelReady: "Preenche o Studio: {model}",
    studioManualConfigure:
      "Abre o Fine-tuning Studio — escolha um modelo que corresponda a este notebook.",
    studioOpenedWithoutModel:
      "O Fine-tuning Studio foi aberto. Selecione um modelo que corresponda a este notebook.",
    studioDisabled: {
      mlxUnavailable:
        "O treinamento precisa de MLX. Execute `unsloth studio update` para habilitar Usar no Studio.",
      intelMac:
        "O treinamento precisa de Apple Silicon ou de uma GPU. Macs Intel são apenas para chat.",
      noGpu: "O treinamento precisa de uma GPU NVIDIA ou AMD.",
      generic: "O treinamento não está disponível neste dispositivo.",
    },
    categories: {
      sft: "Fine-tuning",
      vision: "Visão",
