  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassDescription:
          "Como o Unsloth aprova as chamadas de ferramentas do chat (terminal, python, web, MCP) antes de executá-las. O acesso total desativa as aprovações e o sandbox de código.",
      },
    },
    profile: {
      title: "Perfil",
      ...
      stats: {
        ...
        activityDescription: "{total} tokens nas últimas {weeks} semanas",
        mode: {
          daily: "Diária",
          weekly: "Semanal",
          cumulative: "Acumulada",
        },
        cellTooltip: "{date} · {tokens} tokens, {messages} mensagens",
        weekTooltip: "Semana de {date} · {tokens} tokens",
        less: "Menos",
        more: "Mais",
    ...
    agents: {
      ...
      modelNote:
        "O Codex exige um modelo GGUF servido pelo llama-server. Outros agentes também podem usar modelos baseados em transformers; remova --model para usar o modelo já carregado no Unsloth Studio.",
      subagent: {
