...
export const ptBR = {
  ...
  settings: {
    ...
    debugging: {
      ...
      exportPrivacyNote: "As credenciais são ocultadas nos arquivos ZIP exportados.",
      openFolder: "Abrir pasta de logs",
      openingFolder: "Abrindo...",
      openFolderError: "Não foi possível abrir a pasta de logs",
