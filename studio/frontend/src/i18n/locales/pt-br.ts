  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        description:
          "Use o Unsloth e suas APIs em outros dispositivos por meio da Cloudflare.",
        ...
        qrDescription:
          "Escaneie para abrir a URL remota no navegador do celular.",
        ...
        streamingSupported:
          "Este túnel oferece suporte a respostas em streaming.",
        streamingBuffered:
          "Túneis temporários armazenam respostas em streaming até a conclusão.",
        passwordLabel: "Senha remota",
        passwordDescription:
          "Navegadores remotos entram como unsloth. O aplicativo desktop continua entrando automaticamente.",
        customHostnameTitle: "Nome de host personalizado",
        customHostnameDescription:
          "Use seu próprio nome de host para manter o mesmo endereço.",
        ...
        setupConfirmDescription:
          "Confira o nome de host abaixo. Em seguida, a Cloudflare pedirá que você autorize este túnel: escolha o domínio ao qual este nome de host pertence e clique em Authorize.",
        setupPreparing: "Abrindo a Cloudflare para você autorizar este túnel…",
        setupAuthorize:
          "Aguardando sua autorização na Cloudflare. Escolha o domínio ao qual {hostname} pertence e clique em Authorize.",
        ...
        removeDescription:
          "Isso remove apenas o que o Unsloth salvou. O túnel e seu registro DNS permanecem na Cloudflare até você excluí-los lá.",
        ...
        removeLocally:
          "Abra as Configurações no computador que executa o Unsloth para remover este túnel conectado.",
        dnsConflict:
          "{hostname} já aponta para outro lugar na Cloudflare. Exclua esse registro DNS ou configure um nome de host diferente.",
        requestFailed: "Falha na solicitação de acesso remoto.",
        runtimeFailed:
          "O acesso remoto parou inesperadamente. Tente novamente ou consulte os logs do servidor.",
        startAction: "Iniciar",
        stopAction: "Parar",
        autoStartLabel: "Iniciar automaticamente",
        autoStartTemporary:
          "Cria uma nova URL temporária ao iniciar o Unsloth. Desconectar agora não desativa esta opção.",
        autoStartCustom:
          "Conecta este nome personalizado ao iniciar o Unsloth. Desconectar agora não desativa esta opção.",
        autoStartCustomMissing:
          "Isso não vai conectar nada até você configurar um nome de host personalizado abaixo.",
        blockServerStarting:
          "O acesso remoto ficará disponível assim que o servidor terminar de iniciar.",
        blockCustomNotConfigured:
          "Configure um nome de host personalizado abaixo antes de iniciar o acesso remoto.",
        blockPasswordDesktop:
          "Defina uma senha remota abaixo antes de iniciar o acesso remoto.",
        blockPasswordWeb:
          "Peça ao administrador do host para definir uma senha remota.",
        blockExplicitlyDisabled:
          "O acesso remoto foi desativado quando este servidor iniciou.",
        blockLaunchManaged:
          "Este túnel é gerenciado pelo comando de inicialização do servidor.",
        blockColabManaged: "Este túnel é gerenciado pela sessão do Colab.",
        blockColab:
          "As configurações de acesso remoto são gerenciadas pelo Colab.",
        dnsConflictUnknown:
          "Este nome de host já aponta para outro lugar na Cloudflare. Exclua esse registro DNS ou configure um nome de host diferente.",
        errorInvalidHostname:
          "Esse não é um nome de host completo. Digite um como unsloth.example.com.",
        errorWrongDomain:
          "O domínio que você autorizou na Cloudflare não cobre {hostname}. Configure novamente e escolha o domínio ao qual este nome de host pertence.",
        errorHostnameUnreachable:
          "O túnel conectou, mas {hostname} não abriu. Remova este túnel personalizado, configure-o novamente e escolha o domínio ao qual este nome de host pertence.",
        errorCertificateExists:
          "Já existe um certificado da Cloudflare em {path}, e o Unsloth não vai sobrescrevê-lo. Mova ou exclua esse arquivo e configure novamente.",
        errorBusy:
          "Outra alteração de acesso remoto ainda está em andamento. Aguarde terminar e tente de novo.",
        errorIdentityExists:
          "Já existe um túnel personalizado configurado. Remova-o antes de configurar outro nome de host.",
        errorUnavailable:
          "Não foi possível acessar a Cloudflare. Verifique a conexão de internet desta máquina e tente de novo.",
        errorCancelled:
          "A configuração foi cancelada. Configure novamente quando quiser.",
        errorLoginTimeout:
          "A Cloudflare não foi autorizada a tempo. Configure novamente e clique em Authorize quando a página da Cloudflare abrir.",
        errorLoginFailed:
          "A Cloudflare não concluiu a autorização. Configure novamente.",
        errorSetupFailed:
          "Não foi possível concluir o túnel personalizado. Configure novamente ou verifique os logs do servidor.",
        errorTeardownFailed:
          "Não foi possível remover o túnel personalizado salvo. Tente de novo ou verifique os logs do servidor.",
        errorTeardownManual: "O túnel personalizado foi removido do Unsloth.",
        errorUnknown:
          "A alteração do túnel personalizado não foi concluída. Tente de novo ou verifique os logs do servidor.",
      },
      notifications: {
