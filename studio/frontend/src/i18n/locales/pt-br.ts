...
export const ptBR = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "perguntar",
      escHint: "fechar",
      context: "Texto selecionado ({chars} caracteres)",
    ...
    settings: {
      ...
      setUp: "Configurar...",
      permission: "Acesso de acessibilidade",
      permissionGranted: "Concedido",
      permissionMissing: "Não concedido",
      ...
      actionName: "Nome",
      actionPrompt: "Prompt",
      actionPromptHint: "Deve conter {selection}.",
      actionSystemPrompt: "Prompt de sistema (opcional)",
      actionModel: "Modelo",
      actionModelDefault: "Usar o modelo carregado",
      actionOutputMode: "Resultado",
      outputModeReplace: "Substituir a seleção",
      outputModeShow: "Mostrar o resultado",
      actionEnabled: "Ativado",
