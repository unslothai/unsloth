  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"O Unsloth preparará uma página da Cloudflare. Abra-a, selecione o domínio correspondente e aprove o acesso.",
        setupConfirmAction:"Preparar Cloudflare",
        setupPreparing:"Preparando a Cloudflare...",
        setupAuthorize:"Abra a Cloudflare, selecione o domínio correspondente a {hostname} e aprove o acesso.",
