  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Confirme o nome de host abaixo. Na Cloudflare, selecione o domínio correspondente e aprove o acesso.",
        setupPreparing:"Conectando à Cloudflare...",
        setupAuthorize:"Aguardando aprovação na Cloudflare. Selecione o domínio correspondente a {hostname}.",
        ...
        removeDescription:"Isso remove apenas a conexão salva no Unsloth. O túnel e o registro DNS permanecem na Cloudflare.",
        ...
        autoStartCustomMissing:"Configure um túnel personalizado antes de ativar esta opção.",
        ...
        errorWrongDomain:"A Cloudflare não autorizou {hostname}. Tente novamente e selecione o domínio desse nome de host.",
        errorHostnameUnreachable:"A Cloudflare conectou, mas {hostname} não abriu. Remova este túnel personalizado, configure-o novamente e selecione o domínio correto.",
        ...
        errorTeardownFailed:"O Unsloth não conseguiu remover o túnel personalizado salvo. Tente novamente.",
