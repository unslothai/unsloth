  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"Gerenciado nas configurações",
        ...
        stableTitle:"Nome de host estável",
        stableDescription:"Crie um túnel personalizado da Cloudflare para uma URL permanente e streaming da API.",
        hostnameLabel:"Nome de host completo",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Configurar",
        settingUp:"Configurando...",
        provisionProgress:"Autorize a Cloudflare no navegador. O Unsloth concluirá a criação do túnel e do registro DNS.",
        teardownProgress:"Autorize a Cloudflare para remover o túnel. O registro DNS permanecerá para exclusão manual.",
        openCloudflare:"Abrir Cloudflare",
        connectorReady:"Conector registrado",
        tunnelReady:"Túnel ativo",
        dnsReady:"DNS resolvido",
        dnsPending:"Ainda não acessível",
        dnsUnknown:"Não foi possível verificar",
        dnsLinkWaiting:"O link remoto aparecerá após a confirmação da resolução DNS.",
        ready:"Pronto",
        waiting:"Aguardando",
        removeAction:"Remover túnel personalizado",
        removeTitle:"Remover este túnel personalizado?",
        removeDescription:"A identidade do túnel será excluída após desconectá-lo. A Cloudflare não pode excluir o registro DNS; remova-o no painel antes de reutilizar este nome.",
        removeConfirm:"Remover túnel",
        removeLocally:"Abra as Configurações no computador que executa o Unsloth para remover este túnel conectado.",
        dnsConflict:"O registro {hostname} já existe. Remova-o na Cloudflare ou escolha outro nome de host.",
        orphanedRecords:"Registros DNS restantes na Cloudflare: {hostnames}. Exclua-os no painel antes de reutilizá-los.",
        requestFailed:"Falha na solicitação de acesso remoto.",
        runtimeFailed:"O túnel remoto falhou. Tente novamente ou consulte os logs do servidor.",
        temporaryAction:"Iniciar túnel temporário",
        ...
        autoStartCustom:"Conecta este nome estável ao iniciar o Unsloth. Desconectar agora não desativa esta opção.",
        autoStartCustomMissing:"A inicialização automática personalizada precisa de um túnel configurado.",
        blockServerStarting:"O acesso remoto ficará disponível quando o servidor terminar de iniciar.",
        blockPasswordDesktop:"Defina uma senha remota antes de iniciar o acesso remoto.",
        ...
        dnsConflictUnknown:"Um registro DNS existente bloqueia este nome de host. Remova-o no Cloudflare ou escolha outro nome.",
        errorInvalidHostname:"Digite um nome de host completo, como studio.example.com.",
        errorCertificateExists:"O Studio não substituirá o certificado do Cloudflare existente em {path}. Mova-o e tente novamente.",
        errorBusy:"Outra operação de acesso remoto já está em andamento. Aguarde a conclusão e tente novamente.",
        errorIdentityExists:"Já existe um túnel personalizado configurado. Remova-o antes de configurar outro nome de host.",
        errorUnavailable:"Não foi possível acessar o Cloudflare. Verifique sua conexão e tente novamente.",
        errorCancelled:"A autorização do Cloudflare foi cancelada.",
        errorLoginTimeout:"A autorização do Cloudflare expirou. Inicie a configuração novamente.",
        errorLoginFailed:"A autorização do Cloudflare falhou. Inicie a configuração novamente.",
        errorSetupFailed:"O Cloudflare não conseguiu concluir a configuração do túnel personalizado. Tente novamente.",
        errorTeardownFailed:"O Cloudflare não conseguiu concluir a remoção do túnel personalizado. Tente novamente.",
        errorTeardownManual:"As configurações locais do túnel foram removidas, mas a limpeza no Cloudflare não terminou. Confira o túnel e o registro DNS no painel do Cloudflare.",
        errorUnknown:"A operação do túnel personalizado falhou. Tente novamente ou consulte os logs do servidor."
      },
      notifications: {
