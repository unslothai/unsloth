  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Faça perguntas de sim/não, de escolha e de pontuação sobre qualquer texto e receba probabilidades calibradas de um modelo Laya local. Ela fala a API Jev, então o SDK da TypeSafe funciona sem mudanças.",
        enable: "Atender solicitações",
        enableDescription: "Responde a POST /v1/systemone. Ao ativar, o modelo é baixado; ele é carregado na memória na primeira solicitação.",
        lockedByEnv: "Definido por {name}.",
        model: "Modelo",
        modelDescription: "Multilíngue cobre mais de 100 idiomas. Inglês é maior e só para inglês.",
        ...
        tryIt: "Experimente",
        caveat: "Modelos base são de uso geral. Confira as respostas com seus próprios dados antes de confiar nelas.",
      },
      usageNoModel:
