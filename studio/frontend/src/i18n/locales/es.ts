  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "Usa DirectIO en las compilaciones de Windows compatibles cuando el modelo está totalmente descargado en la GPU. En caso contrario conserva la carga mapeada en memoria. Los búferes de CPU necesarios y las páginas mapeadas pueden seguir usando RAM. Elimina --no-mmap y --mlock.",
