...
export const es = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Pestañas de Imágenes, Videos y Audio",
      mediaTabsDescription: "Mostrar estas pestañas solo cuando haya archivos para ellas, o siempre.",
      mediaTabsAuto: "Cuando tengan archivos",
      mediaTabsAlways: "Siempre",
      ...
      showFineTunes: "Ajustes finos",
      showFineTunesDescription: "Modelos que entrenaste o exportaste en Studio.",
