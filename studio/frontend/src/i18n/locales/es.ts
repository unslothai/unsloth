...
export const es = {
  ...
  skills: {
    ...
    createDescription: "Se guarda como SKILL.md en una carpeta nueva dentro de ~/.agents/skills y se activa en cuanto existe.",
    nameLabel: "Nombre",
    namePlaceholder: "p. ej. code-arithmetic",
    nameHint: "Minúsculas, números y guiones simples. También es el nombre de la carpeta.",
    nameInvalid: "Usa de 1 a 64 minúsculas, números o guiones simples, sin empezar ni terminar con guion.",
    descriptionLabel: "Descripción",
    descriptionPlaceholder: "Usar cuando el usuario pida cálculos aritméticos. Calcularlos siempre con la herramienta de código.",
    descriptionHint: "La línea que el modelo ve en su catálogo de habilidades. Con ella decide cuándo leer la habilidad.",
    instructionsLabel: "Instrucciones",
    instructionsPlaceholder: "Qué hacer cuando aplica esta habilidad, en Markdown.",
    instructionsHint: "El cuerpo de SKILL.md, que el modelo lee completo cuando elige la habilidad.",
    ...
    openError: "No se pudo abrir la habilidad",
    deleteError: "No se pudo eliminar la habilidad",
    deleteTitle: "Eliminar habilidad",
    deleteDescription: '¿Eliminar "{name}" y todo lo que hay en su carpeta dentro de ~/.agents/skills? Esto no se puede deshacer.',
    search: "Buscar habilidades por nombre o descripción…",
    noMatch: "Ninguna habilidad coincide con “{query}”",
    clearSearch: "Borrar búsqueda",
    count: "{shown} de {total} habilidades",
    readOnlyClaude: "Solo lectura: está en ~/.claude/skills. Edita el archivo allí.",
    readOnlyBundled: "Solo lectura: incluida con Unsloth Studio.",
    ...
    fromAgents: "Una habilidad en ~/.agents/skills. Los cambios aquí se escriben directamente en su SKILL.md.",
    fromClaude: "Una habilidad en ~/.claude/skills.",
    fromBundled: "Incluida con Unsloth Studio.",
    detailsTitle: "Detalles",
    detailsDescription: "Los demás campos del frontmatter de SKILL.md. Edita el archivo para cambiarlos.",
    detailsEmpty: "No hay otros campos.",
    licenseLabel: "Licencia",
    compatibilityLabel: "Compatibilidad",
    allowedToolsLabel: "Herramientas permitidas",
    deleteLabel: "Eliminar habilidad",
    deleteRowDescription: "Elimina la carpeta en ~/.agents/skills y todo su contenido.",
    summary: "{enabled} de {total} activadas",
    enabledOnly: "Solo activadas",
    sectionAgents: "Tus habilidades",
    sectionAgentsHint: "Guardadas en ~/.agents/skills. Créalas, edítalas y elimínalas aquí.",
    ...
    sectionBundledHint: "Vienen con Unsloth Studio. Solo lectura.",
    newSkillHint: "Escribe una aquí. Se guarda en ~/.agents/skills.",
    edit: "Editar",
    view: "Ver",
    linked: "Enlace",
    emptyTitle: "Aún no hay habilidades",
    previewTitle: "Lo que ve el modelo",
    previewHint: "Su línea de catálogo. A partir de ella el modelo decide si abrir la habilidad y leer las instrucciones.",
    previewName: "skill-name",
    mention: "Menciónala en el chat",
    copyMention: "Copiar @{name}",
    sourceLabel: "Origen",
