  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassDescription:
          "Cómo aprueba Unsloth las llamadas a herramientas del chat (terminal, python, web, MCP) antes de ejecutarlas. El acceso total desactiva las aprobaciones y el sandbox de código.",
      },
    },
    profile: {
      title: "Perfil",
      ...
      stats: {
        ...
        activityDescription: "{total} tokens en las últimas {weeks} semanas",
        mode: {
          daily: "Diaria",
          weekly: "Semanal",
          cumulative: "Acumulada",
        },
        cellTooltip: "{date} · {tokens} tokens, {messages} mensajes",
        weekTooltip: "Semana del {date} · {tokens} tokens",
        less: "Menos",
        more: "Más",
