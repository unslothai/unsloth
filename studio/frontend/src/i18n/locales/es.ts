  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        methodDescription:
          "Elige si la dirección remota cambia con cada conexión.",
        methodCustomRequirement:
          "Personalizado necesita un dominio que ya hayas añadido a Cloudflare.",
        temporaryMethod: "Temporal",
        customMethod: "Personalizado",
        sectionTitle: "Acceso remoto",
        description:
          "Usa Unsloth y sus API desde otros dispositivos mediante Cloudflare.",
        progressConnecting: "Conectando",
        progressOpeningLink: "Abriendo enlace seguro",
        progressCheckingHostname: "Comprobando nombre de host",
        progressDisconnecting: "Desconectando",
        stateOff: "Desactivado",
        stateStarting: "Iniciando",
        stateOnline: "En línea",
        stateStopping: "Deteniendo",
        stateError: "Error",
        stateUnavailable: "No disponible",
        ownerLaunch: "Gestionado al iniciar",
        ownerColab: "Gestionado por Colab",
        copied: "Copiado",
        copyUrl: "Copiar URL",
        qrTitle: "Abrir en el teléfono",
        qrDescription:
          "Escanea para abrir la URL remota en el navegador del teléfono.",
        remoteUrl: "URL remota",
        remoteUrlReady: "El enlace remoto está listo.",
        urlHint:
          "Cualquiera que tenga esta URL y la contraseña remota puede iniciar sesión.",
        streamingSupported: "Este túnel admite respuestas en streaming.",
        streamingBuffered:
          "Los túneles temporales almacenan las respuestas en streaming hasta que terminan.",
        passwordLabel: "Contraseña remota",
        passwordDescription:
          "Los navegadores remotos inician sesión como unsloth. La aplicación de escritorio sigue iniciando sesión automáticamente.",
        customHostnameTitle: "Nombre de host personalizado",
        customHostnameDescription:
          "Usa tu propio nombre de host para conservar la misma dirección.",
        hostnameLabel: "Nombre de host completo",
        hostnamePlaceholder: "unsloth.example.com",
        setupAction: "Configurar",
        setupConfirmTitle: "¿Configurar este nombre de host?",
        setupConfirmAction: "Confirmar",
        setupConfirmDescription:
          "Revisa el nombre de host de abajo. Cloudflare te pedirá después que autorices este túnel: elige el dominio al que pertenece este nombre de host y haz clic en Authorize.",
        setupPreparing:
          "Abriendo Cloudflare para que puedas autorizar este túnel…",
        setupAuthorize:
          "Esperando a que autorices en Cloudflare. Elige el dominio al que pertenece {hostname} y haz clic en Authorize.",
        removeProgress: "Eliminando la conexión guardada de Unsloth...",
        openCloudflare: "Abrir Cloudflare",
        removeAction: "Eliminar",
        removeTitle: "¿Eliminar este túnel personalizado de Unsloth?",
        removeDescription:
          "Esto solo quita lo que Unsloth guardó. El túnel y su registro DNS permanecen en Cloudflare hasta que los elimines allí.",
        removeTunnelHint: "En Cloudflare, elimina este túnel:",
        tunnelNameUnavailable: "Nombre del túnel no disponible",
        openCloudflareTunnels: "Abrir túneles de Cloudflare",
        removeDnsHint: "Después elimina este registro DNS:",
        openCloudflareDns: "Abrir registros DNS",
        removeConfirm: "Eliminar de Unsloth",
        removeLocally:
          "Abre Ajustes en el equipo que ejecuta Unsloth para eliminar este túnel conectado.",
        dnsConflict:
          "{hostname} ya apunta a otro sitio en Cloudflare. Elimina ese registro DNS o configura un nombre de host distinto.",
        requestFailed: "Falló la solicitud de acceso remoto.",
        runtimeFailed:
          "El acceso remoto se detuvo inesperadamente. Vuelve a intentarlo o revisa los registros del servidor.",
        startAction: "Iniciar",
        stopAction: "Detener",
        autoStartLabel: "Iniciar automáticamente",
        autoStartTemporary:
          "Crea una URL temporal nueva al iniciar Unsloth. Desconectar ahora no desactiva esta opción.",
        autoStartCustom:
          "Conecta este nombre personalizado al iniciar Unsloth. Desconectar ahora no desactiva esta opción.",
        autoStartCustomMissing:
          "Esto no conectará nada hasta que configures abajo un nombre de host personalizado.",
        blockServerStarting:
          "El acceso remoto estará disponible cuando el servidor termine de iniciarse.",
        blockCustomNotConfigured:
          "Configura abajo un nombre de host personalizado antes de iniciar el acceso remoto.",
        blockPasswordDesktop:
          "Establece abajo una contraseña remota antes de iniciar el acceso remoto.",
        blockPasswordWeb:
          "Pide al administrador del host que configure una contraseña remota.",
        blockExplicitlyDisabled:
          "El acceso remoto se deshabilitó al iniciar este servidor.",
        blockLaunchManaged:
          "Este túnel se administra mediante el comando de inicio del servidor.",
        blockColabManaged: "Este túnel se administra desde la sesión de Colab.",
        blockColab: "Colab administra la configuración de acceso remoto.",
        dnsConflictUnknown:
          "Este nombre de host ya apunta a otro sitio en Cloudflare. Elimina ese registro DNS o configura un nombre de host distinto.",
        errorInvalidHostname:
          "Ese no es un nombre de host completo. Escribe uno como unsloth.example.com.",
        errorWrongDomain:
          "El dominio que autorizaste en Cloudflare no cubre {hostname}. Vuelve a configurarlo y elige el dominio al que pertenece este nombre de host.",
        errorHostnameUnreachable:
          "El túnel se conectó, pero {hostname} no se abrió. Quita este túnel personalizado, vuelve a configurarlo y elige el dominio al que pertenece este nombre de host.",
        errorCertificateExists:
          "Ya existe un certificado de Cloudflare en {path} y Unsloth no lo sobrescribirá. Mueve o elimina ese archivo y vuelve a configurarlo.",
        errorBusy:
          "Otro cambio de acceso remoto sigue en curso. Espera a que termine y vuelve a intentarlo.",
        errorIdentityExists:
          "Ya hay un túnel personalizado configurado. Quítalo antes de configurar otro nombre de host.",
        errorUnavailable:
          "No se pudo contactar con Cloudflare. Comprueba la conexión a internet de este equipo y vuelve a intentarlo.",
        errorCancelled:
          "La configuración se canceló. Vuelve a configurarla cuando quieras.",
        errorLoginTimeout:
          "Cloudflare no se autorizó a tiempo. Vuelve a configurarlo y haz clic en Authorize cuando se abra la página de Cloudflare.",
        errorLoginFailed:
          "Cloudflare no completó la autorización. Vuelve a configurarlo.",
        errorSetupFailed:
          "No se pudo terminar el túnel personalizado. Vuelve a configurarlo o revisa los registros del servidor.",
        errorTeardownFailed:
          "No se pudo quitar el túnel personalizado guardado. Inténtalo de nuevo o revisa los registros del servidor.",
        errorTeardownManual: "El túnel personalizado se eliminó de Unsloth.",
        errorUnknown:
          "El cambio del túnel personalizado no se completó. Inténtalo de nuevo o revisa los registros del servidor.",
      },
      notifications: {
