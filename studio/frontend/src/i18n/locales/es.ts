...
export const es = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Aprendizaje por refuerzo con funciones de recompensa predefinidas.",
        note: "RL",
      },
    },
    grpo: {
      settings: "Ajustes de GRPO",
      rewardFunctions: "Funciones de recompensa",
      rewardFunctionsLoading: "Cargando funciones de recompensa...",
      expectedColumns: "Necesita columna(s) del conjunto de datos: {columns}",
      weight: "Peso",
      numGenerations: "Generaciones por prompt",
      numGenerationsTooltip: "Cuántas respuestas se generan y puntúan por prompt. Debe dividir el tamaño de lote x acumulación de gradiente.",
      maxPromptLength: "Longitud máxima del prompt",
      maxPromptLengthTooltip: "Tokens del prompt conservados antes de generar. Los prompts más largos se truncan.",
      maxCompletionLength: "Longitud máxima de la respuesta",
      maxCompletionLengthTooltip: "Máximo de tokens generados por rollout. El prompt más la respuesta deben caber en el contexto.",
      temperature: "Temperatura de muestreo",
      temperatureTooltip: "Valores altos hacen los rollouts más diversos, algo que GRPO necesita para distinguir buenas de malas respuestas.",
      topP: "Top-p",
      topPTooltip: "Umbral de muestreo por núcleo para los rollouts.",
      beta: "Coeficiente KL (beta)",
      betaTooltip: "Cuánto tira el modelo de referencia de la política. 0 elimina el término KL por completo.",
      generationBackend: "Backend de rollouts",
