...
export const es = {
  ...
  settings: {
    ...
    library: {
      ...
      locationsDescription: "Dónde guarda Studio cada tipo de archivo. Las carpetas de la biblioteca son etiquetas dentro de Studio, no carpetas en el disco.",
