  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Confirma el nombre de host de abajo. En Cloudflare, selecciona el dominio que coincida y aprueba el acceso.",
        setupPreparing:"Conectando con Cloudflare...",
        setupAuthorize:"Esperando la aprobación en Cloudflare. Selecciona el dominio que coincida con {hostname}.",
        ...
        removeDescription:"Esto solo elimina la conexión guardada en Unsloth. El túnel y el registro DNS permanecen en Cloudflare.",
        ...
        dnsConflict:"El registro {hostname} ya existe. Elimínalo en Cloudflare o elige otro nombre de host.",
        ...
        autoStartCustomMissing:"Configura un túnel personalizado antes de activar esta opción.",
        blockServerStarting:"El acceso remoto estará disponible cuando el servidor termine de iniciarse.",
        blockPasswordDesktop:"Configura una contraseña remota antes de iniciar el acceso remoto.",
        ...
        dnsConflictUnknown:"Un registro DNS existente bloquea este nombre de host. Elimínalo en Cloudflare o elige otro nombre.",
        errorInvalidHostname:"Introduce un nombre de host completo, como studio.example.com.",
        errorWrongDomain:"Cloudflare no autorizó {hostname}. Inténtalo de nuevo y selecciona el dominio de este nombre de host.",
        errorHostnameUnreachable:"Cloudflare se conectó, pero {hostname} no se abrió. Elimina este túnel personalizado, configúralo de nuevo y selecciona el dominio correcto.",
        errorCertificateExists:"Studio no sobrescribirá el certificado de Cloudflare existente en {path}. Muévelo y vuelve a intentarlo.",
        errorBusy:"Ya hay otra operación de acceso remoto en curso. Espera a que termine y vuelve a intentarlo.",
        errorIdentityExists:"Ya hay un túnel personalizado configurado. Elimínalo antes de configurar otro nombre de host.",
        errorUnavailable:"No se pudo contactar con Cloudflare. Comprueba la conexión y vuelve a intentarlo.",
        errorCancelled:"Se canceló la autorización de Cloudflare.",
        errorLoginTimeout:"La autorización de Cloudflare agotó el tiempo. Inicia de nuevo la configuración.",
        errorLoginFailed:"Falló la autorización de Cloudflare. Inicia de nuevo la configuración.",
        errorSetupFailed:"Cloudflare no pudo terminar de configurar el túnel personalizado. Vuelve a intentarlo.",
        errorTeardownFailed:"Unsloth no pudo eliminar el túnel personalizado guardado. Vuelve a intentarlo.",
        errorTeardownManual:"El túnel personalizado se eliminó de Unsloth.",
        errorUnknown:"Falló la operación del túnel personalizado. Vuelve a intentarlo o revisa los registros del servidor.",
      },
      notifications: {
