  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Haz preguntas de sí/no, de elección y de puntuación sobre cualquier texto y obtén probabilidades calibradas de un modelo Laya local. Habla la API de Jev, así que el SDK de TypeSafe funciona sin cambios.",
        enable: "Atender solicitudes",
        enableDescription: "Responde a POST /v1/systemone. Al activarlo se descarga el modelo; se carga en memoria con la primera solicitud.",
        lockedByEnv: "Definido por {name}.",
        model: "Modelo",
        modelDescription: "Multilingüe cubre más de 100 idiomas. Inglés es más grande y solo para inglés.",
        ...
        tryIt: "Pruébalo",
        caveat: "Los modelos base son de uso general. Comprueba las respuestas con tus propios datos antes de confiar en ellas.",
      },
      usageNoModel:
