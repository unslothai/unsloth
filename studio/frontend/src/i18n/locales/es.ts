...
export const es = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "preguntar",
      escHint: "cerrar",
      context: "Texto seleccionado ({chars} caracteres)",
    ...
    settings: {
      ...
      actionName: "Nombre",
      actionPrompt: "Prompt",
      actionPromptHint: "Debe contener {selection}.",
      actionSystemPrompt: "Prompt del sistema (opcional)",
      actionModel: "Modelo",
      actionModelDefault: "Usar el modelo cargado",
      actionOutputMode: "Resultado",
      outputModeReplace: "Reemplazar la selección",
      outputModeShow: "Mostrar el resultado",
