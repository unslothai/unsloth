...
export const es = {
  ...
  settings: {
    ...
    debugging: {
      ...
      exportPrivacyNote: "Las credenciales se ocultan en los archivos ZIP exportados.",
      openFolder: "Abrir carpeta de registros",
      openingFolder: "Abriendo...",
      openFolderError: "No se pudo abrir la carpeta de registros",
