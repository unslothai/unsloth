  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"Gestionado en ajustes",
        ...
        stableTitle:"Nombre de host estable",
        stableDescription:"Crea un túnel de Cloudflare personalizado para una URL permanente y streaming de API.",
        hostnameLabel:"Nombre de host completo",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Configurar",
        settingUp:"Configurando...",
        provisionProgress:"Autoriza Cloudflare en el navegador. Unsloth terminará de crear el túnel y el registro DNS.",
        teardownProgress:"Autoriza Cloudflare para eliminar el túnel. El registro DNS quedará para que lo elimines.",
        openCloudflare:"Abrir Cloudflare",
        connectorReady:"Conector registrado",
        tunnelReady:"Túnel activo",
        dnsReady:"DNS resuelto",
        dnsPending:"Aún no accesible",
        dnsUnknown:"No se pudo comprobar",
        dnsLinkWaiting:"El enlace remoto aparecerá cuando se confirme la resolución DNS.",
        ready:"Listo",
        waiting:"Esperando",
        removeAction:"Eliminar túnel personalizado",
        removeTitle:"¿Eliminar este túnel personalizado?",
        removeDescription:"Se elimina la identidad del túnel después de desconectarlo. Cloudflare no puede borrar el registro DNS; elimínalo en el panel antes de reutilizar este nombre.",
        removeConfirm:"Eliminar túnel",
        ...
        orphanedRecords:"Registros DNS restantes en Cloudflare: {hostnames}. Elimínalos en el panel antes de reutilizarlos.",
        requestFailed:"Falló la solicitud de acceso remoto.",
        runtimeFailed:"Falló el túnel remoto. Vuelve a intentarlo o revisa los registros del servidor.",
        ...
        autoStartCustom:"Conecta este nombre estable al iniciar Unsloth. Desconectar ahora no desactiva esta opción.",
        autoStartCustomMissing:"El inicio automático personalizado necesita un túnel configurado.",
        ...
        errorTeardownFailed:"Cloudflare no pudo terminar de eliminar el túnel personalizado. Vuelve a intentarlo.",
        errorTeardownManual:"Se eliminó la configuración local del túnel, pero no terminó la limpieza en Cloudflare. Revisa el túnel y el registro DNS en el panel de Cloudflare.",
