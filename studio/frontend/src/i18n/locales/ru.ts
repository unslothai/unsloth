  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        mlockUngoverned: "Загруженная модель использует движок, которым «Память модели» не управляет, поэтому эта настройка не может повлиять на текущий запуск. Она останется сохранённой и применится при следующей загрузке модели llama.cpp.",
