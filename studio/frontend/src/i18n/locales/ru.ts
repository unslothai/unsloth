    ...
    general: {
      ...
      startup: {
        ...
        serverPortDescription:
          "Автоматический режим пробует 8888, затем 8889–8908. Пользовательский режим использует только выбранный порт. Изменения применятся при следующем запуске сервера.",
        serverPortAutomatic: "Автоматически",
        serverPortCustom: "Пользовательский",
        serverPortInvalid: "Введите порт от 1 до 65535.",
        serverPortSaveError: "Не удалось сохранить порт сервера.",
