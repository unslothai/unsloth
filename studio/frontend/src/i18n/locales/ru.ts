  ...
  settings: {
    ...
    agents: {
      ...
      options: {
        ...
        reasoning:
          "Режим рассуждений (off, auto, on) для сервера, запускаемого этой командой; по умолчанию off. Для уровня усилий запустите модель с unsloth run --chat-template-kwargs '{\"reasoning_effort\":\"medium\"}'.",
        yolo:
