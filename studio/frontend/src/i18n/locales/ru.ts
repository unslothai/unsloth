    ...
    resources: {
      ...
      llamaBackend: {
        exactConcurrency: {
          ...
          parkingRequired: "Требуется, чтобы llama-server мог приостанавливать чаты, по умолчанию это выключено: запустите Studio с {variable}. До тех пор действует только «Выкл».",
        },
