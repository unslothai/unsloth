...
export const ru = {
  ...
  settings: {
    ...
    chat: {
      ...
      autoCompactHint: "Ходы, покинувшие контекст, индексируются для поиска, а не удаляются. Ваши постоянные инструкции сохраняются дословно, а остальное модель может найти в архиве. Учитывает заданную длину контекста, а не доступную VRAM.",
      ...
      compactionDescriptionCheckpoint:
        "Сохраняет последний обмен сообщениями и постоянные инструкции, а остальное отправляет в архив для поиска.",
      ...
      autoCompactDescription:
        "Старые ходы уходят в доступный для поиска архив, когда локальный чат GGUF заполнен.",
