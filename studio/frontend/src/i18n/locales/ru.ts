...
export const ru = {
  ...
  settings: {
    ...
    about: {
      ...
      python: "Python",
      accelerator: {
        sectionTitle: "Оптимизированные ядра",
        sectionDescription:
          "Быстрые ядра внимания и квантизации. Каждое собрано под одну сборку PyTorch, поэтому при несовпадении версий не загружается ни одно, и Unsloth молча переходит на более медленные пути.",
        working: "Работает",
        notLoading: "Не загружается",
        notInstalled: "Не установлено",
        notChecked: "Не проверено",
        builtFor: "Собрано для {build}",
        bannerTitle: "Оптимизированные ядра установлены, но не загружаются",
        bannerBody:
          "{packages} не удаётся загрузить здесь, поэтому Unsloth переходит на более медленные пути. Обучение и вывод по-прежнему работают, но требуют больше памяти и времени.",
      },
      updates: "Обновление",
      help: "Справка",
