...
export const ru = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Вкладки Изображения, Видео и Аудио",
      mediaTabsDescription: "Показывать эти вкладки только когда для них есть файлы, или всегда.",
      mediaTabsAuto: "Когда есть файлы",
      mediaTabsAlways: "Всегда",
      ...
      showFineTunes: "Файнтюны",
      showFineTunesDescription: "Модели, которые вы обучили или экспортировали в Studio.",
