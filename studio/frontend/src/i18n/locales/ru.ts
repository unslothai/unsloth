  ...
  settings: {
    ...
    agents: {
      ...
      options: {
        ...
        reasoning:
          "Задаёт режим рассуждений (off, auto, on) для сервера, запускаемого этой командой. По умолчанию: off.",
        yolo:
      ...
      reasoning: {
        ...
        description:
          "Сессии агентов обслуживают модель с reasoning off, чтобы вызовы инструментов оставались в структурированном канале инструментов. Добавьте --reasoning auto или --reasoning on, чтобы снова включить рассуждения модели. Это действует только для сервера, который запускает сам unsloth start: остановите работающий Studio командой unsloth studio stop и запустите снова, иначе останется текущий режим.",
      },
      dryRun: {
