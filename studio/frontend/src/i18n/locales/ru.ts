  ...
  settings: {
    ...
    chat: {
      ...
      compactionDescriptionInherit:
        "Сжимает по политике, настроенной на сервере; по умолчанию это «Сбросить беседу».",
      compactionDescriptionCheckpoint:
        "Сжимает, сохраняя последний обмен сообщениями и те постоянные инструкции, которые помещаются, а остальное отправляя в архив для поиска.",
      compactionDescriptionRolling:
        "Сжимает, архивируя самые старые реплики и сохраняя недавнюю историю и выбранный запас свободного места.",
      ...
      compactionStyleDescription:
        "Как беседа сжимается, когда заполняет контекст. Настройка сервера следует UNSLOTH_CONTEXT_POLICY на сервере, которая поставляется как checkpoint и потому совпадает со «Сбросить беседу», пока её не изменят. Сброс беседы оставляет последний ход и те постоянные инструкции, которые помещаются. Архивирование самых старых ходов удаляет самые давние и может сохранить больше недавней истории.",
