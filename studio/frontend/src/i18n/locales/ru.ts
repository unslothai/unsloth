...
export const ru = {
  ...
  studio: {
    ...
    training: {
      ...
      useEverywhere: "Использовать везде на этом Mac",
      milestone: "Веха",
  ...
  systemPill: {
    ask: {
      placeholder: "Спросить Unsloth...",
      hint: "Enter — задать вопрос",
      loading: "Загрузка {model}...",
      thinking: "Думает...",
      copy: "Копировать",
      copied: "Скопировано",
      noModel:
        "Нет доступной модели. Выберите модель по умолчанию в настройках.",
      failed: "Что-то пошло не так. Бэкенд запущен?",
      autoModel: "Активная модель",
      enterHint: "спросить",
      escHint: "закрыть",
      context: "Выделенный текст ({chars} симв.)",
      followUp: "Уточнить...",
      clear: "Очистить",
    },
    settings: {
      ...
      title: "Ассистент",
      description:
        "Используйте локальную модель для выделенного текста в любом приложении на этом Mac.",
      enable: "Включить строку вопроса",
      enableDescription: "Нажмите {hotkey} в любом приложении.",
      setUp: "Настроить...",
      permission: "Универсальный доступ",
      permissionGranted: "Предоставлен",
      permissionMissing: "Не предоставлен",
      permissionRequest: "Запросить",
      hotkey: "Сочетание клавиш",
      defaultModel: "Модель по умолчанию",
      defaultModelDescription:
        "Отвечает в строке вопроса. Оставьте пустым, чтобы использовать уже загруженную модель.",
      addAction: "Добавить действие",
      editAction: "Изменить",
      deleteAction: "Удалить",
      actionName: "Название",
      actionPrompt: "Промпт",
      actionPromptHint: "Должен содержать {selection}.",
      actionSystemPrompt: "Системный промпт (необязательно)",
      actionModel: "Модель",
      actionModelDefault: "Использовать загруженную модель",
      actionOutputMode: "Результат",
      outputModeReplace: "Заменить выделение",
      outputModeShow: "Показать результат",
      actionEnabled: "Включено",
