  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Подтвердите имя хоста ниже. В Cloudflare выберите соответствующий домен и разрешите доступ.",
        setupPreparing:"Подключение к Cloudflare...",
        setupAuthorize:"Ожидание разрешения в Cloudflare. Выберите домен для {hostname}.",
