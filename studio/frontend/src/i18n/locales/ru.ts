...
export const ru = {
  ...
  settings: {
    accounts: {
      ...
      description: "Создавайте отдельные учётные записи Unsloth Studio. Новые пользователи входят по одноразовому коду настройки и задают пароль.",
    ...
    debugging: {
      ...
      exportForbidden: "Для скачивания всех журналов нужен вход в сеанс Unsloth Studio. Ключа API недостаточно.",
