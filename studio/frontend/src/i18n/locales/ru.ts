  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        keepResidentHint: "Веса не возвращаются в системную ОЗУ, пока модель загружена. Отключает автовыгрузку по простою и передаёт --mlock, чтобы ОС не вытесняла модель и не загружала её заново при следующем запросе.",
