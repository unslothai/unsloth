...
export const ru = {
  ...
  settings: {
    ...
    agents: {
      ...
      intro:
        "подключает Claude Code, Codex, Hermes, OpenClaw, OpenCode и других агентов к модели, которую обслуживает Unsloth: локально и полностью офлайн или на удалённой Studio. Запускается OpenAI-совместимый сервер, а файлы конфигурации вашего агента остаются нетронутыми.",
