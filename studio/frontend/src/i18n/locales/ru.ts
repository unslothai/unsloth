...
export const ru = {
  ...
  promptQueue: {
    ...
    queueingOffHint: "Новые сообщения, отправленные во время ответа, остановят этот ответ и будут выполнены следующими.",
    queueingOnHint: "Новые сообщения, отправленные во время ответа, встанут в очередь и будут выполнены по порядку.",
    queueingHintShared: "Сообщения, уже стоящие в очереди, сохраняются; эта настройка не приостанавливает и не возобновляет очередь.",
  },
  picker: {
