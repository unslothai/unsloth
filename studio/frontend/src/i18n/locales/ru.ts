  ...
  settings: {
    ...
    general: {
      ...
      startup: {
        ...
        menuBarIcon: "Показывать в строке меню",
        menuBarIconDescription:
          "Показывать значок Unsloth в строке меню macOS. Если он скрыт, Unsloth остаётся в Dock, в том числе при запуске при входе в систему.",
        menuBarIconSaveError:
          "Не удалось обновить настройку значка в строке меню.",
