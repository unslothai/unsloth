...
export const ru = {
  ...
  promptQueue: {
    ...
    queueingOffHint: "Новые сообщения останавливают текущий ответ и выполняются следующими.",
    queueingOnHint: "Новые сообщения ждут очереди и выполняются по порядку.",
    queueingHintShared: "Сообщения в очереди сохраняются.",
  },
  picker: {
