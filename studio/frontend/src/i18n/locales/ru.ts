...
export const ru = {
  ...
  notebooks: {
    routeTitle: "Ноутбуки",
    title: "Ноутбуки Unsloth",
    subtitle:
      "Официальные рецепты дообучения из unslothai/notebooks. Откройте в Colab или заполните Fine-tuning Studio.",
    searchPlaceholder: "Поиск ноутбуков…",
    pickerPlaceholder: "Найдите и выберите ноутбук…",
    pickerEmpty: "Нет ноутбуков, соответствующих запросу.",
    pickedSection: "Выбранный ноутбук",
    resultsCount: "{count} ноутбуков",
    allCategories: "Все",
    featured: "Избранное",
    featuredSection: "Избранные ноутбуки",
    allSection: "Все ноутбуки",
    loading: "Загрузка ноутбуков…",
    loadFailed: "Не удалось загрузить ноутбуки",
    emptyTitle: "Ноутбуки не найдены",
    emptyDescription: "Попробуйте другой поиск или фильтр категории.",
    useInStudio: "Использовать в Studio",
    openInColab: "Открыть в Colab",
    viewOnGitHub: "GitHub",
    studioModelReady: "Заполняет Studio: {model}",
    studioManualConfigure:
      "Открывает Fine-tuning Studio — выберите модель, соответствующую этому ноутбуку.",
    studioOpenedWithoutModel:
      "Открыт Fine-tuning Studio. Выберите модель, соответствующую этому ноутбуку.",
    studioDisabled: {
      mlxUnavailable:
        "Для обучения нужен MLX. Выполните `unsloth studio update`, чтобы включить «Использовать в Studio».",
      intelMac:
        "Для обучения нужен Apple Silicon или GPU. На Intel Mac доступен только чат.",
      noGpu: "Для обучения нужна GPU NVIDIA или AMD.",
      generic: "Обучение недоступно на этом устройстве.",
    },
    categories: {
      sft: "Дообучение",
      vision: "Зрение",
