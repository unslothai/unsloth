...
export const ru = {
  ...
  settings: {
    ...
    chat: {
      ...
      autoCompactHint: "Вытесненные ходы индексируются, чтобы модель могла найти их снова, а сброс сохраняет ваши постоянные инструкции дословно. Для архивации нужны сохранённый чат и векторный индекс; без них старые ходы просто удаляются. Учитывает заданную длину контекста, а не доступную VRAM.",
