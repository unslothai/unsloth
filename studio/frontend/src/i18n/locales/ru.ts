  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"Управляется настройками",
        ...
        streamingBuffered:"Быстрые туннели буферизуют потоковые ответы до завершения.",
        ...
        stableTitle:"Постоянное имя хоста",
        stableDescription:"Создайте пользовательский туннель Cloudflare для постоянного URL и потокового API.",
        hostnameLabel:"Полное имя хоста",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Настроить",
        settingUp:"Настройка...",
        provisionProgress:"Авторизуйте Cloudflare в браузере. Unsloth завершит создание туннеля и DNS-записи.",
        teardownProgress:"Авторизуйте Cloudflare для удаления туннеля. DNS-запись останется для ручного удаления.",
        openCloudflare:"Открыть Cloudflare",
        connectorReady:"Коннектор зарегистрирован",
        tunnelReady:"Туннель обслуживает",
        dnsReady:"DNS разрешён",
        dnsPending:"Пока недоступно",
        dnsUnknown:"Не удалось проверить",
        dnsLinkWaiting:"Удалённая ссылка появится после подтверждения разрешения DNS.",
        ready:"Готово",
        waiting:"Ожидание",
        removeAction:"Удалить пользовательский туннель",
        removeTitle:"Удалить этот пользовательский туннель?",
        removeDescription:"После отключения идентификатор туннеля будет удалён. Cloudflare не может удалить DNS-запись; удалите её в панели перед повторным использованием имени.",
        removeConfirm:"Удалить туннель",
        ...
        orphanedRecords:"DNS-записи, оставшиеся в Cloudflare: {hostnames}. Удалите их в панели перед повторным использованием.",
        requestFailed:"Запрос удалённого доступа не выполнен.",
        runtimeFailed:"Сбой удалённого туннеля. Повторите попытку или проверьте журналы сервера.",
        ...
        autoStartCustom:"Подключать это постоянное имя при запуске Unsloth. Отключение сейчас не выключит настройку.",
        autoStartCustomMissing:"Для автозапуска пользовательского туннеля нужен настроенный туннель.",
        ...
        errorIdentityExists:"Именованный туннель уже настроен. Удалите его перед настройкой другого имени хоста.",
        ...
        errorTeardownFailed:"Cloudflare не удалось завершить удаление пользовательского туннеля. Повторите попытку.",
        errorTeardownManual:"Локальные настройки туннеля удалены, но очистка в Cloudflare не завершена. Проверьте туннель и запись DNS в панели Cloudflare.",
