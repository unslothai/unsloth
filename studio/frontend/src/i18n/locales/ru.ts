  ...
  settings: {
    ...
    general: {
      ...
      previewSharing: {
        ...
        enableDescription:
          "Позволяет любому по подписанной ссылке общаться с готовой моделью без входа в систему. Отключите, чтобы отключить публичный предпросмотр; общие ссылки перестанут работать.",
