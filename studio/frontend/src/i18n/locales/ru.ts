  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Unsloth подготовит страницу Cloudflare. Откройте её, выберите подходящий домен и разрешите доступ.",
        setupConfirmAction:"Подготовить Cloudflare",
        setupPreparing:"Подготовка Cloudflare...",
        setupAuthorize:"Откройте Cloudflare, выберите домен для {hostname} и разрешите доступ.",
        ...
        removeDescription:"Будет удалено только подключение, сохранённое в Unsloth. Туннель и DNS-запись останутся в Cloudflare.",
        ...
        dnsConflict:"Запись {hostname} уже существует. Удалите её в Cloudflare или выберите другое имя хоста.",
        ...
        temporaryAction:"Запустить временный туннель",
        connectAction:"Подключить",
        stopAction:"Отключить",
        ...
        autoStartCustomMissing:"Настройте пользовательский туннель перед включением этой функции.",
        blockServerStarting:"Удалённый доступ станет доступен после завершения запуска сервера.",
        blockPasswordDesktop:"Задайте пароль удалённого доступа перед его запуском.",
        ...
        dnsConflictUnknown:"Существующая запись DNS блокирует это имя хоста. Удалите запись в Cloudflare или выберите другое имя.",
        errorInvalidHostname:"Введите полное имя хоста, например studio.example.com.",
        errorWrongDomain:"Cloudflare не разрешил {hostname}. Повторите попытку и выберите домен этого имени хоста.",
        errorHostnameUnreachable:"Cloudflare подключён, но {hostname} не открывается. Удалите этот пользовательский туннель, настройте его снова и выберите правильный домен.",
        errorCertificateExists:"Studio не перезапишет существующий сертификат Cloudflare в {path}. Переместите его и повторите попытку.",
        errorBusy:"Уже выполняется другая операция удалённого доступа. Дождитесь её завершения и повторите попытку.",
        errorIdentityExists:"Пользовательский туннель уже настроен. Удалите его перед настройкой другого имени хоста.",
        errorUnavailable:"Не удалось подключиться к Cloudflare. Проверьте соединение и повторите попытку.",
        errorCancelled:"Авторизация Cloudflare отменена.",
        errorLoginTimeout:"Время авторизации Cloudflare истекло. Запустите настройку заново.",
        errorLoginFailed:"Не удалось авторизоваться в Cloudflare. Запустите настройку заново.",
        errorSetupFailed:"Cloudflare не удалось завершить настройку пользовательского туннеля. Повторите попытку.",
        errorTeardownFailed:"Unsloth не удалось удалить сохранённый пользовательский туннель. Повторите попытку.",
        errorTeardownManual:"Пользовательский туннель удалён из Unsloth.",
        errorUnknown:"Операция с пользовательским туннелем завершилась ошибкой. Повторите попытку или проверьте журналы сервера.",
      },
      notifications: {
