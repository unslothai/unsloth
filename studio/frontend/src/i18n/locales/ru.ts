  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassDescription:
          "Как Unsloth подтверждает вызовы инструментов в чате (терминал, python, веб, MCP) перед запуском. Полный доступ отключает подтверждения и песочницу для кода.",
      },
    },
    profile: {
      title: "Профиль",
      ...
      stats: {
        ...
        activityDescription: "{total} токенов за последние {weeks} нед.",
        mode: {
          daily: "По дням",
          weekly: "По неделям",
          cumulative: "Накопительно",
        },
        cellTooltip: "{date} · {tokens} токенов, {messages} сообщений",
        weekTooltip: "Неделя с {date} · {tokens} токенов",
        less: "Меньше",
        more: "Больше",
        ...
        modelSummary: "{tokens} · {messages} сообщ.",
