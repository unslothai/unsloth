  ...
  settings: {
    ...
    general: {
      ...
      hub: {
        ...
        reloadNeeded: "Перезагрузите это окно, чтобы просмотр каталога использовал новые настройки Hub. Загрузки уже используют их.",
        reload: "Перезагрузить",
        desktopBrowsing: "Загрузки уже используют новые настройки Hub. Чтобы просматривать каталог с ними в настольном приложении, задайте HF_ENDPOINT и HF_DATASETS_SERVER в окружении перед запуском Unsloth.",
      },
      downloads: {
