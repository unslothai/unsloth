...
export const ru = {
  ...
  skills: {
    ...
    delete: "Удалить {name}",
    createDescription: "Сохраняется как SKILL.md в новой папке в ~/.agents/skills и сразу включается.",
    nameLabel: "Имя",
    namePlaceholder: "например, code-arithmetic",
    nameHint: "Строчные латинские буквы, цифры и одиночные дефисы. Это же имя папки.",
    nameInvalid: "От 1 до 64 строчных латинских букв, цифр или одиночных дефисов, без дефиса в начале и в конце.",
    descriptionLabel: "Описание",
    descriptionPlaceholder: "Использовать, когда пользователь просит посчитать. Всегда считать инструментом кода.",
    descriptionHint: "Строка, которую модель видит в каталоге навыков. По ней она решает, когда прочитать навык.",
    instructionsLabel: "Инструкции",
    instructionsPlaceholder: "Что делать, когда навык применим, в Markdown.",
    instructionsHint: "Тело SKILL.md, которое модель читает целиком, выбрав навык.",
    create: "Создать навык",
    save: "Сохранить изменения",
    created: "{name} создан",
    saved: "{name} сохранён",
    deleted: "{name} удалён",
    saveError: "Не удалось сохранить навык",
    openError: "Не удалось открыть навык",
    deleteError: "Не удалось удалить навык",
    deleteTitle: "Удалить навык",
    deleteDescription: "Удалить «{name}» вместе со всем содержимым его папки в ~/.agents/skills? Это действие нельзя отменить.",
    search: "Поиск навыков по имени или описанию…",
    noMatch: "Нет навыков, соответствующих «{query}»",
    clearSearch: "Очистить поиск",
    count: "{shown} из {total} навыков",
    readOnlyClaude: "Только чтение: находится в ~/.claude/skills. Редактируйте файл там.",
    readOnlyBundled: "Только чтение: встроен в Unsloth Studio.",
    ...
    fromAgents: "Навык из ~/.agents/skills. Изменения здесь записываются прямо в его SKILL.md.",
    fromClaude: "Навык из ~/.claude/skills.",
    fromBundled: "Встроен в Unsloth Studio.",
    detailsTitle: "Подробности",
    detailsDescription: "Остальные поля из frontmatter SKILL.md. Чтобы изменить их, отредактируйте файл.",
    detailsEmpty: "Других полей нет.",
    licenseLabel: "Лицензия",
    compatibilityLabel: "Совместимость",
    allowedToolsLabel: "Разрешённые инструменты",
    deleteLabel: "Удалить навык",
    deleteRowDescription: "Удаляет папку в ~/.agents/skills со всем содержимым.",
    summary: "Включено {enabled} из {total}",
    enabledOnly: "Только включённые",
    sectionAgents: "Ваши навыки",
    sectionAgentsHint: "Хранятся в ~/.agents/skills. Создавайте, изменяйте и удаляйте их здесь.",
    ...
    sectionBundledHint: "Поставляются с Unsloth Studio. Только чтение.",
    newSkillHint: "Напишите его здесь. Он попадёт в ~/.agents/skills.",
    edit: "Изменить",
    view: "Открыть",
    linked: "Ссылка",
    emptyTitle: "Навыков пока нет",
    previewTitle: "Что видит модель",
    previewHint: "Строка в каталоге. По ней модель решает, открыть ли навык и прочитать инструкции.",
    previewName: "skill-name",
    mention: "Упомянуть в чате",
    copyMention: "Скопировать @{name}",
