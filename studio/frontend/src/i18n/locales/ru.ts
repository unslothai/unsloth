...
export const ru = {
  ...
  settings: {
    ...
    apiKeys: {
      ...
      revoking: "Отзыв...",
      usageNoModel:
        "На этом сервере нет доступной чат-модели, поэтому в примере указана модель, которой у него нет. Загрузите чат-модель из Hub, и пример укажет её.",
      usageModelNotLoaded:
        "{model} не загружена. Включите «Переключать модель по запросу» выше или загрузите её в чате, прежде чем запускать этот пример.",
      usageModelNotLoadedKeyless:
        "{model} не загружена. Создайте ключ API и используйте его в этом запросе или загрузите модель в чате, прежде чем выполнять этот пример.",
      exampleModel: "Модель",
      exampleModelFollow: "Следовать за загруженной моделью",
      exampleQuant: "Квантование",
      modelLoaded: "Загружена",
    },
    about: {
      title: "О программе",
      description:
