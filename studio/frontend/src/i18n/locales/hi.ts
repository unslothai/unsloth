...
export const hi = {
  ...
  skills: {
    ...
    newSkill: "नया कौशल",
    delete: "{name} हटाएँ",
    createDescription: "~/.agents/skills के नए फ़ोल्डर में SKILL.md के रूप में सहेजा जाता है और बनते ही सक्षम हो जाता है।",
    nameLabel: "नाम",
    namePlaceholder: "जैसे code-arithmetic",
    nameHint: "छोटे अंग्रेज़ी अक्षर, अंक और एकल हाइफ़न। यही फ़ोल्डर का नाम भी है।",
    nameInvalid: "1 से 64 छोटे अंग्रेज़ी अक्षर, अंक या एकल हाइफ़न उपयोग करें, जो हाइफ़न से शुरू या समाप्त न हो।",
    descriptionLabel: "विवरण",
    descriptionPlaceholder: "जब उपयोगकर्ता अंकगणित माँगे तब उपयोग करें। हमेशा कोड टूल से गणना करें।",
    descriptionHint: "वह पंक्ति जो मॉडल अपने कौशल कैटलॉग में देखता है। इसी से वह तय करता है कि कौशल कब पढ़ना है।",
    instructionsLabel: "निर्देश",
    instructionsPlaceholder: "यह कौशल लागू होने पर क्या करना है, Markdown में।",
    instructionsHint: "SKILL.md का मुख्य भाग, जिसे मॉडल कौशल चुनने पर पूरा पढ़ता है।",
    create: "कौशल बनाएँ",
    save: "बदलाव सहेजें",
    created: "{name} बनाया गया",
    saved: "{name} सहेजा गया",
    deleted: "{name} हटाया गया",
    saveError: "कौशल सहेजा नहीं जा सका",
    openError: "कौशल खोला नहीं जा सका",
    deleteError: "कौशल हटाया नहीं जा सका",
    deleteTitle: "कौशल हटाएँ",
    deleteDescription: '"{name}" और ~/.agents/skills में उसके फ़ोल्डर की सभी सामग्री हटाएँ? इसे पूर्ववत नहीं किया जा सकता।',
    search: "नाम या विवरण से कौशल खोजें…",
    noMatch: "“{query}” से मेल खाने वाला कोई कौशल नहीं",
    clearSearch: "खोज साफ़ करें",
    count: "{total} में से {shown} कौशल",
    readOnlyClaude: "केवल पढ़ने के लिए: ~/.claude/skills में मिला। फ़ाइल वहीं संपादित करें।",
    readOnlyBundled: "केवल पढ़ने के लिए: Unsloth Studio के साथ बंडल्ड।",
    readOnlyLinked: "केवल पढ़ने के लिए: यह प्रविष्टि एक लिंक है। फ़ाइलें उनके वास्तविक स्थान पर संपादित करें।",
    characters: "{count} अक्षर",
    unsaved: "असहेजे बदलाव",
    revert: "पूर्ववत करें",
    enabledLabel: "सक्षम",
    locationLabel: "स्थान",
    fromAgents: "~/.agents/skills में एक कौशल। यहाँ के बदलाव सीधे इसकी SKILL.md में लिखे जाते हैं।",
    fromClaude: "~/.claude/skills में एक कौशल।",
    fromBundled: "Unsloth Studio के साथ बंडल्ड।",
    detailsTitle: "विवरण",
    detailsDescription: "SKILL.md फ़्रंटमैटर के अन्य फ़ील्ड। इन्हें बदलने के लिए फ़ाइल संपादित करें।",
    detailsEmpty: "कोई अन्य फ़ील्ड नहीं।",
    licenseLabel: "लाइसेंस",
    compatibilityLabel: "संगतता",
    allowedToolsLabel: "अनुमत टूल",
    deleteLabel: "कौशल हटाएँ",
    deleteRowDescription: "~/.agents/skills के अंतर्गत फ़ोल्डर और उसकी सभी सामग्री हटाता है।",
    summary: "{total} में से {enabled} सक्षम",
    enabledOnly: "केवल सक्षम",
    sectionAgents: "आपके कौशल",
    sectionAgentsHint: "~/.agents/skills में सहेजे गए। इन्हें यहाँ बनाएँ, संपादित करें और हटाएँ।",
    sectionClaude: "Claude कौशल",
    sectionClaudeHint: "~/.claude/skills में मिले। यहाँ केवल पढ़ने के लिए; फ़ाइलें वहीं संपादित करें।",
    sectionBundled: "बंडल्ड",
    sectionBundledHint: "Unsloth Studio के साथ आते हैं। केवल पढ़ने के लिए।",
    newSkillHint: "यहाँ लिखें। यह ~/.agents/skills में सहेजा जाएगा।",
    edit: "संपादित करें",
    view: "देखें",
    linked: "लिंक",
    emptyTitle: "अभी कोई कौशल नहीं",
    previewTitle: "मॉडल क्या देखता है",
    previewHint: "कैटलॉग में इसकी पंक्ति। मॉडल इसी से तय करता है कि कौशल खोलकर निर्देश पढ़े या नहीं।",
    previewName: "skill-name",
    mention: "चैट में उल्लेख करें",
    copyMention: "@{name} कॉपी करें",
    sourceLabel: "स्रोत",
