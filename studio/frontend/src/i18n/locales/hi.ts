...
export const hi = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "इमेज, वीडियो और ऑडियो टैब",
      mediaTabsDescription: "ये टैब केवल तब दिखाएं जब इनमें फ़ाइलें हों, या हमेशा।",
      mediaTabsAuto: "जब फ़ाइलें हों",
      mediaTabsAlways: "हमेशा",
      ...
      showFineTunes: "फ़ाइन-ट्यून",
      showFineTunesDescription: "वे मॉडल जिन्हें आपने Studio में ट्रेन या एक्सपोर्ट किया।",
