...
export const hi = {
  ...
  settings: {
    ...
    chat: {
      ...
      exportConversations: "Recents और Projects एक्सपोर्ट करें",
      exportConversationsDescription:
        "Recents या Recents के साथ प्रोजेक्ट चैट को Raw JSONL, CSV, या ShareGPT JSONL के रूप में, संयुक्त या प्रति चैट डाउनलोड करें।",
      ...
      importChatsDescription:
        "एक JSONL, NDJSON, या CSV एक्सपोर्ट को Recents में इंपोर्ट करें।",
      importChatsAction: "इंपोर्ट करें",
      importNoConversations: "फ़ाइल में कोई वार्तालाप नहीं मिला।",
      importedOneChat: "1 वार्तालाप Recents में इंपोर्ट किया गया।",
      importedChatCount: "{count} वार्तालाप Recents में इंपोर्ट किए गए।",
  ...
  studio: {
    ...
    history: {
      ...
      emptyDescription:
        "अभी तक कोई ट्रेनिंग रन नहीं। Configure टैब में अपनी पहली ट्रेनिंग रन शुरू करें।",
