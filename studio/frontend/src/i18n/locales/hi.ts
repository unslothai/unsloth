  ...
  settings: {
    ...
    agents: {
      ...
      options: {
        ...
        reasoning:
          "इस कमांड से शुरू होने वाले सर्वर के लिए रीज़निंग मोड (off, auto, on) तय करता है। डिफ़ॉल्ट: off।",
        yolo:
      ...
      reasoning: {
        title: "रीज़निंग स्तर",
        description:
          "एजेंट सेशन मॉडल को reasoning off के साथ चलाते हैं, ताकि टूल कॉल संरचित टूल चैनल में ही रहें। मॉडल की रीज़निंग वापस चालू करने के लिए --reasoning auto या --reasoning on जोड़ें। यह सिर्फ़ उसी सर्वर पर लागू होता है जिसे unsloth start खुद शुरू करता है, इसलिए चल रहे Studio को unsloth studio stop से बंद करके दोबारा चलाएँ, वरना मौजूदा मोड ही बना रहेगा।",
      },
      dryRun: {
