  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        progressConnecting:"कनेक्ट हो रहा है",
        progressOpeningLink:"सुरक्षित लिंक खुल रहा है",
        progressCheckingHostname:"होस्टनाम जाँचा जा रहा है",
        progressDisconnecting:"डिस्कनेक्ट हो रहा है",
        stateOff:"बंद",
        stateStarting:"शुरू हो रहा है",
        stateOnline:"ऑनलाइन",
        stateStopping:"रुक रहा है",
        stateError:"त्रुटि",
        stateUnavailable:"अनुपलब्ध",
        ownerLaunch:"लॉन्च द्वारा प्रबंधित",
        ownerColab:"Colab द्वारा प्रबंधित",
        copied:"कॉपी किया",
        copyUrl:"URL कॉपी करें",
        qrTitle:"फ़ोन पर खोलें",
        qrDescription:"रिमोट URL को फ़ोन के ब्राउज़र में खोलने के लिए स्कैन करें।",
        remoteUrl:"रिमोट URL",
        remoteUrlReady:"रिमोट लिंक तैयार है।",
        urlHint:"यह URL और रिमोट पासवर्ड रखने वाला कोई भी व्यक्ति साइन इन कर सकता है।",
        streamingSupported:"यह टनल स्ट्रीमिंग उत्तरों का समर्थन करती है।",
        streamingBuffered:"अस्थायी टनल स्ट्रीमिंग उत्तरों को पूरा होने तक बफ़र करती हैं।",
        passwordLabel:"रिमोट पासवर्ड",
        passwordDescription:"रिमोट ब्राउज़र unsloth के रूप में साइन इन करते हैं। डेस्कटॉप ऐप स्वतः साइन इन रहता है।",
        customHostnameTitle:"कस्टम होस्टनाम",
        customHostnameDescription:"एक ही पता बनाए रखने के लिए अपना होस्टनाम इस्तेमाल करें।",
        hostnameLabel:"पूरा होस्टनाम",
        hostnamePlaceholder:"unsloth.example.com",
        setupAction:"सेट अप करें",
        setupConfirmTitle:"यह होस्टनाम सेट अप करें?",
        setupConfirmAction:"पुष्टि करें",
        setupConfirmDescription:"नीचे दिया होस्टनाम जाँचें। इसके बाद Cloudflare इस टनल को अधिकृत करने को कहेगा: वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है, और Authorize पर क्लिक करें।",
        setupPreparing:"Cloudflare खोला जा रहा है ताकि आप इस टनल को अधिकृत कर सकें…",
        setupAuthorize:"Cloudflare में आपके अधिकृत करने की प्रतीक्षा है। वह डोमेन चुनें जिससे {hostname} संबंधित है, फिर Authorize पर क्लिक करें।",
        removeProgress:"Unsloth से सहेजा गया कनेक्शन हटाया जा रहा है...",
        openCloudflare:"Cloudflare खोलें",
        removeAction:"हटाएँ",
        removeTitle:"यह कस्टम टनल Unsloth से हटाएँ?",
        removeDescription:"यह केवल वही हटाता है जो Unsloth ने सहेजा था। टनल और उसका DNS रिकॉर्ड Cloudflare में तब तक रहेंगे जब तक आप उन्हें वहाँ न हटाएँ।",
        removeTunnelHint:"Cloudflare में यह टनल हटाएँ:",
        tunnelNameUnavailable:"टनल का नाम उपलब्ध नहीं है",
        openCloudflareTunnels:"Cloudflare टनल खोलें",
        removeDnsHint:"फिर यह DNS रिकॉर्ड हटाएँ:",
        openCloudflareDns:"DNS रिकॉर्ड खोलें",
        removeConfirm:"Unsloth से हटाएँ",
        removeLocally:"इस कनेक्टेड टनल को हटाने के लिए Unsloth चलाने वाली मशीन पर सेटिंग खोलें।",
        dnsConflict:"{hostname} Cloudflare में पहले से कहीं और इंगित करता है। उस DNS रिकॉर्ड को हटाएँ, या कोई दूसरा होस्टनाम सेट करें।",
        requestFailed:"रिमोट ऐक्सेस अनुरोध विफल हुआ।",
        ...
        autoStartCustomMissing:"जब तक आप नीचे कस्टम होस्टनाम सेट अप नहीं करते, यह कुछ भी कनेक्ट नहीं करेगा।",
        blockServerStarting:"सर्वर के शुरू होते ही रिमोट एक्सेस उपलब्ध होगा।",
        blockCustomNotConfigured:"रिमोट एक्सेस शुरू करने से पहले नीचे कस्टम होस्टनाम सेट अप करें।",
        blockPasswordDesktop:"रिमोट एक्सेस शुरू करने से पहले नीचे रिमोट पासवर्ड सेट करें।",
        blockPasswordWeb:"होस्ट एडमिन से रिमोट पासवर्ड सेट करने को कहें।",
        blockExplicitlyDisabled:"इस सर्वर के शुरू होने पर रिमोट ऐक्सेस बंद किया गया था।",
        blockLaunchManaged:"यह टनल सर्वर के लॉन्च कमांड से प्रबंधित होती है।",
        blockColabManaged:"यह टनल Colab सेशन से प्रबंधित होती है।",
        blockColab:"रिमोट ऐक्सेस सेटिंग Colab से प्रबंधित होती हैं।",
        dnsConflictUnknown:"यह होस्टनाम Cloudflare में पहले से कहीं और इंगित करता है। उस DNS रिकॉर्ड को हटाएँ, या कोई दूसरा होस्टनाम सेट करें।",
        errorInvalidHostname:"यह पूरा होस्टनाम नहीं है। unsloth.example.com जैसा कोई नाम दर्ज करें।",
        errorWrongDomain:"आपने Cloudflare में जो डोमेन अधिकृत किया, वह {hostname} को कवर नहीं करता। दोबारा सेट अप करें और वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है।",
        errorHostnameUnreachable:"टनल जुड़ गया, पर {hostname} नहीं खुला। इस कस्टम टनल को हटाएँ, दोबारा सेट अप करें, और वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है।",
        errorCertificateExists:"{path} पर Cloudflare प्रमाणपत्र पहले से मौजूद है, और Unsloth उसे अधिलेखित नहीं करेगा। उस फ़ाइल को हटाएँ या कहीं और ले जाएँ, फिर दोबारा सेट अप करें।",
        errorBusy:"रिमोट एक्सेस का एक और बदलाव अभी चल रहा है। उसके पूरा होने की प्रतीक्षा करें, फिर पुनः प्रयास करें।",
        errorIdentityExists:"कस्टम टनल पहले से सेट अप है। कोई दूसरा होस्टनाम सेट करने से पहले उसे हटाएँ।",
        errorUnavailable:"Cloudflare तक नहीं पहुँचा जा सका। इस मशीन का इंटरनेट कनेक्शन जाँचें, फिर पुनः प्रयास करें।",
        errorCancelled:"सेटअप रद्द कर दिया गया। तैयार होने पर दोबारा सेट अप करें।",
        errorLoginTimeout:"Cloudflare समय पर अधिकृत नहीं हुआ। दोबारा सेट अप करें, और Cloudflare पेज खुलने पर Authorize पर क्लिक करें।",
        errorLoginFailed:"Cloudflare ने अधिकृतीकरण पूरा नहीं किया। दोबारा सेट अप करें।",
        errorSetupFailed:"कस्टम टनल पूरा नहीं हो सका। दोबारा सेट अप करें, या सर्वर लॉग देखें।",
        errorTeardownFailed:"सहेजा गया कस्टम टनल हटाया नहीं जा सका। पुनः प्रयास करें, या सर्वर लॉग देखें।",
        errorTeardownManual:"कस्टम टनल Unsloth से हटा दिया गया।",
        errorUnknown:"कस्टम टनल का बदलाव पूरा नहीं हुआ। पुनः प्रयास करें, या सर्वर लॉग देखें।",
      },
      notifications: {
