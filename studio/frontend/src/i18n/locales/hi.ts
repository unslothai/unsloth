...
export const hi = {
  ...
  settings: {
    ...
    apiKeys: {
      ...
      revoking: "रद्द किया जा रहा है...",
      usageNoModel:
        "इस सर्वर पर कोई चैट मॉडल उपलब्ध नहीं है, इसलिए यह उदाहरण एक ऐसे मॉडल का नाम लेता है जो इसके पास नहीं है। Hub से एक चैट मॉडल डाउनलोड करें और उदाहरण उसी का नाम लेगा।",
      usageModelNotLoaded:
        "{model} लोड नहीं है। यह उदाहरण चलाने से पहले ऊपर \"अनुरोध के अनुसार मॉडल बदलें\" चालू करें, या इसे चैट में लोड करें।",
      usageModelNotLoadedKeyless:
        "{model} लोड नहीं है। इस उदाहरण को चलाने से पहले एक API कुंजी बनाकर इस अनुरोध में उपयोग करें, या मॉडल को चैट में लोड करें।",
      exampleModel: "मॉडल",
      exampleModelFollow: "लोड किए गए मॉडल का अनुसरण करें",
      exampleQuant: "क्वांटाइज़ेशन",
      modelLoaded: "लोड है",
    },
    about: {
      title: "परिचय",
