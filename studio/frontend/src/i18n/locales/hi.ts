  ...
  settings: {
    ...
    general: {
      ...
      hub: {
        ...
        endpointInactive: "तब इस्तेमाल होता है जब Hugging Face मॉडल स्रोत हो।",
        ...
        reloadNeeded: "ब्राउज़िंग में नई Hub सेटिंग्स इस्तेमाल करने के लिए यह विंडो रीलोड करें। डाउनलोड पहले से इनका इस्तेमाल कर रहे हैं।",
        reload: "रीलोड करें",
        desktopBrowsing: "डाउनलोड अब नई Hub सेटिंग्स का इस्तेमाल करते हैं। डेस्कटॉप ऐप में इनसे ब्राउज़ करने के लिए, Unsloth शुरू करने से पहले एनवायरनमेंट में HF_ENDPOINT और HF_DATASETS_SERVER सेट करें।",
      },
      downloads: {
