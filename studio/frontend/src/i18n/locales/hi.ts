  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"नीचे दिए होस्टनाम की पुष्टि करें। Cloudflare में उससे मेल खाने वाला डोमेन चुनें और एक्सेस की अनुमति दें।",
        setupPreparing:"Cloudflare से कनेक्ट हो रहा है...",
        setupAuthorize:"Cloudflare में अनुमति का इंतज़ार है। {hostname} से मेल खाने वाला डोमेन चुनें।",
        ...
        removeDescription:"यह केवल Unsloth में सहेजा गया कनेक्शन हटाता है। टनल और DNS रिकॉर्ड Cloudflare में बने रहते हैं।",
        ...
        dnsConflict:"रिकॉर्ड {hostname} पहले से मौजूद है। उसे Cloudflare में हटाएँ या दूसरा होस्टनाम चुनें।",
        ...
        autoStartCustomMissing:"इसे चालू करने से पहले कस्टम टनल सेट अप करें।",
        blockServerStarting:"सर्वर का शुरू होना पूरा होने के बाद रिमोट ऐक्सेस उपलब्ध होगा।",
        blockPasswordDesktop:"रिमोट ऐक्सेस शुरू करने से पहले रिमोट पासवर्ड सेट करें।",
        ...
        dnsConflictUnknown:"मौजूदा DNS रिकॉर्ड इस होस्टनेम को रोक रहा है। Cloudflare में रिकॉर्ड हटाएँ या दूसरा होस्टनेम चुनें।",
        errorInvalidHostname:"studio.example.com जैसा पूरा होस्टनेम दर्ज करें।",
        errorWrongDomain:"Cloudflare ने {hostname} को अनुमति नहीं दी। फिर कोशिश करें और इस होस्टनाम का डोमेन चुनें।",
        errorHostnameUnreachable:"Cloudflare कनेक्ट हुआ, लेकिन {hostname} नहीं खुला। यह कस्टम टनल हटाकर फिर सेट अप करें और सही डोमेन चुनें।",
        errorCertificateExists:"Studio {path} पर मौजूद Cloudflare प्रमाणपत्र को ओवरराइट नहीं करेगा। उसे दूसरी जगह ले जाएँ, फिर कोशिश करें।",
        errorBusy:"रिमोट ऐक्सेस की दूसरी प्रक्रिया पहले से चल रही है। उसके पूरा होने की प्रतीक्षा करें, फिर कोशिश करें।",
        errorIdentityExists:"कस्टम टनल पहले से कॉन्फ़िगर है। दूसरा होस्टनेम सेट करने से पहले उसे हटाएँ।",
        errorUnavailable:"Cloudflare तक नहीं पहुँचा जा सका। अपना कनेक्शन जाँचें और फिर कोशिश करें।",
        errorCancelled:"Cloudflare प्राधिकरण रद्द कर दिया गया।",
        errorLoginTimeout:"Cloudflare प्राधिकरण का समय समाप्त हो गया। सेटअप फिर से शुरू करें।",
        errorLoginFailed:"Cloudflare प्राधिकरण विफल रहा। सेटअप फिर से शुरू करें।",
        errorSetupFailed:"Cloudflare कस्टम टनल का सेटअप पूरा नहीं कर सका। फिर कोशिश करें।",
        errorTeardownFailed:"Unsloth सहेजा गया कस्टम टनल नहीं हटा सका। फिर कोशिश करें।",
        errorTeardownManual:"कस्टम टनल Unsloth से हटा दिया गया।",
        errorUnknown:"कस्टम टनल की प्रक्रिया विफल रही। फिर कोशिश करें या सर्वर लॉग देखें।",
      },
      notifications: {
