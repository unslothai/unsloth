...
export const hi = {
  ...
  settings: {
    ...
    chat: {
      ...
      autoCompactHint:
        "कॉन्टेक्स्ट से बाहर होने वाले टर्न मिटाए नहीं जाते, बल्कि पुनर्प्राप्ति के लिए इंडेक्स किए जाते हैं। आपके स्थायी निर्देश हूबहू बने रहते हैं और बाकी सामग्री मॉडल आर्काइव में खोज सकता है। उपलब्ध VRAM के बजाय आपके तय किए गए संदर्भ की लंबाई का उपयोग करता है।",
      ...
      compactionDescriptionCheckpoint:
        "सबसे हाल का संवाद और स्थायी निर्देश बनाए रखें, और बाकी को खोज के लिए आर्काइव करें।",
      ...
      autoCompactDescription:
        "लोकल GGUF चैट का कॉन्टेक्स्ट भरने पर पुराने टर्न खोजे जा सकने वाले आर्काइव में चले जाते हैं।",
