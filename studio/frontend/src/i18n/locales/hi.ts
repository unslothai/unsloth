  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassDescription:
          "चैट के टूल कॉल (टर्मिनल, python, वेब, MCP) चलाने से पहले Unsloth उन्हें कैसे मंज़ूरी देता है। पूर्ण एक्सेस से मंज़ूरी और कोड सैंडबॉक्स बंद हो जाते हैं।",
      },
    },
    profile: {
      title: "प्रोफ़ाइल",
      ...
      stats: {
        ...
        activityDescription: "पिछले {weeks} हफ़्तों में {total} टोकन",
        mode: {
          daily: "दैनिक",
          weekly: "साप्ताहिक",
          cumulative: "संचयी",
        },
        cellTooltip: "{date} · {tokens} टोकन, {messages} संदेश",
        weekTooltip: "{date} वाला हफ़्ता · {tokens} टोकन",
        less: "कम",
        more: "ज़्यादा",
        ...
        modelSummary: "{tokens} · {messages} संदेश",
