  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "जब मॉडल पूरी तरह GPU पर ऑफ़लोड हो, तो समर्थित Windows बिल्ड पर DirectIO का उपयोग करता है। अन्यथा मेमोरी-मैप्ड लोडिंग बनाए रखता है। आवश्यक CPU बफ़र और मैप्ड पेज अब भी RAM ले सकते हैं। --no-mmap तथा --mlock हटा देता है।",
