...
export const hi = {
  ...
  systemPill: {
    ask: {
      placeholder: "Unsloth स पछ...",
      hint: "पछन क लए Return दबए",
      loading: "{model} लड ह रह ह...",
      thinking: "सच रह ह...",
      copy: "कप कर",
      copied: "कप कय गय",
      noModel: "कई मडल उपलब नह ह। सटग म डफल मडल चन।",
      failed: "कछ गडबड ह गई। क बकएड चल रह ह?",
      autoModel: "सकय मडल",
      enterHint: "पछ",
      escHint: "बद कर",
      context: "चयनत टक ({chars} अकर)",
      followUp: "आग पछ...",
      clear: "सफ कर",
    },
    settings: {
      tab: "अससट",
      title: "अससट",
      description: "इस Mac क कस भ ऐप म चयनत टक पर अपन लकल मडल इसमल कर।",
      enable: "आस बर चल कर",
      enableDescription: "कस भ ऐप म {hotkey} दबए।",
      setUp: "सट अप कर...",
      permission: "एकसबलट एकस",
      permissionGranted: "द गई",
      permissionMissing: "नह द गई",
      permissionRequest: "अनरध कर",
      hotkey: "शरकट",
      defaultModel: "डफल मडल",
      defaultModelDescription:
        "आस बर म जवब दत ह। पहल स लड मडल इसमल करन क लए इस खल छड।",
      addAction: "कय जड",
      editAction: "एडट कर",
      deleteAction: "हटए",
      actionName: "नम",
      actionPrompt: "पम",
      actionPromptHint: "इसम {selection} हन चहए।",
      actionSystemPrompt: "ससम पम (वकलक)",
      actionModel: "मडल",
      actionModelDefault: "लड कय गय मडल इसमल कर",
      actionOutputMode: "परणम",
      outputModeReplace: "चयन बदल",
      outputModeShow: "परणम दखए",
      actionEnabled: "चल",
      saveError: "सव नह ह सक। कपय फर कशश कर।",
    },
  },
