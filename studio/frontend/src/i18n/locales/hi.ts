  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"सेटिंग द्वारा प्रबंधित",
        ...
        stableTitle:"स्थिर होस्टनाम",
        stableDescription:"स्थायी URL और API स्ट्रीमिंग के लिए कस्टम Cloudflare टनल बनाएँ।",
        hostnameLabel:"पूरा होस्टनाम",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"सेट अप करें",
        settingUp:"सेट अप हो रहा है...",
        provisionProgress:"ब्राउज़र में Cloudflare को अनुमति दें। Unsloth टनल और DNS रिकॉर्ड बनाना पूरा करेगा।",
        teardownProgress:"टनल हटाने के लिए Cloudflare को अनुमति दें। DNS रिकॉर्ड आपको हटाने के लिए बना रहेगा।",
        openCloudflare:"Cloudflare खोलें",
        connectorReady:"कनेक्टर पंजीकृत",
        tunnelReady:"टनल सेवा दे रही है",
        dnsReady:"DNS हल हुआ",
        dnsPending:"अभी पहुँच योग्य नहीं",
        dnsUnknown:"जाँच नहीं हो सकी",
        dnsLinkWaiting:"DNS समाधान की पुष्टि के बाद रिमोट लिंक दिखाई देगा।",
        ready:"तैयार",
        waiting:"प्रतीक्षा",
        removeAction:"कस्टम टनल हटाएँ",
        removeTitle:"यह कस्टम टनल हटाएँ?",
        removeDescription:"डिस्कनेक्ट करने के बाद टनल पहचान हटेगी। Cloudflare DNS रिकॉर्ड नहीं हटा सकता; इस होस्टनाम को दोबारा उपयोग करने से पहले डैशबोर्ड में रिकॉर्ड हटाएँ।",
        removeConfirm:"टनल हटाएँ",
        ...
        orphanedRecords:"Cloudflare में बचे DNS रिकॉर्ड: {hostnames}। दोबारा उपयोग से पहले उन्हें Cloudflare डैशबोर्ड में हटाएँ।",
        requestFailed:"रिमोट ऐक्सेस अनुरोध विफल हुआ।",
        runtimeFailed:"रिमोट टनल विफल रही। फिर कोशिश करें या सर्वर लॉग देखें।",
        ...
        autoStartCustom:"Unsloth शुरू होने पर इस स्थिर होस्टनाम से कनेक्ट करें। अभी डिस्कनेक्ट करने से यह सेटिंग बंद नहीं होगी।",
        autoStartCustomMissing:"कस्टम टनल को अपने आप शुरू करने के लिए कॉन्फ़िगर की गई टनल चाहिए।",
        ...
        errorTeardownFailed:"Cloudflare कस्टम टनल को हटाना पूरा नहीं कर सका। फिर कोशिश करें।",
        errorTeardownManual:"स्थानीय टनल सेटिंग हटा दी गईं, लेकिन Cloudflare की सफ़ाई पूरी नहीं हुई। Cloudflare डैशबोर्ड में टनल और DNS रिकॉर्ड जाँचें।",
