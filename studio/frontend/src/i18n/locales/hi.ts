  ...
  settings: {
    ...
    chat: {
      ...
      compactionDescriptionInherit:
        "सर्वर पर सेट की गई नीति से कॉम्पैक्ट करें, जो डिफ़ॉल्ट रूप से «बातचीत रीसेट करें» है।",
      compactionDescriptionCheckpoint:
        "सबसे हाल का संवाद और जितने स्थायी निर्देश समा सकें उन्हें रखते हुए कॉम्पैक्ट करें, और बाकी को खोज के लिए आर्काइव करें।",
      compactionDescriptionRolling:
        "पुराने संवाद आर्काइव करके कॉम्पैक्ट करें, और हाल का इतिहास तथा चुनी गई अतिरिक्त खाली जगह बनाए रखें।",
      ...
      compactionStyleDescription:
        "जब कोई चैट अपना संदर्भ भर देती है तो उसे कैसे कॉम्पैक्ट किया जाए। सर्वर डिफ़ॉल्ट सर्वर पर UNSLOTH_CONTEXT_POLICY का पालन करता है, जो checkpoint के रूप में आता है और बदले जाने तक «बातचीत रीसेट करें» जैसा ही काम करता है। बातचीत रीसेट करने पर नवीनतम टर्न और जितने स्थायी निर्देश समा सकें, वे रहते हैं। सबसे पुराने टर्न आर्काइव करने पर सबसे पुराने हट जाते हैं और हाल का अधिक इतिहास रखा जा सकता है।",
