...
export const hi = {
  ...
  settings: {
    ...
    resources: {
      ...
      llamaBackend: {
        exactConcurrency: {
          label: "सटीक समवर्तीता",
          description: "कई चैट एक साथ चलने पर थ्रूपुट घटाती है, और अगली बार मॉडल लोड होने पर लागू होती है।",
          hint: "llama-server से ऐसी डिकोडिंग माँगें जिसका परिणाम KV कैश साझा करने वाली दूसरी चैट पर निर्भर न हो: एक चैट अकेले और तीन पड़ोसियों के साथ वही टोकन बनाती है। स्वतः माँगता है और सर्वर के मना करने पर उसके बिना चलता रहता है; चालू माँगता है और मना होने पर लोड विफल कर देता है; बंद कभी नहीं माँगता।",
          auto: "स्वतः",
          off: "बंद",
          on: "चालू",
