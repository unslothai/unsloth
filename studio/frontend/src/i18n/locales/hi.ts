...
export const hi = {
  ...
  notebooks: {
    routeTitle: "नोटबुक",
    title: "Unsloth नोटबुक",
    subtitle:
      "unslothai/notebooks की आधिकारिक फाइन-ट्यूनिंग रेसिपी। Colab में खोलें या Fine-tuning Studio पहले से भरें।",
    searchPlaceholder: "नोटबुक खोजें…",
    pickerPlaceholder: "नोटबुक खोजें और चुनें…",
    pickerEmpty: "आपकी खोज से कोई नोटबुक मेल नहीं खाती।",
    pickedSection: "चयनित नोटबुक",
    resultsCount: "{count} नोटबुक",
    allCategories: "सभी",
    featured: "विशेष",
    featuredSection: "विशेष नोटबुक",
    allSection: "सभी नोटबुक",
    loading: "नोटबुक लोड हो रही हैं…",
    loadFailed: "नोटबुक लोड नहीं हो सकीं",
    emptyTitle: "कोई नोटबुक नहीं मिली",
    emptyDescription: "कोई दूसरी खोज या श्रेणी फ़िल्टर आज़माएँ।",
    useInStudio: "Studio में इस्तेमाल करें",
    openInColab: "Colab में खोलें",
    viewOnGitHub: "GitHub",
    studioModelReady: "Studio पहले से भरेगा: {model}",
    studioManualConfigure:
      "Fine-tuning Studio खुलेगा — इस नोटबुक से मेल खाने वाला मॉडल चुनें।",
    studioOpenedWithoutModel:
      "Fine-tuning Studio खुल गया। इस नोटबुक से मेल खाने वाला मॉडल चुनें।",
    studioDisabled: {
      mlxUnavailable:
        "ट्रेनिंग के लिए MLX चाहिए। Studio में इस्तेमाल करें चालू करने के लिए `unsloth studio update` चलाएँ।",
      intelMac:
        "ट्रेनिंग के लिए Apple Silicon या GPU चाहिए। Intel Mac पर केवल चैट उपलब्ध है।",
      noGpu: "ट्रेनिंग के लिए NVIDIA या AMD GPU चाहिए।",
      generic: "इस डिवाइस पर ट्रेनिंग उपलब्ध नहीं है।",
    },
    categories: {
      sft: "फाइन-ट्यूनिंग",
      vision: "विज़न",
