...
export const hi = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "पूर्वनिर्धारित रिवॉर्ड फ़ंक्शनों से रीइन्फ़ोर्समेंट लर्निंग।",
        note: "RL",
      },
    },
    grpo: {
      settings: "GRPO सेटिंग्स",
      rewardFunctions: "रिवॉर्ड फ़ंक्शन",
      rewardFunctionsLoading: "रिवॉर्ड फ़ंक्शन लोड हो रहे हैं...",
      expectedColumns: "डेटासेट कॉलम चाहिए: {columns}",
      weight: "भार",
      numGenerations: "प्रति प्रॉम्प्ट जनरेशन",
      numGenerationsTooltip: "हर प्रॉम्प्ट के लिए कितने उत्तर बनाकर आँके जाएँ। यह बैच साइज़ x ग्रेडिएंट संचय को विभाजित करना चाहिए।",
      maxPromptLength: "अधिकतम प्रॉम्प्ट लंबाई",
      maxPromptLengthTooltip: "जनरेशन से पहले रखे जाने वाले प्रॉम्प्ट टोकन। इससे लंबे प्रॉम्प्ट काट दिए जाते हैं।",
      maxCompletionLength: "अधिकतम पूर्णता लंबाई",
      maxCompletionLengthTooltip: "प्रति रोलआउट अधिकतम जनरेट किए गए टोकन। प्रॉम्प्ट और पूर्णता मिलकर कॉन्टेक्स्ट लंबाई में आने चाहिए।",
      temperature: "सैंपलिंग तापमान",
      temperatureTooltip: "अधिक मान रोलआउट को अधिक विविध बनाते हैं, जिसकी GRPO को अच्छे और बुरे उत्तर पहचानने के लिए ज़रूरत होती है।",
      topP: "Top-p",
      topPTooltip: "रोलआउट के लिए न्यूक्लियस सैंपलिंग सीमा।",
      beta: "KL गुणांक (beta)",
      betaTooltip: "संदर्भ मॉडल पॉलिसी को कितना पीछे खींचता है। 0 करने पर KL पद पूरी तरह हट जाता है।",
      generationBackend: "रोलआउट बैकएंड",
