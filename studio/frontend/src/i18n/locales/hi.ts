...
export const hi = {
  ...
  systemPill: {
    ask: {
      ...
      hint: "पूछने के लिए Return दबाएँ",
      ...
      enterHint: "पूछें",
      escHint: "बंद करें",
      context: "चयनित टेक्स्ट ({chars} अक्षर)",
      followUp: "आगे पूछें...",
      clear: "साफ़ करें",
    },
    settings: {
      ...
      setUp: "सेट अप करें...",
      permission: "एक्सेसिबिलिटी एक्सेस",
      permissionGranted: "दी गई",
      permissionMissing: "नहीं दी गई",
      permissionRequest: "अनुरोध करें",
      hotkey: "शॉर्टकट",
      ...
      deleteAction: "हटाएँ",
      actionName: "नाम",
      actionPrompt: "प्रॉम्प्ट",
      actionPromptHint: "इसमें {selection} होना चाहिए।",
      actionSystemPrompt: "सिस्टम प्रॉम्प्ट (वैकल्पिक)",
      actionModel: "मॉडल",
      actionModelDefault: "लोड किया गया मॉडल इस्तेमाल करें",
      actionOutputMode: "परिणाम",
      outputModeReplace: "चयन बदलें",
      outputModeShow: "परिणाम दिखाएँ",
      actionEnabled: "चालू",
