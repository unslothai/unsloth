  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        description:
          "Cloudflare के ज़रिए दूसरे डिवाइस से Unsloth और उसके API इस्तेमाल करें।",
        ...
        urlHint:
          "यह URL और रिमोट पासवर्ड रखने वाला कोई भी व्यक्ति साइन इन कर सकता है।",
        ...
        passwordDescription:
          "रिमोट ब्राउज़र unsloth के रूप में साइन इन करते हैं। डेस्कटॉप ऐप स्वतः साइन इन रहता है।",
        customHostnameTitle: "कस्टम होस्टनाम",
        customHostnameDescription:
          "एक ही पता बनाए रखने के लिए अपना होस्टनाम इस्तेमाल करें।",
        ...
        setupConfirmDescription:
          "नीचे दिया होस्टनाम जाँचें। इसके बाद Cloudflare इस टनल को अधिकृत करने को कहेगा: वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है, और Authorize पर क्लिक करें।",
        setupPreparing:
          "Cloudflare खोला जा रहा है ताकि आप इस टनल को अधिकृत कर सकें…",
        setupAuthorize:
          "Cloudflare में आपके अधिकृत करने की प्रतीक्षा है। वह डोमेन चुनें जिससे {hostname} संबंधित है, फिर Authorize पर क्लिक करें।",
        ...
        removeDescription:
          "यह केवल वही हटाता है जो Unsloth ने सहेजा था। टनल और उसका DNS रिकॉर्ड Cloudflare में तब तक रहेंगे जब तक आप उन्हें वहाँ न हटाएँ।",
        ...
        removeLocally:
          "इस कनेक्टेड टनल को हटाने के लिए Unsloth चलाने वाली मशीन पर सेटिंग खोलें।",
        dnsConflict:
          "{hostname} Cloudflare में पहले से कहीं और इंगित करता है। उस DNS रिकॉर्ड को हटाएँ, या कोई दूसरा होस्टनाम सेट करें।",
        requestFailed: "रिमोट ऐक्सेस अनुरोध विफल हुआ।",
        runtimeFailed:
          "रिमोट एक्सेस अचानक बंद हो गया। फिर कोशिश करें या सर्वर लॉग देखें।",
        startAction: "शुरू करें",
        stopAction: "रोकें",
        autoStartLabel: "अपने आप शुरू करें",
        autoStartTemporary:
          "Unsloth शुरू होने पर नया अस्थायी URL बनाएँ। अभी डिस्कनेक्ट करने से यह सेटिंग बंद नहीं होगी।",
        autoStartCustom:
          "Unsloth शुरू होने पर इस कस्टम होस्टनाम से कनेक्ट करें। अभी डिस्कनेक्ट करने से यह सेटिंग बंद नहीं होगी।",
        autoStartCustomMissing:
          "जब तक आप नीचे कस्टम होस्टनाम सेट अप नहीं करते, यह कुछ भी कनेक्ट नहीं करेगा।",
        blockServerStarting: "सर्वर के शुरू होते ही रिमोट एक्सेस उपलब्ध होगा।",
        blockCustomNotConfigured:
          "रिमोट एक्सेस शुरू करने से पहले नीचे कस्टम होस्टनाम सेट अप करें।",
        ...
        blockExplicitlyDisabled:
          "इस सर्वर के शुरू होने पर रिमोट ऐक्सेस बंद किया गया था।",
        ...
        dnsConflictUnknown:
          "यह होस्टनाम Cloudflare में पहले से कहीं और इंगित करता है। उस DNS रिकॉर्ड को हटाएँ, या कोई दूसरा होस्टनाम सेट करें।",
        errorInvalidHostname:
          "यह पूरा होस्टनाम नहीं है। unsloth.example.com जैसा कोई नाम दर्ज करें।",
        errorWrongDomain:
          "आपने Cloudflare में जो डोमेन अधिकृत किया, वह {hostname} को कवर नहीं करता। दोबारा सेट अप करें और वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है।",
        errorHostnameUnreachable:
          "टनल जुड़ गया, पर {hostname} नहीं खुला। इस कस्टम टनल को हटाएँ, दोबारा सेट अप करें, और वह डोमेन चुनें जिससे यह होस्टनाम संबंधित है।",
        errorCertificateExists:
          "{path} पर Cloudflare प्रमाणपत्र पहले से मौजूद है, और Unsloth उसे अधिलेखित नहीं करेगा। उस फ़ाइल को हटाएँ या कहीं और ले जाएँ, फिर दोबारा सेट अप करें।",
        errorBusy:
          "रिमोट एक्सेस का एक और बदलाव अभी चल रहा है। उसके पूरा होने की प्रतीक्षा करें, फिर पुनः प्रयास करें।",
        errorIdentityExists:
          "कस्टम टनल पहले से सेट अप है। कोई दूसरा होस्टनाम सेट करने से पहले उसे हटाएँ।",
        errorUnavailable:
          "Cloudflare तक नहीं पहुँचा जा सका। इस मशीन का इंटरनेट कनेक्शन जाँचें, फिर पुनः प्रयास करें।",
        errorCancelled: "सेटअप रद्द कर दिया गया। तैयार होने पर दोबारा सेट अप करें।",
        errorLoginTimeout:
          "Cloudflare समय पर अधिकृत नहीं हुआ। दोबारा सेट अप करें, और Cloudflare पेज खुलने पर Authorize पर क्लिक करें।",
        errorLoginFailed:
          "Cloudflare ने अधिकृतीकरण पूरा नहीं किया। दोबारा सेट अप करें।",
        errorSetupFailed:
          "कस्टम टनल पूरा नहीं हो सका। दोबारा सेट अप करें, या सर्वर लॉग देखें।",
        errorTeardownFailed:
          "सहेजा गया कस्टम टनल हटाया नहीं जा सका। पुनः प्रयास करें, या सर्वर लॉग देखें।",
        errorTeardownManual: "कस्टम टनल Unsloth से हटा दिया गया।",
        errorUnknown:
          "कस्टम टनल का बदलाव पूरा नहीं हुआ। पुनः प्रयास करें, या सर्वर लॉग देखें।",
      },
      notifications: {
