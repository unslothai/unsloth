  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "सिस्टम RAM में वेट्स की पूरी प्रति आरक्षित नहीं करता। llama.cpp की मेमोरी-मैप्ड लोडिंग बनाए रखता है और --no-mmap तथा --mlock हटा देता है। मैपिंग स्वयं बनी रहती है, इसलिए लोडर जिन पेजों को छूता है वे तब तक इस प्रोसेस के खाते में दिखते हैं जब तक OS उन्हें वापस नहीं ले लेता।",
        ...
        mlockUngoverned: "लोड किया गया मॉडल ऐसे रनर का उपयोग करता है जिसे मॉडल मेमोरी नियंत्रित नहीं करती, इसलिए यह सेटिंग मौजूदा लॉन्च को प्रभावित नहीं कर सकती। सेटिंग सहेजी रहेगी और अगली बार लोड किए गए llama.cpp मॉडल पर लागू होगी।",
