  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        keepResidentHint: "जब तक मॉडल लोड रहता है, वेट्स सिस्टम RAM को वापस नहीं दिए जाते। निष्क्रिय होने पर स्वतः अनलोड बंद कर देता है और --mlock भेजता है, ताकि OS मॉडल को पेज आउट करके आपके अगले प्रॉम्प्ट पर दोबारा अपलोड न करे।",
