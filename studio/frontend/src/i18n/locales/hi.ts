...
export const hi = {
  ...
  promptQueue: {
    ...
    queueingOffHint: "उत्तर के दौरान भेजे गए नए संदेश उस उत्तर को रोककर अगले चलेंगे।",
    queueingOnHint: "उत्तर के दौरान भेजे गए नए संदेश कतार में रहेंगे और क्रम से चलेंगे।",
    queueingHintShared: "कतार में मौजूद संदेश बने रहते हैं; इससे कतार रुकती या फिर से शुरू नहीं होती।",
  },
  picker: {
    onDevice: "डिवाइस पर",
