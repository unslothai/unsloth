...
export const hi = {
  ...
  settings: {
    ...
    debugging: {
      ...
      actions: "सभी लॉग",
      exportLogs: "सभी लॉग निर्यात करें (.zip)",
      exportingLogs: "निर्यात हो रहा है...",
      exportError: "लॉग निर्यात नहीं किए जा सके",
      exportPrivacyNote: "निर्यात की गई ZIP फ़ाइलों में क्रेडेंशियल छिपाए जाते हैं।",
      openFolder: "लॉग फ़ोल्डर खोलें",
      openingFolder: "खुल रहा है...",
      openFolderError: "लॉग फ़ोल्डर नहीं खोला जा सका",
