  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "किसी भी टेक्स्ट पर हाँ/नहीं, विकल्प और स्कोर वाले सवाल पूछें और लोकल Laya मॉडल से कैलिब्रेटेड संभावनाएँ पाएँ। यह Jev API के अनुकूल है, इसलिए TypeSafe का SDK बिना बदलाव के काम करता है।",
        enable: "अनुरोधों का जवाब दें",
        enableDescription: "POST /v1/systemone का जवाब देता है। चालू करने पर मॉडल डाउनलोड होता है; पहले अनुरोध पर यह मेमोरी में लोड होता है।",
        lockedByEnv: "{name} द्वारा सेट।",
        model: "मॉडल",
        modelDescription: "बहुभाषी 100 से ज़्यादा भाषाओं को कवर करता है। अंग्रेज़ी बड़ा है और सिर्फ़ अंग्रेज़ी के लिए है।",
        ...
        tryIt: "आज़माएँ",
        caveat: "बेस मॉडल सामान्य उपयोग के लिए हैं। भरोसा करने से पहले अपने डेटा पर जवाब जाँच लें।",
      },
      usageNoModel:
