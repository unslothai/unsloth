  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Poni domande sì/no, a scelta e a punteggio su qualsiasi testo e ricevi probabilità calibrate da un modello Laya locale. Parla l'API Jev, quindi l'SDK di TypeSafe funziona senza modifiche.",
        enable: "Rispondi alle richieste",
        enableDescription: "Risponde a POST /v1/systemone. Attivandolo si scarica il modello; viene caricato in memoria alla prima richiesta.",
        lockedByEnv: "Impostato da {name}.",
        model: "Modello",
        modelDescription: "Multilingue copre oltre 100 lingue. Inglese è più grande e solo per l'inglese.",
        ...
        tryIt: "Provalo",
        caveat: "I modelli base sono generici. Verifica le risposte sui tuoi dati prima di farvi affidamento.",
      },
    },
    about: {
      title: "Informazioni",
