...
export const it = {
  ...
  settings: {
    ...
    debugging: {
      ...
      exportPrivacyNote: "Le credenziali vengono mascherate nei file ZIP esportati.",
      openFolder: "Apri la cartella dei log",
      openingFolder: "Apertura...",
      openFolderError: "Impossibile aprire la cartella dei log",
