...
export const it = {
  ...
  settings: {
    ...
    library: {
      ...
      locationsDescription: "Dove Studio conserva ogni tipo di file. Le cartelle della libreria sono etichette dentro Studio, non cartelle sul disco.",
