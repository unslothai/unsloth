...
export const it = {
  ...
  skills: {
    ...
    delete: "Elimina {name}",
    createDescription: "Salvata come SKILL.md in una nuova cartella in ~/.agents/skills e attivata appena esiste.",
    nameLabel: "Nome",
    namePlaceholder: "es. code-arithmetic",
    nameHint: "Minuscole, numeri e trattini singoli. È anche il nome della cartella.",
    nameInvalid: "Usa da 1 a 64 minuscole, numeri o trattini singoli, senza trattino iniziale o finale.",
    descriptionLabel: "Descrizione",
    descriptionPlaceholder: "Usare quando l'utente chiede calcoli aritmetici. Calcolarli sempre con lo strumento di codice.",
    descriptionHint: "La riga che il modello vede nel suo catalogo di competenze. Da questa decide quando leggere la competenza.",
    instructionsLabel: "Istruzioni",
    instructionsPlaceholder: "Cosa fare quando questa competenza si applica, in Markdown.",
    instructionsHint: "Il corpo di SKILL.md, letto per intero quando il modello sceglie la competenza.",
    create: "Crea competenza",
    save: "Salva modifiche",
    created: "{name} creata",
    saved: "{name} salvata",
    deleted: "{name} eliminata",
    saveError: "Impossibile salvare la competenza",
    openError: "Impossibile aprire la competenza",
    deleteError: "Impossibile eliminare la competenza",
    deleteTitle: "Elimina competenza",
    deleteDescription: "Eliminare \"{name}\" e tutto il contenuto della sua cartella in ~/.agents/skills? L'operazione non può essere annullata.",
    search: "Cerca competenze per nome o descrizione…",
    noMatch: "Nessuna competenza corrisponde a “{query}”",
    clearSearch: "Cancella ricerca",
    count: "{shown} di {total} competenze",
    readOnlyClaude: "Sola lettura: si trova in ~/.claude/skills. Modifica il file lì.",
    readOnlyBundled: "Sola lettura: inclusa in Unsloth Studio.",
    ...
    fromAgents: "Una competenza in ~/.agents/skills. Le modifiche qui vengono scritte direttamente nel suo SKILL.md.",
    fromClaude: "Una competenza in ~/.claude/skills.",
    fromBundled: "Inclusa in Unsloth Studio.",
    detailsTitle: "Dettagli",
    detailsDescription: "Gli altri campi del frontmatter di SKILL.md. Modifica il file per cambiarli.",
    detailsEmpty: "Nessun altro campo.",
    licenseLabel: "Licenza",
    compatibilityLabel: "Compatibilità",
    allowedToolsLabel: "Strumenti consentiti",
    deleteLabel: "Elimina competenza",
    deleteRowDescription: "Rimuove la cartella in ~/.agents/skills e tutto il suo contenuto.",
    summary: "{enabled} di {total} attive",
    enabledOnly: "Solo attive",
    sectionAgents: "Le tue competenze",
    sectionAgentsHint: "Salvate in ~/.agents/skills. Creale, modificale ed eliminale qui.",
    ...
    sectionBundledHint: "Fornite con Unsloth Studio. Sola lettura.",
    newSkillHint: "Scrivine una qui. Finisce in ~/.agents/skills.",
    edit: "Modifica",
    view: "Visualizza",
    linked: "Collegamento",
    emptyTitle: "Ancora nessuna competenza",
    previewTitle: "Cosa vede il modello",
    previewHint: "La sua riga di catalogo. Da questa il modello decide se aprire la competenza e leggere le istruzioni.",
    previewName: "skill-name",
    mention: "Menzionala in chat",
    copyMention: "Copia @{name}",
    sourceLabel: "Origine",
