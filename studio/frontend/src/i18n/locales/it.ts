...
export const it = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Schede Immagini, Video e Audio",
      mediaTabsDescription: "Mostra queste schede solo quando contengono file, oppure sempre.",
      mediaTabsAuto: "Quando contengono file",
      mediaTabsAlways: "Sempre",
      ...
      showFineTunes: "Fine-tune",
      showFineTunesDescription: "Modelli che hai addestrato o esportato in Studio.",
