  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        description:
          "Usa Unsloth e le sue API da altri dispositivi tramite Cloudflare.",
        progressConnecting: "Connessione",
        progressOpeningLink: "Apertura del link sicuro",
        progressCheckingHostname: "Verifica del nome host",
        progressDisconnecting: "Disconnessione",
        stateOff: "Disattivato",
        stateStarting: "Avvio",
        stateOnline: "Online",
        stateStopping: "Arresto",
        stateError: "Errore",
        stateUnavailable: "Non disponibile",
        ownerLaunch: "Gestito all’avvio",
        ownerColab: "Gestito da Colab",
        copied: "Copiato",
        copyUrl: "Copia URL",
        qrTitle: "Apri sul telefono",
        qrDescription:
          "Scansiona per aprire l'URL remoto nel browser del telefono.",
        remoteUrl: "URL remoto",
        remoteUrlReady: "Il link remoto è pronto.",
        urlHint: "Chiunque abbia questo URL e la password remota può accedere.",
        streamingSupported: "Questo tunnel supporta le risposte in streaming.",
        streamingBuffered:
          "I tunnel temporanei memorizzano le risposte in streaming fino al completamento.",
        passwordLabel: "Password remota",
        passwordDescription:
          "I browser remoti accedono come unsloth. L'app desktop continua ad accedere automaticamente.",
        customHostnameTitle: "Nome host personalizzato",
        customHostnameDescription:
          "Usa il tuo nome host per mantenere lo stesso indirizzo.",
        hostnameLabel: "Nome host completo",
        hostnamePlaceholder: "unsloth.example.com",
        setupAction: "Configura",
        setupConfirmTitle: "Configurare questo nome host?",
        setupConfirmAction: "Conferma",
        setupConfirmDescription:
          "Controlla il nome host qui sotto. Cloudflare ti chiederà poi di autorizzare questo tunnel: scegli il dominio a cui appartiene questo nome host e fai clic su Authorize.",
        setupPreparing:
          "Apertura di Cloudflare per consentirti di autorizzare questo tunnel…",
        setupAuthorize:
          "In attesa della tua autorizzazione su Cloudflare. Scegli il dominio a cui appartiene {hostname}, poi fai clic su Authorize.",
        removeProgress: "Rimozione della connessione salvata da Unsloth...",
        openCloudflare: "Apri Cloudflare",
        removeAction: "Rimuovi",
        removeTitle: "Rimuovere questo tunnel personalizzato da Unsloth?",
        removeDescription:
          "Questo rimuove solo ciò che Unsloth ha salvato. Il tunnel e il suo record DNS restano su Cloudflare finché non li elimini lì.",
        removeTunnelHint: "In Cloudflare, elimina questo tunnel:",
        tunnelNameUnavailable: "Nome tunnel non disponibile",
        openCloudflareTunnels: "Apri i tunnel Cloudflare",
        removeDnsHint: "Poi elimina questo record DNS:",
        openCloudflareDns: "Apri i record DNS",
        removeConfirm: "Rimuovi da Unsloth",
        removeLocally:
          "Apri le impostazioni sul computer che esegue Unsloth per rimuovere questo tunnel connesso.",
        dnsConflict:
          "{hostname} punta già altrove su Cloudflare. Elimina quel record DNS oppure configura un nome host diverso.",
        requestFailed: "Richiesta di accesso remoto non riuscita.",
        runtimeFailed:
          "L’accesso remoto si è interrotto in modo imprevisto. Riprova o controlla i log del server.",
        startAction: "Avvia",
        stopAction: "Interrompi",
        autoStartLabel: "Avvia automaticamente",
        autoStartTemporary:
          "Crea un nuovo URL temporaneo all'avvio di Unsloth. Disconnettersi ora non disattiva l'opzione.",
        autoStartCustom:
          "Connette questo nome host personalizzato all'avvio di Unsloth. Disconnettersi ora non disattiva l'opzione.",
        autoStartCustomMissing:
          "Non verrà connesso nulla finché non configuri un nome host personalizzato qui sotto.",
        blockServerStarting:
          "L'accesso remoto sarà disponibile al termine dell'avvio del server.",
        blockCustomNotConfigured:
          "Configura qui sotto un nome host personalizzato prima di avviare l'accesso remoto.",
        blockPasswordDesktop:
          "Imposta qui sotto una password remota prima di avviare l'accesso remoto.",
        blockPasswordWeb:
          "Chiedi all'amministratore dell'host di impostare una password remota.",
        blockExplicitlyDisabled:
          "L'accesso remoto è stato disabilitato all'avvio di questo server.",
        blockLaunchManaged:
          "Questo tunnel è gestito dal comando di avvio del server.",
        blockColabManaged: "Questo tunnel è gestito dalla sessione Colab.",
        blockColab: "Le impostazioni di accesso remoto sono gestite da Colab.",
        dnsConflictUnknown:
          "Questo nome host punta già altrove su Cloudflare. Elimina quel record DNS oppure configura un nome host diverso.",
        errorInvalidHostname:
          "Non è un nome host completo. Inseriscine uno come unsloth.example.com.",
        errorWrongDomain:
          "Il dominio autorizzato su Cloudflare non copre {hostname}. Ripeti la configurazione e scegli il dominio a cui appartiene questo nome host.",
        errorHostnameUnreachable:
          "Il tunnel si è connesso, ma {hostname} non si è aperto. Rimuovi questo tunnel personalizzato, riconfiguralo e scegli il dominio a cui appartiene questo nome host.",
        errorCertificateExists:
          "In {path} esiste già un certificato Cloudflare e Unsloth non lo sovrascriverà. Sposta o elimina quel file, poi riconfigura.",
        errorBusy:
          "È ancora in corso un'altra modifica dell'accesso remoto. Attendi che termini e riprova.",
        errorIdentityExists:
          "Un tunnel personalizzato è già configurato. Rimuovilo prima di configurare un altro nome host.",
        errorUnavailable:
          "Impossibile raggiungere Cloudflare. Controlla la connessione internet di questo computer e riprova.",
        errorCancelled:
          "La configurazione è stata annullata. Riprova quando vuoi.",
        errorLoginTimeout:
          "Cloudflare non è stato autorizzato in tempo. Riconfigura e fai clic su Authorize quando si apre la pagina di Cloudflare.",
        errorLoginFailed:
          "Cloudflare non ha completato l'autorizzazione. Riconfigura.",
        errorSetupFailed:
          "Non è stato possibile completare il tunnel personalizzato. Riconfigura o controlla i log del server.",
        errorTeardownFailed:
          "Non è stato possibile rimuovere il tunnel personalizzato salvato. Riprova o controlla i log del server.",
        errorTeardownManual:
          "Il tunnel personalizzato è stato rimosso da Unsloth.",
        errorUnknown:
          "La modifica del tunnel personalizzato non è stata completata. Riprova o controlla i log del server.",
      },
      notifications: {
