...
export const it = {
  ...
  notebooks: {
    routeTitle: "Notebook",
    title: "Notebook Unsloth",
    subtitle:
      "Ricette ufficiali di fine-tuning da unslothai/notebooks. Aprili in Colab o precompila Fine-tuning Studio.",
    searchPlaceholder: "Cerca notebook…",
    pickerPlaceholder: "Cerca e scegli un notebook…",
    pickerEmpty: "Nessun notebook corrisponde alla ricerca.",
    pickedSection: "Notebook selezionato",
    resultsCount: "{count} notebook",
    allCategories: "Tutti",
    featured: "In evidenza",
    featuredSection: "Notebook in evidenza",
    allSection: "Tutti i notebook",
    loading: "Caricamento dei notebook…",
    loadFailed: "Impossibile caricare i notebook",
    emptyTitle: "Nessun notebook trovato",
    emptyDescription: "Prova un'altra ricerca o un altro filtro di categoria.",
    useInStudio: "Usa in Studio",
    openInColab: "Apri in Colab",
    viewOnGitHub: "GitHub",
    studioModelReady: "Precompila Studio: {model}",
    studioManualConfigure:
      "Apre Fine-tuning Studio — scegli un modello corrispondente a questo notebook.",
    studioOpenedWithoutModel:
      "Fine-tuning Studio è stato aperto. Seleziona un modello corrispondente a questo notebook.",
    studioDisabled: {
      mlxUnavailable:
        "L'addestramento richiede MLX. Esegui `unsloth studio update` per abilitare Usa in Studio.",
      intelMac:
        "L'addestramento richiede Apple Silicon o una GPU. I Mac Intel supportano solo la chat.",
      noGpu: "L'addestramento richiede una GPU NVIDIA o AMD.",
      generic: "L'addestramento non è disponibile su questo dispositivo.",
    },
    categories: {
      sft: "Fine-tuning",
      vision: "Visione",
