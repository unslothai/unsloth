  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerSettings:"Gestito dalle impostazioni",
        ...
        stableTitle:"Nome host stabile",
        stableDescription:"Crea un tunnel Cloudflare personalizzato per un URL permanente e lo streaming API.",
        hostnameLabel:"Nome host completo",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"Configura",
        settingUp:"Configurazione...",
        provisionProgress:"Autorizza Cloudflare nel browser. Unsloth completerà la creazione del tunnel e del record DNS.",
        teardownProgress:"Autorizza Cloudflare a rimuovere il tunnel. Il record DNS resterà da eliminare manualmente.",
        openCloudflare:"Apri Cloudflare",
        connectorReady:"Connettore registrato",
        tunnelReady:"Tunnel attivo",
        dnsReady:"DNS risolto",
        dnsPending:"Non ancora raggiungibile",
        dnsUnknown:"Verifica non disponibile",
        dnsLinkWaiting:"Il collegamento remoto apparirà dopo la conferma della risoluzione DNS.",
        ready:"Pronto",
        waiting:"In attesa",
        removeAction:"Rimuovi tunnel personalizzato",
        removeTitle:"Rimuovere questo tunnel personalizzato?",
        removeDescription:"L'identità del tunnel viene eliminata dopo la disconnessione. Cloudflare non può eliminare il record DNS; rimuovilo dal pannello prima di riusare questo nome.",
        removeConfirm:"Rimuovi tunnel",
        removeLocally:"Apri le impostazioni sul computer che esegue Unsloth per rimuovere questo tunnel connesso.",
        dnsConflict:"Il record {hostname} esiste già. Rimuovilo in Cloudflare o scegli un altro nome host.",
        orphanedRecords:"Record DNS rimasti in Cloudflare: {hostnames}. Eliminali dal pannello prima di riutilizzarli.",
        requestFailed:"Richiesta di accesso remoto non riuscita.",
        runtimeFailed:"Il tunnel remoto non ha funzionato. Riprova o controlla i log del server.",
        temporaryAction:"Avvia tunnel temporaneo",
        connectAction:"Connetti",
        stopAction:"Disconnetti",
        ...
        autoStartCustom:"Connette questo nome host stabile all'avvio di Unsloth. Disconnettersi ora non disattiva l'opzione.",
        autoStartCustomMissing:"L'avvio automatico del tunnel personalizzato richiede un tunnel configurato.",
        blockServerStarting:"L'accesso remoto sarà disponibile al termine dell'avvio del server.",
        blockPasswordDesktop:"Imposta una password remota prima di avviare l'accesso remoto.",
        ...
        dnsConflictUnknown:"Un record DNS esistente blocca questo nome host. Rimuovilo in Cloudflare oppure scegli un altro nome.",
        errorInvalidHostname:"Inserisci un nome host completo, ad esempio studio.example.com.",
        errorCertificateExists:"Studio non sovrascriverà il certificato Cloudflare esistente in {path}. Spostalo e riprova.",
        errorBusy:"È già in corso un'altra operazione di accesso remoto. Attendi che termini e riprova.",
        errorIdentityExists:"È già configurato un tunnel personalizzato. Rimuovilo prima di configurare un altro nome host.",
        errorUnavailable:"Cloudflare non è raggiungibile. Controlla la connessione e riprova.",
        errorCancelled:"L'autorizzazione Cloudflare è stata annullata.",
        errorLoginTimeout:"L'autorizzazione Cloudflare è scaduta. Avvia di nuovo la configurazione.",
        errorLoginFailed:"L'autorizzazione Cloudflare non è riuscita. Avvia di nuovo la configurazione.",
        errorSetupFailed:"Cloudflare non ha completato la configurazione del tunnel personalizzato. Riprova.",
        errorTeardownFailed:"Cloudflare non ha completato la rimozione del tunnel personalizzato. Riprova.",
        errorTeardownManual:"Le impostazioni locali del tunnel sono state rimosse, ma la pulizia su Cloudflare non è terminata. Controlla il tunnel e il record DNS nel pannello Cloudflare.",
        errorUnknown:"L'operazione del tunnel personalizzato non è riuscita. Riprova o controlla i log del server."
      },
      notifications: {
