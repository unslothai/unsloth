...
export const it = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "chiedi",
      escHint: "chiudi",
      context: "Testo selezionato ({chars} caratteri)",
    ...
    settings: {
      ...
      setUp: "Configura...",
      permission: "Accesso alle funzioni di accessibilità",
      permissionGranted: "Concesso",
      permissionMissing: "Non concesso",
      permissionRequest: "Richiedi",
      hotkey: "Scorciatoia",
      ...
      actionName: "Nome",
      actionPrompt: "Prompt",
      actionPromptHint: "Deve contenere {selection}.",
      actionSystemPrompt: "Prompt di sistema (facoltativo)",
      actionModel: "Modello",
      actionModelDefault: "Usa il modello caricato",
      actionOutputMode: "Risultato",
      outputModeReplace: "Sostituisci la selezione",
      outputModeShow: "Mostra il risultato",
      actionEnabled: "Attivo",
