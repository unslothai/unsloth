...
export const it = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Apprendimento per rinforzo con funzioni di ricompensa predefinite.",
        note: "RL",
      },
    },
    grpo: {
      settings: "Impostazioni GRPO",
      rewardFunctions: "Funzioni di ricompensa",
      rewardFunctionsLoading: "Caricamento delle funzioni di ricompensa...",
      expectedColumns: "Richiede la/e colonna/e del dataset: {columns}",
      weight: "Peso",
      numGenerations: "Generazioni per prompt",
      numGenerationsTooltip: "Quanti completamenti vengono generati e valutati per ogni prompt. Deve dividere batch size x accumulo del gradiente.",
      maxPromptLength: "Lunghezza massima del prompt",
      maxPromptLengthTooltip: "Token del prompt mantenuti prima della generazione. I prompt più lunghi vengono troncati.",
      maxCompletionLength: "Lunghezza massima del completamento",
      maxCompletionLengthTooltip: "Numero massimo di token generati per rollout. Prompt e completamento devono stare nel contesto.",
      temperature: "Temperatura di campionamento",
      temperatureTooltip: "Valori più alti rendono i rollout più diversi, cosa che serve a GRPO per distinguere risposte buone e cattive.",
      topP: "Top-p",
      topPTooltip: "Soglia di campionamento nucleus per i rollout.",
      beta: "Coefficiente KL (beta)",
      betaTooltip: "Quanto il modello di riferimento trattiene la policy. 0 rimuove del tutto il termine KL.",
      generationBackend: "Backend dei rollout",
