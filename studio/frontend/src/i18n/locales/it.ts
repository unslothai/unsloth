  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        qrDescription:"Scansiona per aprire l'URL remoto nel browser del telefono.",
        ...
        streamingBuffered:"I tunnel temporanei memorizzano le risposte in streaming fino al completamento.",
        passwordLabel:"Password remota",
        passwordDescription:"I browser remoti accedono come unsloth. L'app desktop continua ad accedere automaticamente.",
        customHostnameTitle:"Nome host personalizzato",
        customHostnameDescription:"Usa il tuo nome host per mantenere lo stesso indirizzo.",
        ...
        setupConfirmDescription:"Controlla il nome host qui sotto. Cloudflare ti chiederà poi di autorizzare questo tunnel: scegli il dominio a cui appartiene questo nome host e fai clic su Authorize.",
        setupPreparing:"Apertura di Cloudflare per consentirti di autorizzare questo tunnel…",
        setupAuthorize:"In attesa della tua autorizzazione su Cloudflare. Scegli il dominio a cui appartiene {hostname}, poi fai clic su Authorize.",
        ...
        removeDescription:"Questo rimuove solo ciò che Unsloth ha salvato. Il tunnel e il suo record DNS restano su Cloudflare finché non li elimini lì.",
        ...
        removeLocally:"Apri le impostazioni sul computer che esegue Unsloth per rimuovere questo tunnel connesso.",
        dnsConflict:"{hostname} punta già altrove su Cloudflare. Elimina quel record DNS oppure configura un nome host diverso.",
        ...
        autoStartCustomMissing:"Non verrà connesso nulla finché non configuri un nome host personalizzato qui sotto.",
        blockServerStarting:"L'accesso remoto sarà disponibile al termine dell'avvio del server.",
        blockCustomNotConfigured:"Configura qui sotto un nome host personalizzato prima di avviare l'accesso remoto.",
        blockPasswordDesktop:"Imposta qui sotto una password remota prima di avviare l'accesso remoto.",
        blockPasswordWeb:"Chiedi all'amministratore dell'host di impostare una password remota.",
        blockExplicitlyDisabled:"L'accesso remoto è stato disabilitato all'avvio di questo server.",
        blockLaunchManaged:"Questo tunnel è gestito dal comando di avvio del server.",
        ...
        dnsConflictUnknown:"Questo nome host punta già altrove su Cloudflare. Elimina quel record DNS oppure configura un nome host diverso.",
        errorInvalidHostname:"Non è un nome host completo. Inseriscine uno come unsloth.example.com.",
        errorWrongDomain:"Il dominio autorizzato su Cloudflare non copre {hostname}. Ripeti la configurazione e scegli il dominio a cui appartiene questo nome host.",
        errorHostnameUnreachable:"Il tunnel si è connesso, ma {hostname} non si è aperto. Rimuovi questo tunnel personalizzato, riconfiguralo e scegli il dominio a cui appartiene questo nome host.",
        errorCertificateExists:"In {path} esiste già un certificato Cloudflare e Unsloth non lo sovrascriverà. Sposta o elimina quel file, poi riconfigura.",
        errorBusy:"È ancora in corso un'altra modifica dell'accesso remoto. Attendi che termini e riprova.",
        errorIdentityExists:"Un tunnel personalizzato è già configurato. Rimuovilo prima di configurare un altro nome host.",
        errorUnavailable:"Impossibile raggiungere Cloudflare. Controlla la connessione internet di questo computer e riprova.",
        errorCancelled:"La configurazione è stata annullata. Riprova quando vuoi.",
        errorLoginTimeout:"Cloudflare non è stato autorizzato in tempo. Riconfigura e fai clic su Authorize quando si apre la pagina di Cloudflare.",
        errorLoginFailed:"Cloudflare non ha completato l'autorizzazione. Riconfigura.",
        errorSetupFailed:"Non è stato possibile completare il tunnel personalizzato. Riconfigura o controlla i log del server.",
        errorTeardownFailed:"Non è stato possibile rimuovere il tunnel personalizzato salvato. Riprova o controlla i log del server.",
        errorTeardownManual:"Il tunnel personalizzato è stato rimosso da Unsloth.",
        errorUnknown:"La modifica del tunnel personalizzato non è stata completata. Riprova o controlla i log del server.",
      },
      notifications: {
