  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "Usa DirectIO sulle build Windows supportate quando il modello è interamente scaricato sulla GPU. Altrimenti mantiene il caricamento mappato in memoria. I buffer CPU necessari e le pagine mappate possono comunque occupare RAM. Rimuove --no-mmap e --mlock.",
