  ...
  settings: {
    ...
    profile: {
      ...
      stats: {
        ...
        dayCountOne: "1 giorno",
        activityTitle: "Attività in token",
        activityDescription: "{total} token nelle ultime {weeks} settimane",
        mode: {
          daily: "Giornaliera",
          weekly: "Settimanale",
          cumulative: "Cumulativa",
        },
        cellTooltip: "{date} · {tokens} token, {messages} messaggi",
        weekTooltip: "Settimana del {date} · {tokens} token",
        less: "Meno",
        more: "Più",
        ...
        modelSummary: "{tokens} · {messages} msg",
    ...
    appearance: {
      title: "Aspetto",
      description: "Come si presenta Unsloth Studio su questo dispositivo.",
      theme: {
        title: "Tema",
    ...
    agents: {
      ...
      modelNote:
        "Codex richiede un modello GGUF servito da llama-server. Gli altri agenti possono usare anche modelli basati su transformer; rimuovi --model per usare il modello già caricato in Unsloth Studio.",
      subagent: {
    ...
    apiKeys: {
      ...
      secureHttpsHint:
        "La porta su 0.0.0.0 resta raggiungibile da tutta la rete. Per la massima sicurezza avvia Unsloth Studio con --secure, così viene esposto solo questo link HTTPS.",
