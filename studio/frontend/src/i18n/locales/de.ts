  ...
  settings: {
    ...
    agents: {
      ...
      automaticSettingsNote:
        "Wenn Sie keine Optionen festgelegt haben, wendet Unsloth automatisch die vom Modell empfohlenen Einstellungen an.",
      configurationNote:
        "Sie können auch jede Konfiguration anpassen. Weitere Informationen finden Sie unten oder in der",
      configurationDocs: "Dokumentation",
      configurationFlagsSuffix: "zu den Optionen.",
      modelNote:
