...
export const de = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Reinforcement Learning mit vordefinierten Belohnungsfunktionen.",
        note: "RL",
      },
    },
    grpo: {
      settings: "GRPO-Einstellungen",
      rewardFunctions: "Belohnungsfunktionen",
      rewardFunctionsLoading: "Belohnungsfunktionen werden geladen ...",
      expectedColumns: "Benötigt Datensatzspalte(n): {columns}",
      weight: "Gewicht",
      numGenerations: "Generierungen pro Prompt",
      numGenerationsTooltip: "Wie viele Vervollständigungen pro Prompt erzeugt und bewertet werden. Muss Batch-Größe x Gradientenakkumulation teilen.",
      maxPromptLength: "Maximale Promptlänge",
      maxPromptLengthTooltip: "Vor der Generierung behaltene Prompt-Tokens. Längere Prompts werden abgeschnitten.",
      maxCompletionLength: "Maximale Vervollständigungslänge",
      maxCompletionLengthTooltip: "Maximale Tokenzahl je Rollout. Prompt und Vervollständigung müssen in die Kontextlänge passen.",
      temperature: "Sampling-Temperatur",
      temperatureTooltip: "Höhere Werte machen Rollouts vielfältiger, was GRPO braucht, um gute von schlechten Antworten zu unterscheiden.",
      topP: "Top-p",
      topPTooltip: "Nucleus-Sampling-Grenze für Rollouts.",
      beta: "KL-Koeffizient (Beta)",
      betaTooltip: "Wie stark das Referenzmodell die Policy zurückhält. 0 entfernt den KL-Term vollständig.",
