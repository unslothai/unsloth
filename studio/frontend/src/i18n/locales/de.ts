...
export const de = {
  ...
  settings: {
    ...
    debugging: {
      ...
      exportPrivacyNote: "Anmeldedaten werden in exportierten ZIP-Dateien maskiert.",
      openFolder: "Protokollordner öffnen",
      openingFolder: "Wird geöffnet...",
      openFolderError: "Protokollordner konnte nicht geöffnet werden",
