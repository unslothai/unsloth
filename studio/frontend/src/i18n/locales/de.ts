...
export const de = {
  ...
  systemPill: {
    ask: {
      ...
      enterHint: "fragen",
      escHint: "schließen",
      context: "Ausgewählter Text ({chars} Zeichen)",
      followUp: "Nachfragen...",
      clear: "Leeren",
    },
    settings: {
      ...
      setUp: "Einrichten...",
      permission: "Bedienungshilfen-Zugriff",
      permissionGranted: "Erteilt",
      permissionMissing: "Nicht erteilt",
      permissionRequest: "Anfordern",
      hotkey: "Kurzbefehl",
      ...
      actionName: "Name",
      actionPrompt: "Prompt",
      actionPromptHint: "Muss {selection} enthalten.",
      actionSystemPrompt: "System-Prompt (optional)",
      actionModel: "Modell",
      actionModelDefault: "Geladenes Modell verwenden",
      actionOutputMode: "Ergebnis",
      outputModeReplace: "Auswahl ersetzen",
      outputModeShow: "Ergebnis anzeigen",
      actionEnabled: "Aktiviert",
