  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Bestätige den Hostnamen unten. Wähle in Cloudflare die passende Domain und erlaube den Zugriff.",
        setupPreparing:"Verbindung mit Cloudflare...",
        setupAuthorize:"Warten auf die Freigabe in Cloudflare. Wähle die passende Domain für {hostname}.",
        ...
        removeDescription:"Nur die in Unsloth gespeicherte Verbindung wird entfernt. Tunnel und DNS-Eintrag bleiben in Cloudflare.",
        ...
        dnsConflict:"Der Eintrag {hostname} existiert bereits. Entferne ihn in Cloudflare oder wähle einen anderen Hostnamen.",
        ...
        autoStartCustomMissing:"Richte zuerst einen benutzerdefinierten Tunnel ein.",
        blockServerStarting:"Der Fernzugriff ist verfügbar, sobald der Server vollständig gestartet ist.",
        blockPasswordDesktop:"Lege ein Fernzugriffspasswort fest, bevor du den Fernzugriff startest.",
        ...
        dnsConflictUnknown:"Ein vorhandener DNS-Eintrag blockiert diesen Hostnamen. Entferne den Eintrag in Cloudflare oder wähle einen anderen Hostnamen.",
        errorInvalidHostname:"Gib einen vollständigen Hostnamen wie studio.example.com ein.",
        errorWrongDomain:"Cloudflare hat {hostname} nicht autorisiert. Versuche es erneut und wähle die Domain dieses Hostnamens aus.",
        errorHostnameUnreachable:"Cloudflare ist verbunden, aber {hostname} lässt sich nicht öffnen. Entferne diesen benutzerdefinierten Tunnel, richte ihn erneut ein und wähle die passende Domain.",
        errorCertificateExists:"Studio überschreibt das vorhandene Cloudflare-Zertifikat unter {path} nicht. Verschiebe es und versuche es erneut.",
        errorBusy:"Ein anderer Fernzugriffsvorgang läuft bereits. Warte, bis er abgeschlossen ist, und versuche es erneut.",
        errorIdentityExists:"Ein benutzerdefinierter Tunnel ist bereits konfiguriert. Entferne ihn, bevor du einen anderen Hostnamen einrichtest.",
        errorUnavailable:"Cloudflare ist nicht erreichbar. Prüfe deine Verbindung und versuche es erneut.",
        errorCancelled:"Die Cloudflare-Autorisierung wurde abgebrochen.",
        errorLoginTimeout:"Die Cloudflare-Autorisierung ist abgelaufen. Starte die Einrichtung erneut.",
        errorLoginFailed:"Die Cloudflare-Autorisierung ist fehlgeschlagen. Starte die Einrichtung erneut.",
        errorSetupFailed:"Cloudflare konnte den benutzerdefinierten Tunnel nicht vollständig einrichten. Versuche die Einrichtung erneut.",
        errorTeardownFailed:"Unsloth konnte den gespeicherten benutzerdefinierten Tunnel nicht entfernen. Versuche es erneut.",
        errorTeardownManual:"Der benutzerdefinierte Tunnel wurde aus Unsloth entfernt.",
        errorUnknown:"Der Vorgang für den benutzerdefinierten Tunnel ist fehlgeschlagen. Versuche es erneut oder prüfe die Serverprotokolle.",
      },
      notifications: {
