...
export const de = {
  ...
  settings: {
    ...
    library: {
      ...
      showFineTunesDescription: "Modelle, die du in Studio trainiert oder exportiert hast.",
      ...
      locationsDescription: "Wo Studio jede Dateiart speichert. Bibliotheksordner sind Beschriftungen in Studio, keine Ordner auf dem Datenträger.",
