...
export const de = {
  ...
  settings: {
    ...
    library: {
      ...
      mediaTabs: "Tabs für Bilder, Videos und Audio",
      mediaTabsDescription: "Diese Tabs nur anzeigen, wenn es Dateien dafür gibt, oder immer.",
      mediaTabsAuto: "Wenn Dateien vorhanden sind",
      mediaTabsAlways: "Immer",
