  ...
  settings: {
    ...
    apiKeys: {
      ...
      decisionApi: {
        ...
        description: "Stelle Ja/Nein-, Auswahl- und Bewertungsfragen zu beliebigem Text und erhalte kalibrierte Wahrscheinlichkeiten von einem lokalen Laya-Modell. Die API ist Jev-kompatibel, das SDK von TypeSafe funktioniert also unverändert.",
        enable: "Anfragen beantworten",
        enableDescription: "Beantwortet POST /v1/systemone. Beim Einschalten wird das Modell heruntergeladen; es wird bei der ersten Anfrage in den Speicher geladen.",
        lockedByEnv: "Festgelegt durch {name}.",
        model: "Modell",
        modelDescription: "Multilingual deckt über 100 Sprachen ab. Englisch ist größer und nur für Englisch.",
        ...
        tryIt: "Ausprobieren",
        caveat: "Basismodelle sind allgemein gehalten. Prüfe die Antworten mit deinen eigenen Daten, bevor du dich darauf verlässt.",
      },
      usageNoModel:
