...
export const de = {
  ...
  settings: {
    ...
    chat: {
      ...
      importedCursorPartial: "Einige Cursor-Konversationen konnten nicht importiert werden.",
      ...
      importedClaudePartial: "Einige Claude-Code-Konversationen konnten nicht importiert werden.",
