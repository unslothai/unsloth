...
export const de = {
  ...
  settings: {
    ...
    agents: {
      ...
      intro:
        "verbindet Claude Code, Codex, Hermes, OpenClaw, OpenCode und weitere Agenten mit einem von Unsloth bereitgestellten Modell, lokal und vollständig offline oder auf einem entfernten Studio. Es startet einen OpenAI-kompatiblen Server und verändert nie die Konfigurationsdateien Ihres Agenten.",
