  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        ownerLaunch:"Vom Startbefehl verwaltet",
        ownerSettings:"Von Einstellungen verwaltet",
        ...
        stableTitle:"Stabiler Hostname",
        stableDescription:"Einen benutzerdefinierten Cloudflare-Tunnel für eine feste URL und API-Streaming erstellen.",
        ...
        provisionProgress:"Cloudflare im Browser autorisieren. Unsloth erstellt anschließend Tunnel und DNS-Eintrag.",
        teardownProgress:"Cloudflare autorisieren, um den Tunnel zu entfernen. Der DNS-Eintrag bleibt zur manuellen Löschung bestehen.",
        openCloudflare:"Cloudflare öffnen",
        connectorReady:"Connector registriert",
        tunnelReady:"Tunnel erreichbar",
        dnsReady:"DNS aufgelöst",
        dnsPending:"Noch nicht erreichbar",
        dnsUnknown:"Prüfung nicht möglich",
        dnsLinkWaiting:"Der Remote-Link erscheint, sobald die DNS-Auflösung bestätigt ist.",
        ready:"Bereit",
        waiting:"Warten",
        removeAction:"Benutzerdefinierten Tunnel entfernen",
        removeTitle:"Diesen benutzerdefinierten Tunnel entfernen?",
        removeDescription:"Die Tunnel-Identität wird nach dem Trennen gelöscht. Cloudflare kann den DNS-Eintrag nicht löschen; entferne ihn vor der Wiederverwendung im Dashboard.",
        removeConfirm:"Tunnel entfernen",
        ...
        orphanedRecords:"Verbleibende DNS-Einträge in Cloudflare: {hostnames}. Vor der Wiederverwendung im Cloudflare-Dashboard löschen.",
        requestFailed:"Remotezugriffsanfrage fehlgeschlagen.",
        runtimeFailed:"Der Remote-Tunnel ist fehlgeschlagen. Versuche es erneut oder prüfe die Serverprotokolle.",
        temporaryAction:"Temporäre Tunnel starten",
        ...
        autoStartCustom:"Beim Start von Unsloth diesen stabilen Hostnamen verbinden. Das Trennen ändert diese Einstellung nicht.",
        autoStartCustomMissing:"Der Autostart eines benutzerdefinierten Tunnels benötigt einen konfigurierten Tunnel.",
        ...
        errorTeardownFailed:"Cloudflare konnte den benutzerdefinierten Tunnel nicht vollständig entfernen. Versuche es erneut.",
        errorTeardownManual:"Die lokalen Tunneleinstellungen wurden entfernt, aber die Cloudflare-Bereinigung wurde nicht abgeschlossen. Prüfe Tunnel und DNS-Eintrag im Cloudflare-Dashboard.",
