...
export const de = {
  ...
  skills: {
    ...
    delete: "{name} löschen",
    createDescription: "Wird als SKILL.md in einem neuen Ordner unter ~/.agents/skills gespeichert und sofort aktiviert.",
    nameLabel: "Name",
    namePlaceholder: "z. B. code-arithmetic",
    nameHint: "Kleinbuchstaben, Ziffern und einzelne Bindestriche. Zugleich der Ordnername.",
    nameInvalid: "1-64 Kleinbuchstaben, Ziffern oder einzelne Bindestriche, nicht mit einem Bindestrich beginnend oder endend.",
    descriptionLabel: "Beschreibung",
    descriptionPlaceholder: "Verwenden, wenn der Nutzer Rechenaufgaben stellt. Immer mit dem Code-Tool berechnen.",
    descriptionHint: "Die Zeile, die das Modell in seinem Fähigkeitenkatalog sieht. Daran entscheidet es, wann es die Fähigkeit liest.",
    instructionsLabel: "Anweisungen",
    instructionsPlaceholder: "Was zu tun ist, wenn diese Fähigkeit greift, in Markdown.",
    instructionsHint: "Der Inhalt von SKILL.md, den das Modell vollständig liest, sobald es die Fähigkeit auswählt.",
    create: "Fähigkeit erstellen",
    save: "Änderungen speichern",
    created: "{name} erstellt",
    saved: "{name} gespeichert",
    deleted: "{name} gelöscht",
    saveError: "Fähigkeit konnte nicht gespeichert werden",
    openError: "Fähigkeit konnte nicht geöffnet werden",
    deleteError: "Fähigkeit konnte nicht gelöscht werden",
    deleteTitle: "Fähigkeit löschen",
    deleteDescription: "„{name}“ samt allem in seinem Ordner unter ~/.agents/skills löschen? Das lässt sich nicht rückgängig machen.",
    search: "Fähigkeiten nach Name oder Beschreibung suchen…",
    noMatch: "Keine Fähigkeiten passen zu „{query}“",
    clearSearch: "Suche leeren",
    count: "{shown} von {total} Fähigkeiten",
    readOnlyClaude: "Schreibgeschützt: liegt in ~/.claude/skills. Bearbeite die Datei dort.",
    readOnlyBundled: "Schreibgeschützt: mit Unsloth Studio mitgeliefert.",
    ...
    fromAgents: "Eine Fähigkeit in ~/.agents/skills. Änderungen hier werden direkt in ihre SKILL.md geschrieben.",
    fromClaude: "Eine Fähigkeit in ~/.claude/skills.",
    fromBundled: "Mit Unsloth Studio mitgeliefert.",
    detailsTitle: "Details",
    detailsDescription: "Die übrigen Felder im Frontmatter der SKILL.md. Zum Ändern die Datei bearbeiten.",
    detailsEmpty: "Keine weiteren Felder.",
    licenseLabel: "Lizenz",
    compatibilityLabel: "Kompatibilität",
    allowedToolsLabel: "Erlaubte Tools",
    deleteLabel: "Fähigkeit löschen",
    deleteRowDescription: "Entfernt den Ordner unter ~/.agents/skills samt Inhalt.",
    summary: "{enabled} von {total} aktiviert",
    enabledOnly: "Nur aktivierte",
    sectionAgents: "Deine Fähigkeiten",
    sectionAgentsHint: "Gespeichert in ~/.agents/skills. Hier anlegen, bearbeiten und löschen.",
    ...
    sectionBundledHint: "Mit Unsloth Studio ausgeliefert. Schreibgeschützt.",
    newSkillHint: "Hier schreiben. Landet in ~/.agents/skills.",
    edit: "Bearbeiten",
    view: "Ansehen",
    linked: "Verknüpfung",
    emptyTitle: "Noch keine Fähigkeiten",
    previewTitle: "Was das Modell sieht",
    previewHint: "Die Katalogzeile. Daran entscheidet das Modell, ob es die Fähigkeit öffnet und die Anweisungen liest.",
    previewName: "skill-name",
    mention: "Im Chat erwähnen",
    copyMention: "@{name} kopieren",
    sourceLabel: "Quelle",
