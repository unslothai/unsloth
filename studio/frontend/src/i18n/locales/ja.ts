...
export const ja = {
  ...
  notebooks: {
    routeTitle: "ノートブック",
    title: "Unsloth ノートブック",
    subtitle:
      "unslothai/notebooks の公式ファインチューニングレシピです。Colab で開くか、Fine-tuning Studio に事前入力できます。",
    searchPlaceholder: "ノートブックを検索…",
    pickerPlaceholder: "ノートブックを検索して選択…",
    pickerEmpty: "検索に一致するノートブックはありません。",
    pickedSection: "選択中のノートブック",
    resultsCount: "{count} 件のノートブック",
    allCategories: "すべて",
    featured: "注目",
    featuredSection: "注目のノートブック",
    allSection: "すべてのノートブック",
    loading: "ノートブックを読み込んでいます…",
    loadFailed: "ノートブックの読み込みに失敗しました",
    emptyTitle: "ノートブックが見つかりません",
    emptyDescription: "別の検索語またはカテゴリフィルターを試してください。",
    useInStudio: "Studio で使う",
    openInColab: "Colab で開く",
    viewOnGitHub: "GitHub",
    studioModelReady: "Studio に事前入力: {model}",
    studioManualConfigure:
      "Fine-tuning Studio を開きます — このノートブックに合うモデルを選んでください。",
    studioOpenedWithoutModel:
      "Fine-tuning Studio を開きました。このノートブックに合うモデルを選択してください。",
    studioDisabled: {
      mlxUnavailable:
        "トレーニングには MLX が必要です。「Studio で使う」を有効にするには `unsloth studio update` を実行してください。",
      intelMac:
        "トレーニングには Apple Silicon または GPU が必要です。Intel Mac はチャットのみです。",
      noGpu: "トレーニングには NVIDIA または AMD の GPU が必要です。",
      generic: "このデバイスではトレーニングを利用できません。",
    },
    categories: {
      sft: "ファインチューニング",
      vision: "ビジョン",
