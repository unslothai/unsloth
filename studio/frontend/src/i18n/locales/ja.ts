  ...
  settings: {
    ...
    general: {
      ...
      permissions: {
        ...
        bypassLabel: "ツールの権限",
        bypassDescription:
          "チャットのツール呼び出し (ターミナル、python、ウェブ、MCP) を実行する前に、Unsloth がどのように承認するかを決めます。フルアクセスにすると承認とコードサンドボックスが無効になります。",
      },
    },
    profile: {
      title: "プロフィール",
      ...
      stats: {
        ...
        activityDescription: "直近 {weeks} 週間で {total} トークン",
        mode: {
          daily: "日次",
          weekly: "週次",
          cumulative: "累計",
        },
        cellTooltip: "{date} · {tokens} トークン、{messages} 件のメッセージ",
        weekTooltip: "{date} の週 · {tokens} トークン",
        less: "少ない",
        more: "多い",
        ...
        modelSummary: "{tokens} · {messages} 件",
