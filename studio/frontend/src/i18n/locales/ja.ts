...
export const ja = {
  ...
  settings: {
    ...
    chat: {
      ...
      autoCompactHint: "コンテキストから外れたターンは削除されず、検索できるように索引化されます。継続的な指示はそのままの文言で引き継がれ、残りはモデルがアーカイブを検索して取り出せます。空きVRAMではなく、設定したコンテキスト長を基準にします。",
      ...
      autoCompactDescription:
        "ローカル GGUF チャットの文脈が満杯になると、古いターンは検索可能なアーカイブに移ります。",
