  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"Unsloth が Cloudflare ページを準備します。開いたら、このホスト名に一致するドメインを選び、アクセスを承認してください。",
        setupConfirmAction:"Cloudflare を準備",
        setupPreparing:"Cloudflare を準備中...",
        setupAuthorize:"Cloudflare を開き、{hostname} に一致するドメインを選び、アクセスを承認してください。",
        removeProgress:"Unsloth から保存済み接続を削除中...",
        openCloudflare:"Cloudflare を開く",
        ready:"準備完了",
        removeAction:"削除",
        removeTitle:"このカスタムトンネルを Unsloth から削除しますか？",
        removeDescription:"Unsloth に保存された接続だけを削除します。トンネルと DNS レコードは Cloudflare に残ります。",
        ...
        autoStartCustomMissing:"この設定をオンにする前にカスタムトンネルを設定してください。",
        ...
        errorWrongDomain:"Cloudflare は {hostname} を承認しませんでした。再試行して、このホスト名のドメインを選んでください。",
        errorHostnameUnreachable:"Cloudflare には接続しましたが、{hostname} を開けません。カスタムトンネルを削除して再設定し、正しいドメインを選んでください。",
        ...
        errorTeardownFailed:"Unsloth は保存済みのカスタムトンネルを削除できませんでした。再試行してください。",
