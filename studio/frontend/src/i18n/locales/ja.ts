...
export const ja = {
  ...
  systemPill: {
    ...
    settings: {
      ...
      setUp: "設定...",
      permission: "アクセシビリティのアクセス権",
      permissionGranted: "許可済み",
      permissionMissing: "未許可",
      permissionRequest: "リクエスト",
      hotkey: "ショートカット",
      defaultModel: "既定のモデル",
      ...
      actionName: "名前",
      actionPrompt: "プロンプト",
      actionPromptHint: "{selection} を含める必要があります。",
      actionSystemPrompt: "システムプロンプト（任意）",
      actionModel: "モデル",
      actionModelDefault: "読み込み済みのモデルを使う",
      actionOutputMode: "結果",
      outputModeReplace: "選択範囲を置き換える",
      outputModeShow: "結果を表示する",
      actionEnabled: "有効",
