  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        setupConfirmDescription:"以下のホスト名を確認してください。Cloudflare で一致するドメインを選び、アクセスを承認してください。",
        setupPreparing:"Cloudflare に接続しています...",
        setupAuthorize:"Cloudflare の承認を待っています。{hostname} に一致するドメインを選んでください。",
