  ...
  settings: {
    ...
    general: {
      ...
      remoteAccess: {
        ...
        stableTitle:"固定ホスト名",
        stableDescription:"固定 URL と API ストリーミング用のカスタム Cloudflare トンネルを作成します。",
        hostnameLabel:"完全なホスト名",
        hostnamePlaceholder:"studio.example.com",
        setupAction:"設定",
        settingUp:"設定中...",
        provisionProgress:"ブラウザで Cloudflare を承認してください。トンネルと DNS レコードの作成は Unsloth が完了します。",
        teardownProgress:"トンネルを削除するため Cloudflare を承認してください。DNS レコードは手動削除用に残ります。",
        openCloudflare:"Cloudflare を開く",
        connectorReady:"コネクタ登録",
        tunnelReady:"トンネル稼働",
        dnsReady:"DNS 解決",
        dnsPending:"まだ到達できません",
        dnsUnknown:"確認できません",
        dnsLinkWaiting:"DNS 解決が確認されるとリモートリンクが表示されます。",
        ready:"準備完了",
        waiting:"待機中",
        removeAction:"カスタムトンネルを削除",
        removeTitle:"このカスタムトンネルを削除しますか？",
        removeDescription:"切断後にトンネル ID を削除します。Cloudflare は DNS レコードを削除できないため、このホスト名を再利用する前にダッシュボードで削除してください。",
        removeConfirm:"トンネルを削除",
        removeLocally:"接続中のトンネルを削除するには、Unsloth を実行しているマシンで設定を開いてください。",
        dnsConflict:"レコード {hostname} は既に存在します。Cloudflare で削除するか、別のホスト名を選択してください。",
        orphanedRecords:"Cloudflare に残っている DNS レコード: {hostnames}。再利用前に Cloudflare ダッシュボードで削除してください。",
        requestFailed:"リモートアクセス要求に失敗しました。",
        runtimeFailed:"リモートトンネルに失敗しました。再試行するか、サーバーログを確認してください。",
        temporaryAction:"一時トンネルを開始",
        connectAction:"接続",
        stopAction:"切断",
        actionStarting:"起動中...",
        actionStopping:"停止中...",
        ...
        autoStartCustom:"Unsloth の起動時にこの固定ホスト名へ接続します。今切断してもこの設定はオフになりません。",
        autoStartCustomMissing:"カスタムトンネルの自動起動には設定済みのトンネルが必要です。",
        blockServerStarting:"サーバーの起動が完了すると、リモートアクセスを使用できます。",
        blockPasswordDesktop:"リモートアクセスを開始する前にリモートパスワードを設定してください。",
        ...
        dnsConflictUnknown:"既存の DNS レコードがこのホスト名の使用を妨げています。Cloudflare でそのレコードを削除するか、別のホスト名を選択してください。",
        errorInvalidHostname:"studio.example.com のような完全なホスト名を入力してください。",
        errorCertificateExists:"Studio は {path} にある既存の Cloudflare 証明書を上書きしません。別の場所に移動してから再試行してください。",
        errorBusy:"別のリモートアクセス操作が進行中です。完了してから再試行してください。",
        errorIdentityExists:"カスタムトンネルがすでに設定されています。別のホスト名を設定する前に削除してください。",
        errorUnavailable:"Cloudflare に接続できませんでした。接続を確認して再試行してください。",
        errorCancelled:"Cloudflare の認証がキャンセルされました。",
        errorLoginTimeout:"Cloudflare の認証がタイムアウトしました。設定を最初からやり直してください。",
        errorLoginFailed:"Cloudflare の認証に失敗しました。設定を最初からやり直してください。",
        errorSetupFailed:"Cloudflare はカスタムトンネルの設定を完了できませんでした。再試行してください。",
        errorTeardownFailed:"Cloudflare はカスタムトンネルの削除を完了できませんでした。再試行してください。",
        errorTeardownManual:"ローカルのトンネル設定は削除されましたが、Cloudflare のクリーンアップが完了しませんでした。Cloudflare ダッシュボードでトンネルと DNS レコードを確認してください。",
        errorUnknown:"カスタムトンネルの操作に失敗しました。再試行するか、サーバーログを確認してください。"
      },
      notifications: {
        sectionTitle: "通知",
