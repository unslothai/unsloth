...
export const ja = {
  ...
  settings: {
    ...
    about: {
      ...
      update: {
        ...
        sourceInstallDetected: "ソースまたはVCSパッケージのインストールが検出されました。元のローカルパスまたは Git URL から再インストールしてください。",
  ...
  studio: {
    ...
    params: {
      ...
      evalSteps: "評価ステップ間隔",
      evalStepsTooltip: "評価を行う総トレーニングステップの割合 (0-1)。0 に設定すると評価が無効になります。例: 0.01 = ステップの 1% ごとに評価を実行。",
      seed: "シード値",
