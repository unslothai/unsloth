...
// reader must survive a backend that sends only the boolean.

/** The reported list, lower-cased and emptied of blanks. An absent or malformed field is [] rather
 *  than a guessed default: inventing "fp8" would name a precision an Ampere host never runs. */
