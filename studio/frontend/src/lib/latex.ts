...
function findInlineCodeRegions(
  ...
  // Avoid rebuilding the masked reply unless a backtick exists outside block code.
  // This function runs for every streamed chunk, so the early exit prevents O(n^2) work.
