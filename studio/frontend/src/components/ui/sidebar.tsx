      ...
      >
        <div
          ...
          className={cn(
            ...
            hasPinMode && "rounded-xl corner-squircle bg-muted/50 ring-1 ring-sidebar-border/60",
          )}
        >
          {children}
        </div>
