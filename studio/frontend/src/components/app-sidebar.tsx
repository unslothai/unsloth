...
export function AppSidebar() {
  ...
  // Driven only from onScroll + a content-change effect below. No ResizeObserver: its
  // callback-driven setState caused a render loop (React #185). Both setters bail if unchanged.
    ...
    >
      ...
      <SidebarFooter
        className={cn(
          ...
          // Tighter top with the update card so the fade hugs it; fuller top for the profile alone.
      ...
      >
        ...
        <div
          aria-hidden="true"
          className={cn(
            // The scroll area hard-clips at the fade's bottom edge, so a plain ramp is still
            // part-transparent there and slices the last row mid-glyph. from-[16px] holds it opaque.
            ...
            // Shorter fade with the update card, but still tall enough to clear a row.
