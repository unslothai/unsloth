      ...
      <div className="relative">
        ...
        >
          <HugeiconsIcon
            icon={icon}
            strokeWidth={1.75}
            className="size-[18px]! shrink-0 group-hover/menu-button:animate-icon-pop"
          />
...
const THEME_OPTIONS: { value: Theme; label: string; icon: typeof Sun02Icon }[] =
  [
...
export function AppSidebar() {
  ...
  const themeIcon = resolved === "dark" ? Moon02Icon : Sun02Icon;
  ...
  // Training runs
  const { items: runItems, refresh: refreshRuns } =
    useTrainingHistorySidebarItems(!chatOnly && isStudioRoute);
    ...
    <>
      ...
      >
        ...
        <SidebarContent className="gap-0 overflow-y-auto overscroll-contain min-h-0">
          ...
          <SidebarGroup
            data-tour="navbar"
            className="group-data-[collapsible=icon]:px-0 px-2 pt-[10px] pb-[14px]"
          >
            <SidebarGroupContent>
              <SidebarMenu>
                <NavItem
          ...
          {!isStudioRoute && chatItems.length > 0 && (
            ...
            >
              <SidebarGroup className="group-data-[collapsible=icon]:hidden overflow-hidden px-2 py-0">
                <SidebarGroupLabel
                  className="pt-2 pb-1.5 pl-2.5 pr-2 text-[12.5px]! font-normal normal-case tracking-normal text-[#62605a] dark:text-[#9d9fa5] focus-visible:ring-0! focus-visible:outline-none"
                  asChild={true}
                >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild={true}>
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5 leading-none group-data-[collapsible=icon]:hidden">
                      <span className="truncate font-heading text-[13px] tracking-[0.02em] font-semibold text-[#383835] dark:text-[#c7c7c4]">
                        {displayTitle}
                      </span>
                      <span className="truncate text-[11px] tracking-[0.01em] text-muted-foreground">
                        Studio
                      </span>
                    </div>
                    <ChevronsUpDown
                ...
                >
                  <DropdownMenuGroup>
                    ...
                    <DropdownMenuSub>
                      <DropdownMenuSubTrigger className="h-[32px]! px-2.5! py-0! gap-[8.5px]! rounded-[10px]! font-medium text-[14px] leading-[18px] tracking-[0.01em] text-[#383835] dark:text-[#c7c7c4] focus:bg-[#f0f0f0] dark:focus:bg-[#2a2c2f] focus:text-black dark:focus:text-white data-open:bg-[#f0f0f0] dark:data-open:bg-[#2a2c2f] data-open:text-black dark:data-open:text-white">
                        <HugeiconsIcon
                          icon={themeIcon}
                          strokeWidth={1.75}
                          className="size-[18px]"
                      ...
                      <DropdownMenuSubContent className="min-w-[10rem] py-1.5">
                        <DropdownMenuRadioGroup
                          value={theme}
                        ...
                        >
                          {THEME_OPTIONS.map((opt) => (
                            <DropdownMenuRadioItem
                              key={opt.value}
                              value={opt.value}
                              className="gap-[8.5px] py-1.5 pr-8"
                            >
                              <HugeiconsIcon
                                icon={opt.icon}
                                strokeWidth={1.75}
