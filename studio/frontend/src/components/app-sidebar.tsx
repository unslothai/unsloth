    ...
    <SidebarMenuItem className={className}>
      <div className="relative">
        <SidebarMenuButton
          ...
          isActive={active}
          data-tour={dataTour}
          className="sidebar-nav-btn h-[33px] rounded-[12px] gap-[8.5px] px-2.5 font-medium group-data-[collapsible=icon]:!w-[32px] group-data-[collapsible=icon]:!rounded-[10px] group-data-[collapsible=icon]:mx-auto"
        >
...
export function AppSidebar() {
  ...
  function renderChatSidebarItem(
    ...
    const buttonClass = cn(
      "sidebar-nav-btn h-[33px] cursor-pointer rounded-[12px] pr-4 text-[14.5px] leading-[19px] tracking-nav font-medium",
                    ...
                    return (
                      ...
                      >
                        <SidebarMenuButton
                          ...
                          className="sidebar-nav-btn h-auto flex-col items-start gap-0.5 py-[5px] rounded-[12px] pl-2.5 pr-7 text-[14.5px] tracking-nav font-medium"
                          onClick={() => {
