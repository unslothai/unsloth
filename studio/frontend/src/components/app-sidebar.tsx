...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <SidebarFooter className="relative group-data-[collapsible=icon]:px-0" aria-hidden={shouldHideExpandedSidebarContent || undefined} inert={shouldHideExpandedSidebarContent || undefined}>
