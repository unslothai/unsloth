...
export function AppSidebar() {
  ...
  function renderChatSidebarItem(
    ...
    const buttonClass = cn(
      "sidebar-nav-btn h-[29px] cursor-pointer rounded-full py-0 pr-4 text-ui-14p5 leading-ui-19 tracking-nav font-medium",
        ...
        <SidebarMenuItem key={item.id} className={itemClass}>
          <input
            ...
            className={cn(
              ...
              "text-foreground h-[29px] w-full border-0 bg-transparent py-0 pr-4 text-ui-14p5 leading-ui-19 font-medium tracking-nav outline-none",
              variant === "project" ? "pl-[39px]" : "pl-3",
            )}
          />
        </SidebarMenuItem>
