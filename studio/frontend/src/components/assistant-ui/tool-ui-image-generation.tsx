            ...
            {captionPrompt ? (
              <figcaption className="w-full text-xs leading-5 text-muted-foreground">
                ...
                {promptCanExpand ? (
                  <button
                    type="button"
                    className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-foreground/80 underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                    onClick={() =>
