...
export function PromptQueueList({
  ...
  return (
    ...
    >
      <div
        ref={listRef}
        className="max-h-[28dvh] overflow-y-auto px-1.5 pt-1 pb-3 text-muted-foreground sm:px-2 [&_button]:border-0 [&_button]:shadow-none [&_.aui-button-icon:focus-visible]:bg-accent"
