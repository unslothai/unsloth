...
const VoiceToggle: FC = () => {
  ...
  const voiceModeEnabled = voiceMode !== "off";
  ...
  return (
    ...
    >
      ...
      <span>
        {voiceMode === "configuring"
          ? "Pick a voice"
          : voiceMode === "active" && isDictating
            ? "Listening"
            : voiceMode === "active" && isSpeaking
              ? "Speaking"
              : voiceMode === "active" && isThreadRunning
                ? "Thinking"
                : "Voice"}
      </span>
    </button>
