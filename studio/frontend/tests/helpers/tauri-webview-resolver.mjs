...
const WEBVIEW_STUB = new URL("./tauri-webview-stub.mjs", import.meta.url).href;
...
export function resolve(specifier, context, next) {
  ...
  if (specifier === "@tauri-apps/api/webview") {
    return next(WEBVIEW_STUB + suffix, context);
  }
  ...
  if (specifier.startsWith(".") && context.parentURL?.startsWith("file:")) {
    ...
    if (resolved) {
      return next(resolved + suffix, context);
    }
  }
