...
// bundler-resolver's two rules, plus one redirect: features/auth -> a stub.
// See auth-stub.mjs for why the redirect is needed.
...
export function resolve(specifier, context, next) {
  if (specifier === "@/features/auth" || /(^|\/)features\/auth$/.test(specifier)) {
