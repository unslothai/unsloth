...
# main.py's OS-trust-store injection. Inline copy of the gating in
# backend/utils/native_tls.py (this module is vendored standalone and cannot
# import backend modules) -- keep the two in sync.
