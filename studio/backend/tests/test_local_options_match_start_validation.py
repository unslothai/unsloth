...
_CONFIGS = ["default", "cfg-1", "en.simple", "wikitext-103-raw-v1"]
_REJECTED = ["tréin", "my config", "träin"]
...
def test_a_split_the_backend_accepts_is_offered(value):
    ...
    assert _valid_option(value, _SPLIT_RE) == value, (
...
def test_nothing_the_backend_rejects_is_offered(value):
    ...
    offered_split = _valid_option(value, _SPLIT_RE)
