...
"""A public preview link opens the outputs of the account that minted it; the owner's tokens keep their shape so links handed out before this change still work."""
