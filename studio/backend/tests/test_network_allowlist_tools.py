...
def test_windows_shell_note_and_allowlist_note_compose(monkeypatch):
    ...
    assert "The shell is bash (Git for Windows)." in terminal
    assert "The shell is cmd, not bash" not in terminal
