...
class TestTheWiringIsThere:
    """Structural, because the absence is what breaks: both calls behaved correctly on their own
    terms, and a pause simply never reached them.
    """
    ...
    def test_the_module_still_parses(self):
        """The handler lives deep inside a very long generator; a stray indent there would be
        caught by nothing else in this file.
        """
