...
def test_health_response_reports_desktop_capability_fields(monkeypatch):
    ...
    spark_serving_module = ModuleType("routes.spark_serving")
    spark_serving_module.router = APIRouter()
    ...
    monkeypatch.setitem(sys.modules, "routes.spark_serving", spark_serving_module)
