...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("<body><p>visible</p>"
            '<div style="display:none">secret loading block</div>'
            "<p>after</p></body>", "visible", "after", "secret loading block", id = "inline_style_display_none_subtree_is_dropped"),
        ...
        pytest.param('<body><p>before</p><hr aria-hidden="true"><p>after</p></body>', "before", "after", "---", id = "hidden_void_element_is_suppressed"),
        # The hidden <br> must not inject a newline between the two runs.
        pytest.param("<body><p>one<br hidden>two</p></body>", "one", "two", "one\ntwo", id = "hidden_void_br_emits_no_break"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('<body><p>keep</p><div style="display:none !important">gone</div></body>', "gone", id = "inline_style_display_none_important_is_dropped"),
        pytest.param('<body><p>keep</p><div style="color: red; display : none ; margin:0">gone</div></body>', "gone", id = "inline_style_display_none_among_other_declarations"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("<body><p hidden>secret<hr>kept text</body>", "secret", "kept text", id = "hr_implicitly_closes_hidden_paragraph"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("<body><p hidden><span>secret<div>visible div</div><p>visible paragraph</body>", "visible div", "visible paragraph", id = "hidden_paragraph_with_inline_child_implicitly_closed_by_block"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("```html\n"
            ...
            "```\n\n"
            "# My Project\n\nInstall and run.\n", "```html", "<!DOCTYPE html>", "# My Project", id = "fetch_page_text_keeps_markdown_readme_with_html_example"),
        ...
        pytest.param('<table align="center">\n'
            '<tr><td><img src="logo.png"></td><td>Badges</td></tr>\n'
            "</table>\n\n"
            "# My Project\n\n"
            "- feature one\n"
            "- feature two\n\n"
            "```python\nprint('hi')\n```\n", "- feature one\n- feature two", "```python", "# My Project", id = "fetch_page_text_keeps_markdown_readme_with_leading_table"),
        ...
        pytest.param("<blockquote>Note: pre-release.</blockquote>\n\n"
            "# My Project\n\n"
            "Install:\n\n"
            "- step one\n"
            "- step two\n\n"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("<article><header><h1><a href='/p?%s'>Title</a></h1>"
