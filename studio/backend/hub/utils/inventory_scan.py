...
def _completed_gguf_variants(snapshot_dir: Optional[Path]) -> set[str]:
    ...
    for path in paths:
        ...
        # quant. Judged with the loader's label, since the two extractors disagree on shapes
        # like F16-be-checkpoint-Q4_K_M and this file must not mark Q4_K_M complete.
