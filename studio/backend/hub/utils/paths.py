...
# "Where do local models live" is one policy, defined once in utils.paths.storage_roots and
# re-exported here. It used to be copied into this module, and the copies drifted: a BOM'd
# ~/.lmstudio/settings.json was honoured by one and silently dropped by the other.
