...
from hub.utils.hf_tokens import cached_read_refused as hub_cached_read_refused, is_anonymous
...
async def get_gguf_variants_answer(
    ...
    def _compute_with_cleanables() -> VariantsAnswer:
        ...
        return VariantsAnswer(
            _compute_response(), answered_from[0], cache_authorized[0], variant_context_sources
        )
