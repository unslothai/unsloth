...
_FAMILIES: tuple[DiffusionFamily, ...] = (
    DiffusionFamily(
        ...
        prequant_variant_repos = (
            ...
            # Policy ``flux_mod_single_v1``, gated on schnell ONLY: a family row would hand dev and Krea-dev the schnell artifact, which _validate_checkpoint refuses on base_model_id after the download.
    ...
    DiffusionFamily(
        ...
        prequant_repos = (
            ...
            # Per-layer policy ``zimg_f8mod_toq34_v1``, GPTQ-corrected on the 4-bit operand, baked activation scales. The plain RTN build of the same policy is hosted alongside for A/B only.
