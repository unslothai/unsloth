...
def _is_cuda_nvidia(target: Any) -> bool:
    ...
    try:
        ...
        # Shared with the stub installer: hip alone misreads AMD wheels that only tag __version__,
        # dropping aiter and routing cuDNN/xformers (stubbed there) at a ROCm card.
