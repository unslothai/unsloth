...
class ToolIsolationUnavailableResult(str):
    """Trusted isolation failure requiring user recovery rather than model retries."""
    ...
    def prepare_call(
        ...
        *,
        ...
        if self._isolation_unavailable:
            action = "disabled"
            noop = "Python and Terminal isolation failed. Stop retrying tools and explain that the user must repair or change isolation settings."
