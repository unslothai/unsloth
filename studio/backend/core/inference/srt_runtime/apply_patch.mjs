...
const patchedHash = '4b9651b7d9249b3f747eb01494af2f31cb4f11216afa93b13250e3d404639a25';
...
export function applyPatch(root = path.dirname(fileURLToPath(import.meta.url))) {
  ...
  if (hash !== originalHash) throw new Error('Cannot patch an unknown SRT source file');
