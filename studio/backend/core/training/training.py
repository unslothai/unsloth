...
class TrainingBackend:
    ...
    def _run_finished_locked(self) -> bool:
        ...
        # A start in flight means the previous run's _progress is still what we would read.
        # main spells that state _start_in_progress; here it is the spawn reservation, the
        # same pair is_training_active() tests.
