                ...
                try:
                    ...
                    if (
                        ...
                        if rename_candidates:
                            ...
                            snapshot = None
                            renamed += 1
                    # Metadata-only updates and renames consume their snapshot.
                    # Every remaining snapshot still needs ingestion, including
                    # a new file for which no rename candidate was found.
