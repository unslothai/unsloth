...
def _resolve_embedding_model_plan(
    ...
    if not on_llama:
        ...
        # The alias-aware predicate alone, which already pairs the ST file family with the loadable check per
        # candidate; the repo the cache hit came from is what the PUT verifies and scans.
