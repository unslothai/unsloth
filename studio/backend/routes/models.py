...
def _diffusion_owned_targets(diff_status: dict) -> list[tuple[str, str | None]]:
    ...
    per-variant delete to take advantage of. Lazy text-side GGUF repos
    are paired with their own GGUF filename because their mmap-backed
    tensors can stay resident too.
    """
    return [
        (
