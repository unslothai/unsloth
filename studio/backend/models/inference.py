...
class ValidateModelRequest(BaseModel):
    ...
    # Intended load settings, so validate's training-coexistence check matches the
    # follow-up /load (defaults preserve the old behavior for callers that omit them).
