...
class InferenceStatusResponse(_InferenceRuntimeFields):
    ...
    spec_fallback_reason: Optional[str] = Field(
        ...
        description = (
            ...
            "'drafter_no_vram' -> an Auto-mode fit downgrade: Studio proved the model "
            "pins but its drafter does not, or llama.cpp confirmed it omitted a shared "
            "drafter from fitting and then OOMed while loading it; Auto keeps the context "
