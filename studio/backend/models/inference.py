...
class LoadRequest(BaseModel):
    ...
    gpu_ids: Optional[List[int]] = Field(
        ...
        description = (
            ...
            "automatic selection. CUDA/HIP uses physical indices. Intel XPU "
            "supports stable root IDs only in COMPOSITE hierarchy; UUID/MIG, "
            "subdevice tokens, and FLAT tile handles cannot be resolved safely. "
            "For GGUF models the selected CUDA/HIP devices are pinned through "
            "their visibility masks."
        ),
    )
