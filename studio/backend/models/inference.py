...
class ChatCompletionRequest(BaseModel):
    ...
    enabled_tools: Optional[list[str]] = Field(
        None,
        description = (
            "[x-unsloth] List of enabled tool names. Studio-local tools, including "
            "when Studio drives an external provider, accept ['web_search', 'python', "
            "'terminal', 'edit_file', 'render_html', 'create_skill', 'read_skill']. "
            "Provider-hosted tools accept ['web_search', 'web_fetch', 'code_execution'] for "
