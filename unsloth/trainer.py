...
def _patch_sft_trainer_auto_packing(trl_module):
    ...
    def new_init(self, *args, **kwargs):
        ...
        if _should_auto_pack(config_arg) and not blocked:
            ...
            logger.info("Unsloth: Auto sample packing enabled for SFTTrainer instance.")
        ...
        try:
            ...
            if auto_pack_active and _should_skip_auto_packing_error(exc):
                logger.info(
                    "Unsloth: Auto sample packing disabled because trainer reported an incompatible setup (%s).",
                    exc,
                )
        ...
        if auto_pack_active and _should_auto_pack(trainer_args):
            ...
            logger.info("Unsloth: Sample packing runtime hooks installed on trainer.")
