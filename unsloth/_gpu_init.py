...
fix_torchao_nf4tensor_move()
# W8A8 compressed-tensors checkpoints fake-quantize activations under no_grad; LoRA training needs the
# gradient to pass through. Lazy: patches forward_quantize when compressed_tensors is imported.
fix_compressed_tensors_activation_quant_gradient()
fix_torchao_safe_int_mm_repr_probe()
