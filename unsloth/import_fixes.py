...
def disable_broken_wandb():
    ...
    Both must be patched, and broken wandb modules must be purged from
    sys.modules to prevent cached partial imports from causing crashes.
    """
    import sys as _sys
    ...
    try:
        ...
        # wandb is installed but broken - clean up and disable
        logger.info(
