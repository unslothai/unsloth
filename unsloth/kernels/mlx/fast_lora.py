...
@mx.compile
def _compiled_mlp_swiglu(X, gateW, gateA, gateB, gateS, upW, upA, upB, upS, downW, downA, downB, downS):
    # X: (Batch, Seq, Dim)
...
def apply_lora_mlp_swiglu(
    ...
    out_mlx = _compiled_mlp_swiglu(
        X_mlx,
        gateW_mlx, gateA_mlx, gateB_mlx, gateS_mlx,
