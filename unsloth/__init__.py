...
if (DEVICE_TYPE in ("cuda", "hip")) and (
    os.environ.get("UNSLOTH_VLLM_STANDBY", "0") == "0"
):
    ...
    and (os.environ.get("UNSLOTH_VLLM_STANDBY", "0") == "1")
    and ("expandable_segments:True" in os.environ.get("PYTORCH_CUDA_ALLOC_CONF", ""))
):
    warnings.warn(
