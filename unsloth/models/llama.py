...
from unsloth.utils.modeling import QuantizationMethod, has_bias
...
class FastLlamaModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if load_in_4bit:
            ...
            ), f"loading in 4bit requires bnb but quantization method is set to {QuantizationMethod.BNB}"
    ...
    def patch_peft_model(
        ...
        if lora_dropout == 0 and bias == "none":
            if model.quantization_method == QuantizationMethod.GPTQ:
                from unsloth.gptq.fast_lora import (
                    apply_lora_mlp,
                    apply_lora_o,
                    apply_lora_qkv,
                )

                logger.warning_once("Patching model with fast unsloth GPTQ layers...")
            else:
                ...
                logger.warning_once("Patching model with fast unsloth BNB layers...")
