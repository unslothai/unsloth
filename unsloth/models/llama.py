...
def LlamaAttention_fast_forward_inference(
    ...
    if do_prefill:
        self.paged_attention = torch.empty((128+1, 2, bsz, n_kv_heads, head_dim), dtype = dtype, device = "cuda")
        ...
        self.attention = torch.empty((bsz, n_heads, 1, 128), dtype = dtype, device = "cuda")
...
def LlamaForCausalLM_fast_forward(
    ...
    *args, **kwargs,
    ...
    if causal_mask is None and past_key_value is not None:
