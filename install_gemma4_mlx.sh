...
printf "  ${C_DIM}%s${C_RST}\n" "$RULE"
echo ""
step "available models" "unsloth/gemma-4-E2B-it-MLX-4bit (5bit/6bit/8bit/BF16)"
substep "unsloth/gemma-4-E2B-it-MLX-UD-4bit (5bit/6bit/8bit/BF16)"
substep "unsloth/gemma-4-E4B-it-MLX-4bit (5bit/6bit/8bit/BF16)"
substep "unsloth/gemma-4-E4B-it-MLX-UD-4bit (5bit/6bit/8bit/BF16)"
echo ""
