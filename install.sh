...
_configure_uv_cache() {
    ...
    # A relative cache-dir comes back verbatim and uv resolves it against its working directory, so scanning it as written inspects a same-named directory beside us.
