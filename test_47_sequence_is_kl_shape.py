...
r_tok = grpo_compute_loss(
    ref, new.clone().requires_grad_(True), old, None, input_ids, mask, beta, advantages,
...
print(f"PASS: token IS coef_1 shape={coef_1_tok.shape}, sequence IS coef_1 shape={coef_1_seq.shape}")
