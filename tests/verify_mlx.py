...
from unsloth.kernels.mlx.fast_lora import apply_lora_mlp_swiglu, apply_lora_qkv, apply_lora_o
...
def test_mlp():
    ...
    mx.eval(out) # Ensure eval if returning mlx array (though wrapper converts to torch)
