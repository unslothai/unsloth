...
def test_native_mlx_loading():
    ...
    if mapped_count > 0:
        print(f"✅ Success: {mapped_count} weights were natively mapped from MLX safetensors.")
    else:
        print(f"❌ Failure: No weights were natively mapped. Check logs for mapping errors.")
