...
class TestGetModelName(unittest.TestCase):
    ...
    def test_resolution_matrix(self):
        cases = [
            ...
            ("mistralai/Ministral-8B-Instruct-2410", True, "mistralai/Ministral-8B-Instruct-2410", False),
            ("meta-llama/Llama-3.2-1B-Instruct", False, "unsloth/Llama-3.2-1B-Instruct", True),
            ("meta-llama/Llama-2-7b-chat-hf", True, "unsloth/llama-2-7b-chat-bnb-4bit", True),
            ("meta-llama/Llama-3.3-70B-Instruct", True, "unsloth/llama-3.3-70b-instruct-unsloth-bnb-4bit", True),
            ...
            ("mistralai/Ministral-3-3B-Instruct-2512", True, "unsloth/Ministral-3-3B-Instruct-2512-unsloth-bnb-4bit", True),
            ("mistralai/Ministral-3-3B-Instruct-2512", False, "unsloth/Ministral-3-3B-Instruct-2512", True),
            ...
            ("unsloth/gpt-oss-20b-unsloth-bnb-4bit", False, "unsloth/gpt-oss-20b", True),
            ("unsloth/gpt-oss-20b-bnb-4bit", True, "unsloth/gpt-oss-20b-bnb-4bit", False),
        ]
        for case in cases:
    ...
    def test_static_mapper_contract(self):
        contracts = [
            ...
            ("mistralai/ministral-3-3b-instruct-2512", "unsloth/ministral-3-3b-instruct-2512-unsloth-bnb-4bit"),
