...
"""Text-only loads of pre-quantized VLM repos must end up in the requested dtype (CPU only)."""
...
class _EetqLikeLinear(nn.Module):
    """Like transformers' EetqLinear: int8 weight, float16 weight_scales / bias."""
