...
from unsloth.kernels.mps.geglu import (
    mps_geglu_exact_forward, mps_geglu_exact_backward,
    mps_geglu_approx_forward, mps_geglu_approx_backward
)
...
def test_cross_entropy_parity():
    ...
    # Reference
    loss_ref = F.cross_entropy(logits.view(-1, 128), labels.view(-1), ignore_index=-100, reduction='mean')
