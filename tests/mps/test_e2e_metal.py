...
def run_e2e_test():
    ...
    # 2. Kernel Check
    from unsloth.kernels.metal import is_metal_swiglu_available, is_metal_geglu_available
    ...
    print(f"  GEGLU Exact Parity: max_diff={diff_geglu:.6f} {'✅' if diff_geglu < 1e-2 else '❌'}")
    ...
    print(f"  GEGLU Approx Parity: max_diff={diff_geglu_approx:.6f} {'✅' if diff_geglu_approx < 1e-2 else '❌'}")
