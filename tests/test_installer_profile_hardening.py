...
def test_profile_hardening_precedes_every_use_it_protects():
    ...
    for marker, what in (
        ...
        ("Invoke-ManagedUnslothCli -Python $VenvPython -Arguments $studioArgs", "the setup handoff"),
    ):
...
def test_the_handoff_is_published_only_around_the_setup_child():
    ...
    call = _locate(source, "    try {\n        Invoke-ManagedUnslothCli -Python $VenvPython -Arguments $studioArgs", "the child invocation")
