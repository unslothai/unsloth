...
class TestIssue497(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            print(f"Skipping test because model loading failed (likely due to environment): {e}")
    ...
    def test_generate_with_past_key_values(self):
        ...
        # First generation
        model_inputs = self.tokenizer(prompt, return_tensors="pt", add_special_tokens=False).to("cuda")
        ...
        model_inputs_2 = self.tokenizer(full_prompt, return_tensors="pt", add_special_tokens=False).to("cuda")
