from unsloth import FastModel, UnslothVisionDataCollator
...
from cleanup_utils import safe_remove_directory
from perplexity_eval import ppl_model, add_to_comparison, print_model_comparison
...
def load_and_compute_8bit_ppl(result_queue, load_in_4bit=False, load_in_8bit=False):
    ...
    from unsloth.chat_templates import get_chat_template
    from perplexity_eval import ppl_model
