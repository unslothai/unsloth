...
# The awk header pattern is the loose "independent Apple Silicon venv" substring so it
# keeps matching whichever wording of the guard comment install.sh ships.
{
    printf 'substep() { :; }\n'
