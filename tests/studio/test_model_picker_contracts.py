...
def test_a_pinned_cached_row_loads_from_the_id_the_backend_pinned():
    ...
    # The GGUF selection plus the safetensors row and its settings action all
    # reload through the backend-pinned identity.
    assert picker.count("loadId: c.load_id") == 3, "every cached selection path needs the pin"
