...
Check "gfx110x-all family"                (Test-PipRocmFamilyLeaf "gfx110x-all")
Check "gfx1151-private NOT family"        (-not (Test-PipRocmFamilyLeaf "gfx1151-private"))
Check "gfx9999 NOT family"                (-not (Test-PipRocmFamilyLeaf "gfx9999"))
