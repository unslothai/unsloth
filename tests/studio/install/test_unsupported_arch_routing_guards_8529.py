...
_STRIX_SITES = [
    ...
    # Either spelling: the set is module-level as _strix_gfx, or a local strix_gfx inside
    # _selected_linux_strix_gfx, which setup.sh and the full dependency pass both route through.
    (_STACK_PY, r"^\s*_?strix_gfx\s*=\s*\{([^}]*)\}"),
]
