...
# the real package for the session. Stub only a genuinely absent one (check sys.modules first:
# find_spec() raises ValueError on another module's bare stub), then backfill get_logger.
