...
"""Compare local pre-contract and working-tree TestClient p50/p95; fail above 5%. Run from the repo root: python tests/studio/multi_account/perf/compare.py --output artifacts/perf.json"""
