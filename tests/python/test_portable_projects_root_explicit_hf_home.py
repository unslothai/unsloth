...
TORCH_HOME is checked alongside it as the variable that was already on the right
side of the early return, so a future edit cannot fix one by breaking the other.
...
def main() -> int:
    with tempfile.TemporaryDirectory() as td:
        ...
        check(
            ...
            ["TORCH_HOME", "UNSLOTH_STUDIO_PROJECTS_HOME"],
            r["default_keys"],
        )
