...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Offline / no winget, so nothing can be installed, but an x64 build of a
        # lower-priority supported minor is already here. Use it: the native 3.13
        # cannot resolve pyarrow or hf-transfer, and this one can.
