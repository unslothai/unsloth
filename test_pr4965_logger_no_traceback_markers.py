...
def test_logger_never_receives_exc_info_true(monkeypatch, fake_datasets, fake_structlog):
...
def test_logger_message_has_no_traceback_keywords(monkeypatch, fake_datasets, fake_structlog):
    import datasets as ds
